 ...
 * 5 Start Rescind cancellation policy
 * Fill required field, click ok.
 * Decline confirmation of Rescind Cancellation action
 * Click Cancel in Rescind Cancellation workspace
 * 6. Rescind Cancellation policy
 * 7. Verify Policy status is "Policy Active"
 * Verify BAM Message present
 * Verify Rescind transaction present in transaction History
 * @details
