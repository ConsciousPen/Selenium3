...
import aaa.main.modules.policy.pup.actiontabs.DeclineByCompanyActionTab;
 ...
 * @name Test Umbrella Quote Decline by Company
 * @scenario
 * 1. Create Customer
 ...
 * @details
 */
public class TestQuoteDeclineByCompany extends PersonalUmbrellaBaseTest {
    ...
    public void testQuoteDeclineByCompanyCancellations() {
        ...
        policy.declineByCompanyQuote().getView().getTab(DeclineByCompanyActionTab.class).getAssetList()
                .getWarning(PersonalUmbrellaMetaData.DeclineByCompanyActionTab.DECLINE_REASON.getLabel()).verify.contains(
        ...
        policy.declineByCompanyQuote().getView().getTab(DeclineByCompanyActionTab.class).getAssetList().verify.present();
