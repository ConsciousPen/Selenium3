...
public class TestQuotePropose extends PersonalUmbrellaBaseTest {
    ...
    public void testQuotePropose() {
        ...
        policy.propose().start();
        policy.propose().getView().getTab(ProposeActionTab.class).getAssetList().getControl(PersonalUmbrellaMetaData.ProposeActionTab.NOTES.getLabel()).verify.enabled();
        ...
        policy.propose().getView().getTab(ProposeActionTab.class).getAssetList().getControl(PersonalUmbrellaMetaData.ProposeActionTab.NOTES.getLabel(), TextBox.class).setValue("Comment");
