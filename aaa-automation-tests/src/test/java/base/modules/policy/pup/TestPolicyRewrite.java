...
import aaa.main.modules.policy.pup.actiontabs.RewriteActionTab;
 ...
 * @name Test Rewrite for Umbrella Policy
 * @scenario
 * 1. Create Customer
...
public class TestPolicyRewrite extends PersonalUmbrellaBaseTest {
    ...
    public void createCancelledPolicy() {
        ...
        effectiveDate = tdPolicy.getTestData("Rewrite", "TestDataNewNumber").getValue(
                PersonalUmbrellaMetaData.RewriteActionTab.class.getSimpleName(),
                PersonalUmbrellaMetaData.RewriteActionTab.EFFECTIVE_DATE.getLabel());
    ...
    public void testPolicyRewriteCancellations() {
        ...
        NavigationPage.Verify.viewTabSelected("Policy");
