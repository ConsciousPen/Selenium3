 ...
 * @name Test Renew Automatic Offer with Lapse for Umbrella Policy
 * @scenario
 * 1. Create Customer
...
public class TestPolicyRenewAutomaticOfferWithLapse extends PersonalUmbrellaBaseTest {
    ...
    public void testPolicyRenewAutomaticOfferWithLapse() {
        ...
        String minimumDue = BillingSummaryPage.tableBillingGeneralInformation.getRow(1).getCell(BillingConstants.BillingGeneralInformationTable.MINIMUM_DUE).getValue();
