 ...
 * @name Test Cancellation Notice with Cancellation for Umbrella Policy
 * @scenario
 * 1. Create Customer
 ...
 * @details
 */
public class TestPolicyCancelNoticeWithCancellation extends PersonalUmbrellaBaseTest {
