...
import aaa.main.modules.policy.auto_ss.actiontabs.ProposeActionTab;
 ...
 * @details
 */
public class TestQuotePropose extends AutoSSBaseTest {
    ...
    public void testQuotePropose() {
        ...
        policy.propose().start();
        policy.propose().getView().getTab(ProposeActionTab.class).getAssetList().getControl(AutoSSMetaData.ProposeActionTab.NOTES.getLabel()).verify.enabled();
        ...
        policy.propose().getView().getTab(ProposeActionTab.class).getAssetList().getControl(AutoSSMetaData.ProposeActionTab.NOTES.getLabel(), TextBox.class).setValue("Comment");
