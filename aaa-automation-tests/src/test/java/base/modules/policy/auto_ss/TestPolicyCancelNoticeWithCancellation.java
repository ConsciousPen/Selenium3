 ...
 * @name Test Cancellation Notice with Cancellation for Auto Policy
 * @scenario
 * 1. Create Customer
 ...
 * @details
 */
public class TestPolicyCancelNoticeWithCancellation extends AutoSSBaseTest {
    ...
    public void testPolicyCancelNoticeWithCancellation() {
        ...
        TimeSetterUtil.getInstance().nextPhase(TimeSetterUtil.getInstance().getCurrentTime().plusDays(daysOfNotice).plusDays(BillingHelper.DAYS_CANCELLATION));
