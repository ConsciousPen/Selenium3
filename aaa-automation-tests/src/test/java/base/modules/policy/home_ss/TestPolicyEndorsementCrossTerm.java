 ...
 * @name Test Endorsement Cross Term for Home Policy
 * @scenario
 * 1. Create Customer
 ...
 * 6. Verify Policy status is 'Pending out of sequence completion' in endorsement
 * 7. Verify 'Renewals' button is disabled
 * 8. Verify policy premium is changed
 * @details
 */
public class TestPolicyEndorsementCrossTerm extends HomeSSHO3BaseTest {
