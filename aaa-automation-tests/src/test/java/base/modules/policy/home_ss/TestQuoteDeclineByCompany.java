    ...
    public void testQuoteDeclineByCompany() {
        ...
        NotesAndAlertsSummaryPage.activitiesAndUserNotes.verify.description(1, String.format(
                ...
                tdPolicy.getTestData("DeclineByCompany", "TestData").getValue(
                        HomeSSMetaData.DeclineByCompanyActionTab.class.getSimpleName(),
                        HomeSSMetaData.DeclineByCompanyActionTab.DECLINE_REASON.getLabel())));
    ...
    public void testQuoteDeclineByCompanyCancellations() {
        ...
        policy.declineByCompanyQuote().start().getView().fill(
                tdPolicy.getTestData("DeclineByCompany", "TestData")
                        .mask(HomeSSMetaData.DeclineByCompanyActionTab.class.getSimpleName(),
                                HomeSSMetaData.DeclineByCompanyActionTab.DECLINE_REASON.getLabel()));

        DeclineByCompanyActionTab.buttonOk.click();

        policy.declineByCompanyQuote().getView().getTab(DeclineByCompanyActionTab.class)
                .getAssetList().getWarning(HomeSSMetaData.DeclineByCompanyActionTab
