 ...
 * @name Test Renew Automatic Offer without Lapse for Home Policy
 * @scenario
 * 1. Create Customer
 ...
 * @details
 */
public class TestPolicyRenewAutomaticOfferWithoutLapse extends HomeSSHO3BaseTest {
    ...
    public void testPolicyRenewAutomaticOfferWithoutLapse() {
        ...
        TimeSetterUtil.getInstance().nextPhase(policyExpirationDate.addDays(BillingHelper.DAYS_RENEW_WITHOUT_LAPSE));
        mainApp().reopen();
