...
/**
 * @author Ivan Kisly
 * @name Test Product Factory Rename Component
 * @scenario
 * 1. Open 'Components' page of predefined product
 * 2. Connect component from 'Port' view
 * 3. Change component's Reference name
 * 4. Select newly renamed component in the 'Relation' view
 * 5. Connect new component in the 'Repository' view
 * @details
 */
public class TestProductFactoryRenameComponent extends BaseTest {
    ...
    public void testProductFactoryRenameComponent() {
        adminApp().open();
        ...
        log.info("TEST: Rename Component");
        ...
        productFactory.getDefaultView().getTab(ComponentsTab.class)
                .getPropertiesAssetList().getControl(ProductMetaData.ComponentsTab.REFERENCE_NAME.getLabel(), PFTextBox.class).verify
                .value(tdSpecific.getTestData("ComponentRenameComponent").getValue("Properties", ProductMetaData.ComponentsTab.REFERENCE_NAME.getLabel()));
