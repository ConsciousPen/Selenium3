 ...
 * @name Test Customer Contact Details "Address" Add Remove
 * @scenario
 * 1. Create Non Individual Customer
 * 2. Navigate to Contacts Relationship tab
 * 3. Add new Contact details "Address"
...
public class TestCustomerContactDetailsNewAddressAddRemove extends CustomerBaseTest {
    ...
    public void testCustomerContactDetailsNewAddressAddRemove() {
        ...
        log.info("TEST: Add New Address for Customer # " + customerNumber);
        ...
        CustomerSummaryPage.tableCustomerContacts.getRow(2).getCell(CustomerConstants.CustomerContactsTable.CONTACT_TYPE).verify.value(tdCustomerNonIndividual.getTestData(
                "ContactsDetails", "Adjustment_NewAddress", CustomerMetaData.GeneralTab.class.getSimpleName()).getValue(
                CustomerMetaData.GeneralTab.ADDRESS_TYPE.getLabel()));

        log.info("TEST: Remove Address for Customer # " + customerNumber);
