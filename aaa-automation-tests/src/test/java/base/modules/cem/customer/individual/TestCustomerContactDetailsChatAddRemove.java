 ...
 * @name Test Customer Contact Details "Chat" Add Remove
 * @scenario
 * 1. Create Individual Customer
 * 2. Navigate to Contacts Relationship tab
 * 3. Add new Contact details "Chat"
 ...
 * @details
 */
public class TestCustomerContactDetailsChatAddRemove extends CustomerBaseTest {

    @Test
    @TestInfo(component = "CRM.Customer")
    public void testCustomerContactDetailsChatAddRemove() {
        mainApp().open();
        ...
        log.info("TEST: Add New Chat for Customer # " + customerNumber);
        ...
        CustomerSummaryPage.tableCustomerContacts.getRow(2).getCell(CustomerConstants.CustomerContactsTable.CONTACT_TYPE).verify.value(tdCustomerIndividual.getTestData(
                "ContactsDetails", "Adjustment_NewChat", CustomerMetaData.GeneralTab.class.getSimpleName()).getValue(
                CustomerMetaData.GeneralTab.CHAT_TYPE.getLabel()));

        log.info("TEST: Remove chat for Customer # " + customerNumber);
