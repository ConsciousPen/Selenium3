 ...
 * @name Test Customer Add/Remove Membership Participant
 * @scenario
 * 1. Create Non-Individual Customer
 * 2. Perform Add Participant action
 * 3. Verify that Participant appeared in Membership table in Census tab
 * 4. Remove previously created Participant
 * 5. Verify that Membership table is not present
 * @details
 */
public class TestCustomerParticipantMembershipAddRemove extends CustomerBaseTest {
    ...
    public void testCustomerParticipantMembershipAddRemove() {
        ...
        CustomerSummaryPage.tableMembershipCensus.verify.rowsCount(1);
        ...
        CustomerSummaryPage.tableMembershipCensus.verify.present(false);
    }
}
