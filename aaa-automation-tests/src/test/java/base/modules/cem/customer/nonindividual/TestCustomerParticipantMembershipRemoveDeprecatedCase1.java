 ...
 * @name Test Customer Remove Deprecated Membership Relationship (case 1)
 * @scenario
 ...
 */
public class TestCustomerParticipantMembershipRemoveDeprecatedCase1 extends CustomerBaseTest {

    @Test
    @TestInfo(component = "CRM.Customer")
    public void testCustomerParticipantMembershipRemoveDeprecatedCase1() {
        mainApp().open();
        ...
        String participantId =
                CustomerSummaryPage.tableMembershipCensus.getRow(1).getCell(CustomerConstants.CustomerMembershipCensusTable.PARTICIPANT_ID)
                        .getValue();
