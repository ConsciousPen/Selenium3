 ...
 * @details
 */
public class TestCustomerCommunicationThreadAddRemoveAccount extends CustomerBaseTest {

    @Test
    @TestInfo(component = "CRM.Customer")
    public void testCustomerCommunicationThreadAddRemoveAccount() {
        mainApp().open();
        ...
        customer.addCommunicationThread().perform(tdCustomerNonIndividual.getTestData("CommunicationThread", "TestData_Account"), 1);
        ...
        CommunicationActionTab.tableCommunications.getRow(2).getCell(CustomerConstants.CustomerCommunicationsTable.ENTITY_REFERENCE_ID).verify.value(CustomerSummaryPage.labelAccountNumber.getValue());
