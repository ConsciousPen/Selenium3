 ...
 * @name Test Customer Contact Details "Email" Add Remove
 * @scenario
 * 1. Create Non Individual Customer
 * 2. Navigate to Contacts Relationship tab
 * 3. Add new Contact details "Email"
...
public class TestCustomerContactDetailsEmailAddRemove extends CustomerBaseTest {
    ...
    public void testCustomerContactDetailsEmailAddRemove() {
        ...
        log.info("TEST: Add New email for Customer # " + customerNumber);
        ...
        CustomerSummaryPage.tableCustomerContacts.getRow(2).getCell(CustomerConstants.CustomerContactsTable.CONTACT_TYPE).verify.value(tdCustomerNonIndividual.getTestData(
                "ContactsDetails", "Adjustment_NewEmail", CustomerMetaData.GeneralTab.class.getSimpleName()).getValue(
                CustomerMetaData.GeneralTab.EMAIL_TYPE.getLabel()));

        log.info("TEST: Remove email for Customer # " + customerNumber);
