...
public class TestCustomerRelationshipAddNonIndOnUpdate extends CustomerBaseTest {
    ...
    public void testCustomerRelationshipAddNonIndOnUpdate() {
        ...
        customer.update().perform(tdCustomerNonIndividual.getTestData("Update", "TestData")
                .adjust(tdCustomerNonIndividual.getTestData("DataGather", "Adjustment_RelationshipWithNonIndividualType")));
        ...
        new RelationshipTab().getAssetList().getControl(CustomerMetaData.RelationshipTab.TYPE.getLabel(), RadioGroup.class).verify.value(
                tdCustomerNonIndividual.getTestData("DataGather", "Adjustment_RelationshipWithNonIndividualType").getTestData(
