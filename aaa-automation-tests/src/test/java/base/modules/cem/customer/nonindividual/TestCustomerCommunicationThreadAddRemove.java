 ...
 * 4. Verify that added Communication Thread is present in Communications table
 * 5. Remove previously added Communication Thread
 * 6. Verify that previously removed Communication Thread is not present in Communications table
 * @details
 */
