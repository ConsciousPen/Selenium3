 ...
 * @name Test Customer Add/Remove Communication
 * @scenario
 ...
 * @details
 */
public class TestCustomerCommunicationAddRemove extends CustomerBaseTest {

    @Test
    @TestInfo(component = "CRM.Customer")
    public void testCustomerCommunicationAddRemove() {
        mainApp().open();
        ...
        CommunicationActionTab.tableCommunications.getRow(1).getCell(CustomerConstants.CustomerCommunicationsTable.ENTITY_REFERENCE_ID).verify
                .value(CustomerSummaryPage.labelCustomerNumber.getValue());
