 ...
 * 3. Add Relationship with Individual type
...
public class TestCustomerRelationshipUpdate extends CustomerBaseTest {
    ...
    public void testCustomerRelationshipUpdate() {
        ...
        customer.addRelationshipContact().perform(tdCustomerIndividual.getTestData("DataGather", "Adjustment_Relationship"));
        ...
        RelationshipTab.comboBoxRelationshipRole.verify.value(
                tdCustomerIndividual.getTestData("DataGather", "Adjustment_RelationshipUpdate").getTestData(
