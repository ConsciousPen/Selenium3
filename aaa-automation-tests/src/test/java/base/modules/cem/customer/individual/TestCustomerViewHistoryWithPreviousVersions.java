...
public class TestCustomerViewHistoryWithPreviousVersions extends CustomerBaseTest {
    ...
    public void testCustomerViewHistoryWithPreviousVersions() {
        ...
        new ViewHistoryActionTab().getAssetList().getControl(CustomerMetaData.ViewHistoryActionTab.VERSION_DATE.getLabel(), TextBox.class).verify.value(
                tdCustomerIndividual.getValue("ViewHistoryAction", "TestData", CustomerMetaData.ViewHistoryActionTab.class.getSimpleName(),
                        CustomerMetaData.ViewHistoryActionTab.VERSION_DATE.getLabel()));
        ...
        ViewHistoryActionTab.tableGeneralInfo.getRow(4).getCell(2).verify.value(tdSpecific.getValue("TestData", CustomerMetaData.GeneralTab.class.getSimpleName(),
                CustomerMetaData.GeneralTab.FIRST_NAME.getLabel()));
