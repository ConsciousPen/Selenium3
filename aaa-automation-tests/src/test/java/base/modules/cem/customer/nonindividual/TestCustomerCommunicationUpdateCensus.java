 ...
 * @name Test Customer Update Communication from Census
 * @scenario
 ...
 * @details
 */
public class TestCustomerCommunicationUpdateCensus extends CustomerBaseTest {

    @Test
    @TestInfo(component = "CRM.Customer")
    public void testCustomerCommunicationUpdateCensus() {
        mainApp().open();
