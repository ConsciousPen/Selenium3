...
public class TestCustomerAssociateAccountAddRemoveOnUpdate extends CustomerBaseTest {
    ...
    public void testCustomerAssociateAccountAddRemoveOnUpdate() {
        ...
        customer.update().perform(tdCustomerNonIndividual.getTestData("DataGather", "TestData")
                .adjust(tdCustomerNonIndividual.getTestData("DataGather", "Adjustment_WithAssociateAccountOnUpdate").resolveLinks()));
