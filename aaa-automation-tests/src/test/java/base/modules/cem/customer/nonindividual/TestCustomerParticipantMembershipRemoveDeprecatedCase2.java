 ...
 * @name Test Customer Remove Deprecated Membership Relationship (case 2)
 * @scenario
 ...
 * 4. Verify that Membership Information is present
 * 5. Remove Relationship to Sponsor and check Keep History
 * 6. Verify that Deprecated Membership Information is present
 * 7. Remove Relationship to Sponsor
 * 8. QuickSearch for removed Participant
 * 9. Start Update action
 * 10. Verify that Membership Information is not present
 * @details https://jira.exigeninsurance.com/browse/EISDEV-135337
 */
public class TestCustomerParticipantMembershipRemoveDeprecatedCase2 extends CustomerBaseTest {

    @Test
    @TestInfo(component = "CRM.Customer")
    public void testCustomerParticipantMembershipRemoveDeprecatedCase2() {
        mainApp().open();
        ...
        customer.updateParticipantMembership().start(1);
        CustomerSummaryPage.labelMembershipInformationExpanded.verify.value(
                "Membership Information for " + customerNumber + " " + participantName + " Relationship");
        ...
        CustomerSummaryPage.labelMembershipInformationCollapsed.verify.value(
                "Membership Information for " + customerNumber + " " + participantName
        ...
        CustomerSummaryPage.labelMembershipInformationExpanded.verify.present(false);
    }
}
