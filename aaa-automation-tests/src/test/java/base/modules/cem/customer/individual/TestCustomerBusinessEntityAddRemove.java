 ...
 * @name Test Customer Business Entity Add Remove
 * @scenario
 * 1. Create Individual Customer
 * 2. Select Update action from drop-down
 * 3. Fill Business Entity tab
 * 4. Verify that Business Entity is present in Business Entity table
 * 5. Navigate to Business Entity tab and remove them
 * 6. Verify that Business Entity is not present in Business Entity table
 * @details
 */
public class TestCustomerBusinessEntityAddRemove extends CustomerBaseTest {

    @Test
    @TestInfo(component = "CRM.Customer")
    public void testCustomerBusinessEntityAddRemove() {
        ...
        customer.update().perform(tdCustomerIndividual.getTestData("Update", "TestData").adjust(dateUpdate));
