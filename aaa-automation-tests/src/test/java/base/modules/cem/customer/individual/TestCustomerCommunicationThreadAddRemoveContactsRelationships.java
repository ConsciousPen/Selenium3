 ...
 * @name Test Customer Add/Remove Communication Thread from Contacts and Relationships
 * @scenario
 ...
 * @details
 */
public class TestCustomerCommunicationThreadAddRemoveContactsRelationships extends CustomerBaseTest {

    @Test
    @TestInfo(component = "CRM.Customer")
    public void testCustomerCommunicationThreadAddRemoveContactsRelationships() {
        mainApp().open();
