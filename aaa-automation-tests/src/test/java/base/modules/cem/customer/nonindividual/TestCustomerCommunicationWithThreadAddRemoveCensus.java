 ...
 * @name Test Customer Add/Remove Communication with Thread from Census
 * @scenario
 ...
 * @details
 */
public class TestCustomerCommunicationWithThreadAddRemoveCensus extends CustomerBaseTest {

    @Test
    @TestInfo(component = "CRM.Customer")
    public void testCustomerCommunicationWithThreadAddRemoveCensus() {
        mainApp().open();
