 ...
 * @name Test Customer Update Communication from Contacts & Relationships
 * @scenario
 * 1. Create Individual Customer
 * 2. Navigate to Contacts & Relationships tab
 * 3. Add Communication
 * 4. Update previously added Communication
 * 5. Verify that previously added Communication is updated
 * @details
 */
public class TestCustomerCommunicationUpdateContactsRelationships extends CustomerBaseTest {

    @Test
    @TestInfo(component = "CRM.Customer")
    public void testCustomerCommunicationUpdateContactsRelationships() {
        mainApp().open();
