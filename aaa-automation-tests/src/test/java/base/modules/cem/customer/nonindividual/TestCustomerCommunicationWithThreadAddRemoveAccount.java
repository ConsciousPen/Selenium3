 ...
 * @details
 */
public class TestCustomerCommunicationWithThreadAddRemoveAccount extends CustomerBaseTest {

    @Test
    @TestInfo(component = "CRM.Customer")
    public void testCustomerCommunicationWithThreadAddRemoveAccount() {
        mainApp().open();
