 ...
 * @name Test Customer Remove Membership Participant and do not Keep History
 * @scenario
 ...
 * 6. Verify that Membership Information is not present
 * @details https://jira.exigeninsurance.com/browse/EISDEV-135335
 */
public class TestCustomerParticipantMembershipRemoveNoHistory extends CustomerBaseTest {

    @Test
    @TestInfo(component = "CRM.Customer")
    public void testCustomerParticipantMembershipRemoveNoHistory() {
        mainApp().open();
        ...
        customer.removeParticipantMembership().perform(tdCustomerNonIndividual.getTestData("RemoveParticipant", "TestData"), 1);
