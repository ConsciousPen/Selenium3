 ...
 * @name Test Customer Remove Employment Participant on Update
 * @scenario
 ...
 * @details
 */
public class TestCustomerParticipantEmploymentRemoveOnUpdate extends CustomerBaseTest {

    @Test
    @TestInfo(component = "CRM.Customer")
    public void testCustomerParticipantEmploymentRemoveOnUpdate() {
        mainApp().open();
