...
public class TestCustomerRelationshipAddIndOnUpdate extends CustomerBaseTest {
    ...
    public void testCustomerRelationshipAddIndOnUpdate() {
        ...
        customer.update().perform(tdCustomerIndividual.getTestData("Update", "TestData")
                .adjust(tdCustomerIndividual.getTestData("DataGather", "Adjustment_RelationshipWithIndividualType")).resolveLinks());
        ...
        new RelationshipTab().getAssetList().getControl(CustomerMetaData.RelationshipTab.TYPE.getLabel(), RadioGroup.class).verify.value(
                tdCustomerIndividual.getTestData("DataGather", "Adjustment_RelationshipWithIndividualType").getTestData(
