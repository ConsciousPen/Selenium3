 ...
 * @name Test Customer Add/Remove Communication Thread from Customer Info
 * @scenario
 ...
 * @details
 */
public class TestCustomerCommunicationThreadAddRemoveCustomerInfo extends CustomerBaseTest {

    @Test
    @TestInfo(component = "CRM.Customer")
    public void testCustomerCommunicationThreadAddRemoveCustomerInfo() {
        mainApp().open();
