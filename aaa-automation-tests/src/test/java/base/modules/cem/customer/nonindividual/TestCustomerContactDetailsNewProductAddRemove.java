...
public class TestCustomerContactDetailsNewProductAddRemove extends CustomerBaseTest {
    ...
    public void testCustomerContactDetailsNewProductAddRemove() {
        ...
        CustomerSummaryPage.tableNewProductDetails.getRow(1).getCell(CustomerConstants.CustomerNewProductDetailsTable.POLICY_TYPE).verify.value(tdCustomerNonIndividual.getTestData(
