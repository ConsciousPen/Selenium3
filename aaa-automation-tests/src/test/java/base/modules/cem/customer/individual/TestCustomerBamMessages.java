...
public class TestCustomerBamMessages extends AccountBaseTest {
    ...
    public void testCustomerBamMessages() {
        ...
        customer.updateRelationshipContact().perform(tdCustomerIndividual.getTestData("DataGather", "Adjustment_RelationshipUpdate"));
        ...
        NotesAndAlertsSummaryPage.activitiesAndUserNotes.verify.descriptionContains(1, "Update Customer Address Contact ");
        ...
        log.info("STEP: Update new Contacts Details for Customer #" + customerNumber);
        customer.updateContactsDetails().perform(tdCustomerIndividual.getTestData("ContactsDetails", "TestData")
                .adjust(tdCustomerIndividual.getTestData("ContactsDetails", "Adjustment_UpdatePhoneNumber")), 2);
        ...
        log.info("STEP: Add new Contacts Details for Customer #" + customerNumber);
        customer.addNewContactsDetails().perform(tdCustomerIndividual.getTestData("ContactsDetails", "TestData")
                .adjust(tdCustomerIndividual.getTestData("ContactsDetails", "Adjustment_NewChat")));
        ...
        log.info("STEP: Update new Contacts Details for Customer #" + customerNumber);
        customer.updateContactsDetails().perform(tdCustomerIndividual.getTestData("ContactsDetails", "TestData")
                .adjust(tdCustomerIndividual.getTestData("ContactsDetails", "Adjustment_UpdateChatId")), 2);
        ...
        log.info("STEP: Add new Contacts Details for Customer #" + customerNumber);
        customer.addNewContactsDetails().perform(tdCustomerIndividual.getTestData("ContactsDetails", "TestData")
                .adjust(tdCustomerIndividual.getTestData("ContactsDetails", "Adjustment_NewWebUrl")));
        ...
        log.info("STEP: Update new Contacts Details for Customer #" + customerNumber);
        customer.updateContactsDetails().perform(tdCustomerIndividual.getTestData("ContactsDetails", "TestData")
                .adjust(tdCustomerIndividual.getTestData("ContactsDetails", "Adjustment_UpdateWebUrl")), 2);
        ...
        log.info("STEP: Update new Contacts Details for Customer #" + customerNumber);
        customer.updateContactsDetails().perform(tdCustomerIndividual.getTestData("ContactsDetails", "TestData")
                .adjust(tdCustomerIndividual.getTestData("ContactsDetails", "Adjustment_UpdateSocialNetId")), 2);
        ...
        log.info("STEP: Update new Contacts Details for Customer #" + customerNumber);
        customer.updateContactsDetails().perform(tdCustomerIndividual.getTestData("ContactsDetails", "TestData")
                .adjust(tdCustomerIndividual.getTestData("ContactsDetails", "Adjustment_UpdateEmailAddress")), 2);
