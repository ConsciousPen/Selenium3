 ...
 * @name Test Customer Contact Details "Phone" Add Remove
 * @scenario
 * 1. Create Non Individual Customer
 * 2. Navigate to Contacts Relationship tab
 * 3. Add new Contact details "Phone"
...
public class TestCustomerContactDetailsNewPhoneAddRemove extends CustomerBaseTest {
    ...
    public void testCustomerContactDetailsNewPhoneAddRemove() {
        ...
        log.info("TEST: Add New Contats Details for Customer # " + customerNumber);
        ...
        CustomerSummaryPage.tableCustomerContacts.getRow(2).getCell(CustomerConstants.CustomerContactsTable.CONTACT_TYPE).verify.value(tdCustomerNonIndividual.getTestData(
                "ContactsDetails", "TestData", CustomerMetaData.GeneralTab.class.getSimpleName()).getValue(
                CustomerMetaData.GeneralTab.PHONE_TYPE.getLabel()));

        log.info("TEST: Remove New Contats Details for Customer # " + customerNumber);
