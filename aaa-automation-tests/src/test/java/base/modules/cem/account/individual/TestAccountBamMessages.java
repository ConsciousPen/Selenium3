...
import aaa.main.modules.account.actiontabs.AddAffinityGroupActionTab;
...
public class TestAccountBamMessages extends AccountBaseTest {
    ...
    public void testAccountBamMessages() {
        ...
        account.addCustomer().getView().fillUpTo(tdCustomerIndividual.getTestData("DataGather", "TestData"), GeneralTab.class);
        ...
        AddAffinityGroupActionTab.buttonTopCancel.click();
        Page.dialogConfirmation.confirm();

        log.info("STEP: Add Affinity Group for Account # " + accountNumber);
        account.addAffinityGroup().perform(tdAccountIndividual.getTestData("AffinityGroups", "TestData"));
