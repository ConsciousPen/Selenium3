 ...
 * @name Test Account Move Non-Individual Customer to new Account
 * @scenario
...
public class TestAccountMoveCustomerNewAccount extends AccountBaseTest {
    ...
    public void testAccountMoveCustomerNewAccount() {
        ...
        account.moveCustomerToNewAccount().perform(tdAccountNonIndividual.getTestData("MoveCustomer", "TestData_NewAccount"));
