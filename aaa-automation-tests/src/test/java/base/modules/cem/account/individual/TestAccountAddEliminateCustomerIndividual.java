 ...
 * @name Test Account with Individual Customer Add/Eliminate New Individual Customer
 * @scenario
 * 1. Create Account with Individual Customer
 * 2. Navigate to Account tab
 * 3. Add another Individual Customer
 * 4. Verify that newly created Customer is present in Customer table
 * 5. Eliminate previously created Customer
 * 6. Verify that previously created eliminated Customer is not present
 * @details
 */
public class TestAccountAddEliminateCustomerIndividual extends AccountBaseTest {

    @Test
    @TestInfo(component = "CRM.Account")
    public void testAccountAddEliminateCustomerIndividual() {
        mainApp().open();
        ...
        account.addCustomer().perform(tdCustomerIndividual.getTestData("DataGather", "TestData"));
