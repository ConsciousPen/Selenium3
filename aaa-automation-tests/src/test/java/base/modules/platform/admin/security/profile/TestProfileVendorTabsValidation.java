 ...
 * @scenario
 * 1. Initiate Profile creation (channel Vendro)
 ...
 * 5. Check that Agency/Location section is not visible
...
public class TestProfileVendorTabsValidation extends PlatformBaseTest {
    ...
    private IProfile vendorProfile = ProfileType.VENDOR.get();
    private TestData tdVendorProfileData = tdSpecific.getTestData("ProfileInformationSection");
    ...
    public void testVendorProfileTabs() {
        ...
        storeValues(mapVendorValues, tdVendorProfileData);
        ...
        vendorProfile.create(tdProfileManager);
        vendorProfile.create(tdProfileSubordinate);

        create2PAR();

        vendorProfile.initiate();
        ...
        ProfilePage.change(ProfilePage.getSearchTestData(FIRST_NAME, mapVendorValues.get(FIRST_NAME)));
    ...
    private void validateProfileInformationSection() {
        assetList.getControl(ProfileMetaData.GeneralProfileTab.CHANNEL.getLabel(), StaticElement.class).verify.value(ProfileType.VENDOR.getName());
        ...
        CustomAssert.assertEquals("No", assetList.getControl(ProfileMetaData.GeneralProfileTab.SELLS_INSURANCE_PRODUCTS.getLabel(), RadioGroup.class).getValue());
        CustomAssert.assertFalse(assetList.getControl(ProfileMetaData.GeneralProfileTab.COMMISSIONABLE.getLabel(), CheckBox.class).isPresent());
        CustomAssert.assertFalse(assetList.getControl(ProfileMetaData.GeneralProfileTab.PROFILE_SUBPRODUCER_ID.getLabel(), TextBox.class).isPresent());
        ...
        GeneralProfileTab.tableAgencyLocation.verify.present(Boolean.FALSE);

        new GeneralProfileTab().fillTab(tdVendorProfileData);
        GeneralProfileTab.buttonSave.click();
    ...
    private void validateAfterSave() {
        ...
        assetList.getControl(ProfileMetaData.GeneralProfileTab.FIRST_NAME.getLabel(), TextBox.class).verify.value(mapVendorValues.get(FIRST_NAME));
        assetList.getControl(ProfileMetaData.GeneralProfileTab.LAST_NAME.getLabel(), TextBox.class).verify.value(mapVendorValues.get(LAST_NAME));

        assetList.getControl(ProfileMetaData.GeneralProfileTab.MIDDLE_NAME.getLabel(), TextBox.class).verify.value(
                tdVendorProfileData.getValue(GeneralProfileTab.class.getSimpleName(), ProfileMetaData.GeneralProfileTab.MIDDLE_NAME.getLabel()));
        assetList.getControl(ProfileMetaData.GeneralProfileTab.EFFECTIVE_DATE.getLabel(), TextBox.class).verify.value(
                tdVendorProfileData.getValue(GeneralProfileTab.class.getSimpleName(), ProfileMetaData.GeneralProfileTab.EFFECTIVE_DATE.getLabel()));
        ...
        assetList.getControl(ProfileMetaData.GeneralProfileTab.JOB_TITLE.getLabel(), TextBox.class).verify.value(
                tdVendorProfileData.getValue(GeneralProfileTab.class.getSimpleName(), ProfileMetaData.GeneralProfileTab.JOB_TITLE.getLabel()));
        assetList.getControl(ProfileMetaData.GeneralProfileTab.SIGNATURE_URI.getLabel(), TextBox.class).verify.value(
                tdVendorProfileData.getValue(GeneralProfileTab.class.getSimpleName(), ProfileMetaData.GeneralProfileTab.SIGNATURE_URI.getLabel()));
        ...
        assetList.getControl(ProfileMetaData.GeneralProfileTab.USER_LOGIN.getLabel(), TextBox.class).verify.value(mapVendorValues.get(LOGIN));
        ...
        assetList.getControl(ProfileMetaData.GeneralProfileTab.CATEGORY.getLabel(), ComboBox.class).verify.value("Service Provide");
    ...
    private void validateRelationshipReflectedMS() {
        ...
        generalProfileTab.verifyFieldHasValue("User Subordinates", mapVendorValues.get(LAST_NAME) + ", " + mapVendorValues.get(FIRST_NAME));
        ...
        generalProfileTab.verifyFieldHasValue("Managers", mapVendorValues.get(LAST_NAME) + ", " + mapVendorValues.get(FIRST_NAME));
