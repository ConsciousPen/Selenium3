...
public interface AaaDocGenEntityQueries {
    ...
    enum EventNames {
        RENEWAL_OFFER, PREMIUM_CALCULATED, CANCEL_MIDTERM, ENDORSEMENT_ISSUE, ADHOC_DOC_GENERATE, POLICY_ISSUE, PRE_RENEWAL, ADHOC_DOC_ON_DEMAND_GENERATE, RENEWAL_BILL
    }
