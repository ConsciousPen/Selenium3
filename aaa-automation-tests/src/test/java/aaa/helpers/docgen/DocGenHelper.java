...
public class DocGenHelper {
	...
	public static StandardDocumentRequest verifyDocumentsGenerated(boolean verifyExists, String policyNumber, DocGenEnum.Documents... documents) {
		return verifyDocumentsGenerated(verifyExists, false, policyNumber, documents);
	}
	 ...
	 */
	public static StandardDocumentRequest verifyDocumentsGenerated(boolean verifyExists, boolean generatedByJob, String policyNumber, DocGenEnum.Documents... documents) {
