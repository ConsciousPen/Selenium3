...
public class VehicleQueries {
    ...
    public static final  String DELETE_CHOICE_FROM_VEHICLEREFDATAVINCONTROL_BY_MSRP_VERSION = "DELETE FROM vehiclerefdatavincontrol WHERE MSRP_VERSION='MSRP_2000_CHOICE_TEST'";
