...
public class VehicleQueries {
	...
	public static final String REPAIR_SPECIFIED_COLLCOMP = "UPDATE Vehiclerefdatavin SET PHYSICALDAMAGECOLLISION ='35', PHYSICALDAMAGECOMPREHENSIVE ='44' where vin like '%s' and VERSION like 'SYMBOL_2000'";
