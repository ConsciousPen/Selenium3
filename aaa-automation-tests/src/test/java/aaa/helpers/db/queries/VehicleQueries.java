...
public class VehicleQueries {
    ...
    public static final  String DELETE_FROM_VEHICLEREFDATAVINCONTROL_BY_MSRPVERSION = "DELETE FROM vehiclerefdatavincontrol WHERE MSRP_VERSION='MSRP_2000_CHOICE_TEST";
