...
public class VehicleQueries {
	...
	public static final String PAYMENT_CENTRAL_CONFIG_CHECK = "select value from PROPERTYCONFIGURERENTITY where propertyname in('aaaBillingAccountUpdateActionBean.ccStorateEndpointURL','aaaPurchaseScreenActionBean.ccStorateEndpointURL','aaaBillingActionBean.ccStorateEndpointURL')";
		...
		//Cleanup query for file upload PAS-12872
	public static final String UPDATE_VEHICLEREFDATAVIN_VALID_NEWPOLICY_AUTO_SS_CLEANUP = "UPDATE VEHICLEREFDATAVIN SET VALID = '1' where vin like '1G1ZJ5SU%G' and VERSION ='SYMBOL_2000' and MAKE_TEXT ='CHEVROLET'";
	public static final String DELETE_VEHICLEREFDATAVIN_REFRESHABLE_VIN_CLEANER1_SS = "Delete from VEHICLEREFDATAVIN WHERE vin like '1G1ZJ5SU%G' and MAKE_TEXT = 'CHEVROLET AUTO'";
	public static final String UPDATE_VEHICLEREFDATAVIN_VALID_RENEWAL_AUTO_SS_CLEANUP = "UPDATE VEHICLEREFDATAVIN SET VALID = '1' where vin like '3FADP4BE%H' and VERSION ='SYMBOL_2000' and MAKE_TEXT ='FORD'";
	public static final String DELETE_VEHICLEREFDATAVIN_REFRESHABLE_VIN_CLEANER2_SS = "Delete from VEHICLEREFDATAVIN WHERE vin like '3FADP4BE%H'  and MAKE_TEXT = 'FORD MOTOR'";
	public static final String UPDATE_VEHICLEREFDATAVIN_VALID_NEWPOLICY_CA_CHOICE_CLEANUP = "UPDATE VEHICLEREFDATAVIN SET VALID = '1' where vin like 'KMHCN35C%9' and VERSION ='SYMBOL_2000_CHOICE' and MAKE_TEXT ='HYUNDAI'";
	public static final String DELETE_VEHICLEREFDATAVIN_REFRESHABLE_VIN_CLEANER1_CAC =  "Delete from VEHICLEREFDATAVIN WHERE vin like 'KMHCN35C%9'  and MAKE_TEXT = 'HYUNDAI MOTOR'";
	public static final String UPDATE_VEHICLEREFDATAVIN_VALID_ONRENEWAL_CA_CHOICE_CLEANUP = "UPDATE VEHICLEREFDATAVIN SET VALID = '1' where vin like '1N4BL3AP%H' and VERSION ='SYMBOL_2000_CHOICE' and MAKE_TEXT ='NISSAN'";
	public static final String DELETE_VEHICLEREFDATAVIN_REFRESHABLE_VIN_CLEANER2_CAC = "Delete from VEHICLEREFDATAVIN WHERE vin like '1N4BL3AP%H'  and MAKE_TEXT = 'NISSAN MOTOR'";
	public static final String UPDATE_VEHICLEREFDATAVIN_VALID_NEWPOLICY_CA_SELECT_CLEANUP ="UPDATE VEHICLEREFDATAVIN SET VALID = '1' where vin like '3VW637AJ%G' and VERSION ='SYMBOL_2000' and MAKE_TEXT ='VOLKSWAGEN'";
	public static final String DELETE_VEHICLEREFDATAVIN_REFRESHABLE_VIN_CLEANER1_CAS = "Delete from VEHICLEREFDATAVIN WHERE vin like '3VW637AJ%G'  and MAKE_TEXT = 'VOLKSWAGEN AG'";
	public static final String UPDATE_VEHICLEREFDATAVIN_VALID_RENEWAL_CA_SELECT_CLEANUP = "UPDATE VEHICLEREFDATAVIN SET VALID = '1' where vin like 'JTEDC3EH%B' and VERSION ='SYMBOL_2000' and MAKE_TEXT ='TOYOTA'";
	public static final String DELETE_VEHICLEREFDATAVIN_REFRESHABLE_VIN_CLEANER2_CAS = "Delete from VEHICLEREFDATAVIN WHERE vin like 'JTEDC3EH%B'  and MAKE_TEXT = 'TOYOTA MOTOR'";
}
