...
import static aaa.utils.JobRunner.restartAsyncManager;
...
//Execution with dependencies
	...
	@Parameters({"state"})
	@Test(dependsOnMethods="RUN_12_AAACANCELLATIONCONFIRMATIONASYNCJOB")
	...
	@Parameters({"state"})
	@Test(dependsOnMethods="RUN_31_AAAAUTOMATEDPROCESSINGINITIATIONJOB")
	...
	@Parameters({"state"})
	@Test(dependsOnMethods="RUN_36_AUTOMATEDPROCESSINGBYPASSINGANDERRORSREPORT")
