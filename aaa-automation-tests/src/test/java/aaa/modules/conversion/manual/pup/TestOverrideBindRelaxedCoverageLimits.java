...
public class TestOverrideBindRelaxedCoverageLimits extends ConvPUPBaseTest {
    ...
    public void pas6971_TestOverrideBindLimitsNB(@Optional("") String state) {
    ...
    @Test(groups = {Groups.FUNCTIONAL, Groups.MEDIUM})
    @TestInfo(component = ComponentConstant.Sales.PUP, testCaseId = "PAS-6971")
    public void pas6971_TestOverrideBindLimitsConversion(@Optional("") String state) {
    ...
    @Test(groups = {Groups.FUNCTIONAL, Groups.MEDIUM})
    @TestInfo(component = ComponentConstant.Sales.PUP, testCaseId = "PAS-6971")
    public void pas6971_TestOverrideBindAutoCombinedSingleLimitNB(@Optional("") String state) {
    ...
    @Test(groups = {Groups.FUNCTIONAL, Groups.MEDIUM})
    @TestInfo(component = ComponentConstant.Sales.PUP, testCaseId = "PAS-6971")
    public void pas6971_TestOverrideBindAutoCombinedSingleLimitConversion(@Optional("") String state) {
