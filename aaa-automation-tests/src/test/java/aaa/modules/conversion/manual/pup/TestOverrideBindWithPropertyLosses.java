...
public class TestOverrideBindWithPropertyLosses extends ConvPUPBaseTest {
    ...
    public void pas7242TestOverrideBindWithPropertyLossesNB(@Optional("NJ") String state) {
    ...
    @Test(groups = {Groups.FUNCTIONAL, Groups.MEDIUM})
    @TestInfo(component = ComponentConstant.Sales.PUP, testCaseId = "PAS-7242")
    public void pas7242TestOverrideBindWithPropertyLossesConversion(@Optional("NJ") String state) {
