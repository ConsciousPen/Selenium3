...
public class HomeCaHO6PremiumCalculationTest extends HomeCaPremiumCalculationTest<HomeCaHO6OpenLPolicy, OpenLTest> {
	...
	public void premiumCalculationTest(@Optional("") String state, String fileName, @Optional("") String policyNumbers) {
		...
		verifyPremiums(fileName, HomeCaHO6OpenLPolicy.class, OpenLTest.class, tdGenerator, getPolicyNumbers(policyNumbers));
	}
}
