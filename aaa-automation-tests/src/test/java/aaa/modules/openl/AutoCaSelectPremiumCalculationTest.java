...
public class AutoCaSelectPremiumCalculationTest extends AutoCaPremiumCalculationTest<AutoCaSelectOpenLPolicy, OpenLTest> {
	...
	public void premiumCalculationTest(@Optional("") String state, String fileName, @Optional("") String policyNumbers) {
		...
		verifyPremiums(fileName, AutoCaSelectOpenLPolicy.class, OpenLTest.class, tdGenerator, getPolicyNumbers(policyNumbers));
	}
}
