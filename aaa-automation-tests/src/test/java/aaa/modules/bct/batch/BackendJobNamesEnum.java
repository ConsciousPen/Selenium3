...
public enum BackendJobNamesEnum {
	...
	POLICY_LAPSED_RENEWAL_PROCESS_ASYNC_JOB(BCTJobs.grouplapsedRenewalProcessJob, BatchJob.policyLapsedRenewalProcessAsyncJob, "policyLapsedRenewalProcessAsyncJob"),
