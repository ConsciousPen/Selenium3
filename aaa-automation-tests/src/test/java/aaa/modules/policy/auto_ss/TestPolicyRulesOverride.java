...
public class TestPolicyRulesOverride extends AutoSSBaseTest {
	...
	public void testPolicyRulesOverride() {
		...
		TestData class_td = getStateTestData(tdPolicy, this.getClass().getSimpleName(), "TestData");
		...
		policy.updateRulesOverride().perform(tdPolicy.getTestData(this.getClass().getSimpleName(), "UpdateRulesTestData_1"));
		...
		policy.updateRulesOverride().perform(tdPolicy.getTestData(this.getClass().getSimpleName(), "UpdateRulesTestData_2"));
