...
public class TestQuoteViewRatingDetailsCompCollSymbolsPresence extends AutoSSBaseTest{
    ...
    public void testQuoteRatingViewDetailsCompCollSymbolsArePresentAndNotEmpty() {
        ...
        policy.initiate();
        policy.getDefaultView().fillUpTo(getStateTestData(tdPolicy, "DataGather", "TestData"), VehicleTab.class, true);

        new VehicleTab().addVehicle(getStateTestData(tdPolicy, "DataGather", "TestData"));
