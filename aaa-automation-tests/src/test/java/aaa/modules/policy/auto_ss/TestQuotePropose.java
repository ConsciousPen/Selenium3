...
public class TestQuotePropose extends AutoSSBaseTest {
    ...
    public void testQuotePropose() {
        ...
        policy.propose().start();
        policy.propose().getView().getTab(ProposeActionTab.class).getAssetList().getAsset(AutoSSMetaData.ProposeActionTab.NOTES.getLabel()).verify.enabled();
        ...
        policy.propose().getView().getTab(ProposeActionTab.class).getAssetList().getAsset(AutoSSMetaData.ProposeActionTab.NOTES.getLabel(), TextBox.class).setValue("Comment");
