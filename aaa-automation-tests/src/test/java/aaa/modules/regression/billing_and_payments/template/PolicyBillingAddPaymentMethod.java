...
public abstract class PolicyBillingAddPaymentMethod extends PolicyBaseTest{
	...
	public void testAddPaymentMethods() {
        ...
        //Navigate to Update Billing Account tab and verify that AutoPay Selection dropdown contains added CC and EFT payment methods
        ...
        String paymentMethodEFT = AddPaymentMethodsMultiAssetList.tablePaymentMethods.getRow(1).getCell("Payment Method").getValue();
