...
public class TestMiniServicesVehiclesHelper extends PolicyBaseTest {
	...
	protected void pas9493_TransactionInformationForEndorsementsAddRemoveVehicleBody(PolicyType policyType, SoftAssertions softly) {
		...
		assertThat(veh1.data.modelYear).isEqualTo("2006");
		assertThat(veh1.data.manufacturer).isEqualTo("HONDA");
		assertThat(veh1.data.series).isEqualTo("CIVIC LX");
		assertThat(veh1.data.model).isEqualTo("CIVIC");
		assertThat(veh1.data.bodyStyle).isEqualTo("SEDAN 4 DOOR");
		assertThat(veh1.data.oid).isEqualTo(oid1);
		assertThat(veh1.data.purchaseDate).startsWith(purchaseDate);
		assertThat(veh1.data.vehIdentificationNo).isEqualTo(vin1);
		assertThat(veh1.data.vehicleStatus).isEqualTo("pending");
		assertThat(veh1.data.usage).isEqualTo("Pleasure");
		assertThat(veh1.data.salvaged).isEqualTo(false);
		assertThat(veh1.data.garagingDifferent).isEqualTo(false);
		assertThat(veh1.data.antiTheft).isEqualTo("NONE");
		assertThat(veh1.data.registeredOwner).isEqualTo(true);
		assertThat(veh1.data.vehTypeCd).isEqualTo("PPA");
		//Garaging Address
		assertThat(veh1.garagingAddress.changeType).isEqualTo("ADDED");
		assertThat(veh1.garagingAddress.data.addressLine1).isNotEmpty();
		assertThat(veh1.garagingAddress.data.addressLine2).isEqualTo(null);
		assertThat(veh1.garagingAddress.data.city).isNotEmpty();
		assertThat(veh1.garagingAddress.data.stateProvCd).isNotEmpty();
		assertThat(veh1.garagingAddress.data.postalCode).isNotEmpty();
		//Vehicle Ownership
		assertThat(veh1.vehicleOwnership.changeType).isEqualTo("ADDED");
		assertThat(veh1.vehicleOwnership.data.ownership).isEqualTo("OWN");
		assertThat(veh1.vehicleOwnership.data.name).isEqualTo(null);
		assertThat(veh1.vehicleOwnership.data.secondName).isEqualTo(null);
		assertThat(veh1.vehicleOwnership.data.addressLine1).isEqualTo(null);
		assertThat(veh1.vehicleOwnership.data.addressLine2).isEqualTo(null);
		assertThat(veh1.vehicleOwnership.data.city).isEqualTo(null);
		assertThat(veh1.vehicleOwnership.data.stateProvCd).isEqualTo(null);
		assertThat(veh1.vehicleOwnership.data.postalCode).isEqualTo(null);
		...
		assertThat(veh2.data.modelYear).isEqualTo("2001");
		assertThat(veh2.data.manufacturer).isEqualTo("FORD");
		assertThat(veh2.data.series).isEqualTo("FOCUS ZX3");
		assertThat(veh2.data.model).isEqualTo("FOCUS");
		assertThat(veh2.data.bodyStyle).isEqualTo("3 DOOR COUPE");
		assertThat(veh2.data.oid).isEqualTo(oid2);
		...
		assertThat(veh2.data.vehIdentificationNo).isEqualTo(vin2);
		assertThat(veh2.data.vehicleStatus).isEqualTo("pending");
		assertThat(veh2.data.usage).isEqualTo("Pleasure");
		assertThat(veh2.data.salvaged).isEqualTo(false);
		assertThat(veh2.data.garagingDifferent).isEqualTo(false);
		assertThat(veh2.data.antiTheft).isEqualTo("NONE");
		assertThat(veh2.data.registeredOwner).isEqualTo(true);
		assertThat(veh2.data.vehTypeCd).isEqualTo("PPA");
		//Garaging Address
		assertThat(veh2.garagingAddress.changeType).isEqualTo("ADDED");
		assertThat(veh2.garagingAddress.data.addressLine1).isNotEmpty();
		assertThat(veh2.garagingAddress.data.addressLine2).isEqualTo(null);
		assertThat(veh2.garagingAddress.data.city).isNotEmpty();
		assertThat(veh2.garagingAddress.data.stateProvCd).isNotEmpty();
		assertThat(veh2.garagingAddress.data.postalCode).isNotEmpty();
		//Vehicle Ownership
		assertThat(veh2.vehicleOwnership.changeType).isEqualTo("ADDED");
		assertThat(veh2.vehicleOwnership.data.ownership).isEqualTo("OWN");
		assertThat(veh2.vehicleOwnership.data.name).isEqualTo(null);
		assertThat(veh2.vehicleOwnership.data.secondName).isEqualTo(null);
		assertThat(veh2.vehicleOwnership.data.addressLine1).isEqualTo(null);
		assertThat(veh2.vehicleOwnership.data.addressLine2).isEqualTo(null);
		assertThat(veh2.vehicleOwnership.data.city).isEqualTo(null);
		assertThat(veh2.vehicleOwnership.data.stateProvCd).isEqualTo(null);
		assertThat(veh2.vehicleOwnership.data.postalCode).isEqualTo(null);
		...
		softly.assertThat(veh1nd.garagingAddress.data.addressLine2).isEqualTo(null);
