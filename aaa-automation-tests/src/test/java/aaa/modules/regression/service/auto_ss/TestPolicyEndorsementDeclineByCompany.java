...
/**
 * @author Yonggang Sun
 * <b> Test endorsement decline by company for Auto Policy </b>
 * <p> Steps:
 * <p> 1. Create Customer
 * <p> 2. Create Auto (AAA) Policy
 * <p> 3. Create endorsement
 * <p> 4. Decline by company
 * <p> 5. Verify Policy status is 'Company Declined' in endorsement
 *
 */
public class TestPolicyEndorsementDeclineByCompany extends PolicyEndorsementDeclineByCompany {
    ...
    public void testPolicyEndorsementDeclineByCompany(@Optional("") String state) {
		testPolicyEndorsementDeclineByCompany();
    }
}
