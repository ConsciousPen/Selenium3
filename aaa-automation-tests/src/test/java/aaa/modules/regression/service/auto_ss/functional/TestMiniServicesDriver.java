...
public class TestMiniServicesDriver extends TestMiniServicesDriversHelper {
	...
	@Parameters({"state"})
	@Test(groups = {Groups.FUNCTIONAL, Groups.CRITICAL})
	@StateList(states = {Constants.States.VA,Constants.States.OR, Constants.States.AZ, Constants.States.NY})
	...
	@Parameters({"state"})
	@Test(groups = {Groups.FUNCTIONAL, Groups.CRITICAL})
	@StateList(states = {Constants.States.VA,Constants.States.OR, Constants.States.CT})
	@TestInfo(component = ComponentConstant.Service.AUTO_SS, testCaseId = {"PAS-16696"})
