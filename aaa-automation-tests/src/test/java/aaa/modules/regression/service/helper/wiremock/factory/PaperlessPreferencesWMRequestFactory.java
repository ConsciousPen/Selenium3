...
import aaa.modules.regression.service.helper.wiremock.dto.*;
...
public class PaperlessPreferencesWMRequestFactory {
    ...
    public static WireMockMappingRequest create(String policyNumber, String scenarioJsonFileName) {
        ...
        MatchesJsonPathBodyPattern matchesJsonPathBodyPattern = new MatchesJsonPathBodyPattern();
        matchesJsonPathBodyPattern.expression = EXPRESSION;
        matchesJsonPathBodyPattern.contains = policyNumber;
        bodyPattern.matchesJsonPath = matchesJsonPathBodyPattern;
