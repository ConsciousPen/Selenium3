...
import com.exigen.ipb.etcsa.utils.report.TestRunEmail;
...
/**
 * @author Lina Li
 * @name Test Mask Driver License Number for Auto Policy with privilege
 * @scenario
 * 1. Create Customer
 * 2. Create Auto policy
 * 3. Login with E34 role make endorsement other than driver check mask DLN PASBB-951
 * 4. Login with G36 role make endorsement to change driver license check mask DLN- PASBB-950
 * 5. Login with L41 role make out of sequence endorsement to check mask DLN PASBB-954
 * @details
 */
public class TestMaskDlnEndorsementWithPrivilege extends AutoSSBaseTest{
