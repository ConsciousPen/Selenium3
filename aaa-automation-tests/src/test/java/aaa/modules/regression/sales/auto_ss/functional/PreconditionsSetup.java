...
public class PreconditionsSetup implements EvalueInsertSetupPreConditions {
    ...
    private static final String GET_POLICY_NUMBER_RANGE = "select indx from NumberRange\n"
            + "where ENTITYCLASS = 'com.exigen.ipb.policy.domain.PolicySummary'";
    ...
    public static void numberRangeUpdate() {
    ...
    private static void setNumberRangeForPolicy(String s) {
