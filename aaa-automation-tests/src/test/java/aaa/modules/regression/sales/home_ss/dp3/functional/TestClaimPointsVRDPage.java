...
public class TestClaimPointsVRDPage extends TestClaimPointsVRDPageAbstract {
	 ...
	 * @name Test Claims points refresh on VRD page for SS DP3 policies during NB. Updated with PAS-6730
	 * @scenario
	 * 1.  Create customer
	...
	@TestInfo(component = ComponentConstant.Sales.HOME_SS_DP3, testCaseId = "PAS-17772, PAS-6730")
