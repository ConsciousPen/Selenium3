...
public class TestMembershipPendingCA extends HomeCaHO3BaseTest {
    ...
    private void premiumAndDiscountCheckAAANo() {
        ...
        assertThat(PremiumsAndCoveragesQuoteTab.tableDiscounts.getRow(1).getCell("Discounts applied")).hasValue("New home");
    }
    ...
    private void premiumAndDiscountCheckAAAPending() {
        ...
        assertThat(PremiumsAndCoveragesQuoteTab.tableDiscounts.getRow(1).getCell("Discounts applied")).hasValue("New home, AAA Membership");
    }
