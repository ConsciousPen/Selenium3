...
public class TestCurrentTermEndAddsVehicle extends AutoCaChoiceBaseTest{
    ...
    @TestInfo(component = ComponentConstant.Sales.AUTO_CA_CHOICE, testCaseId = "PAS-14532")
    ...
    public void pas14532_refreshForCurrentAndRenewalTerms(@Optional("CA") String state, String scenario) {
       ...
       // String controlTableFile = "controlTable_CA.xlsx";
        ...
        if (scenario.equals("NOT_MATCHED")) { //Assertion for scenario 1
            ...
            softly.assertThat(tableRatingDetailsVehicles.getRow(1, "Coll Symbol").getCell(2).getValue()).isEqualTo("20");
            ...
            softly.assertThat(tableRatingDetailsVehicles.getRow(1, "Comp Symbol").getCell(3).getValue()).isEqualTo("6");
            softly.assertThat(tableRatingDetailsVehicles.getRow(1, "Coll Symbol").getCell(3).getValue()).isEqualTo("6");
            ...
            softly.assertThat(tableRatingDetailsVehicles.getRow(1, "Comp Symbol").getCell(4).getValue()).isEqualTo("13");
            softly.assertThat(tableRatingDetailsVehicles.getRow(1, "Coll Symbol").getCell(4).getValue()).isEqualTo("13");
            ...
            softly.assertThat(tableRatingDetailsVehicles.getRow(1, "Comp Symbol").getCell(2).getValue()).isEqualTo("77");
            softly.assertThat(tableRatingDetailsVehicles.getRow(1, "Coll Symbol").getCell(2).getValue()).isEqualTo("77");
            ...
            softly.assertThat(tableRatingDetailsVehicles.getRow(1, "Comp Symbol").getCell(2).getValue()).isEqualTo("8");
            softly.assertThat(tableRatingDetailsVehicles.getRow(1, "Coll Symbol").getCell(2).getValue()).isEqualTo("8");

            // The second Vehicle - NOT updated will not change/not refresh;
            softly.assertThat(tableRatingDetailsVehicles.getRow(1, "Make").getCell(3).getValue()).isEqualToIgnoringCase("BMW MOTOR");
            softly.assertThat(tableRatingDetailsVehicles.getRow(1, "Comp Symbol").getCell(3).getValue()).isEqualTo("7");
            softly.assertThat(tableRatingDetailsVehicles.getRow(1, "Coll Symbol").getCell(3).getValue()).isEqualTo("7");
    ...
    public TestData getTestDataWithTwoVehicles(TestData testData, String scenario) {
        ...
        TestData testDataDocumentsAndBindTab = getTestSpecificTD("DocumentsAndBindTab_TestDataCurrentTermEndAddsVehicle");
