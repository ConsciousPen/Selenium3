...
public class TestRenewalBillDiscardAndMessageOnPaymentPlanChange extends HomeSSDP3BaseTest {
	...
	@TestInfo(component = ComponentConstant.Sales.HOME_SS_DP3, testCaseId = "PAS-16405, PAS-16526")
	...
	public void testRenewalBillDiscardAndMessageOnPaymentPlanChange_AutoPay_ManualBillGeneration(@Optional("") String state) {
		...
		template.testRenewalBillDiscardAndMessageOnPaymentPlanChange(getPolicyType(), BillingConstants.PaymentPlan.QUARTERLY,
				...
				template.automaticPaymentMessage, BillingConstants.PaymentPlan.QUARTERLY_RENEWAL);
	}
}
