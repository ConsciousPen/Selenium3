...
public class TestOffCycleBillNoInstallmentDate extends TestOffCycleBillNoInstallmentDateAbstract {
     ...
     * @name Test balance is invoiced as off cycle bill for SS HO3 policy when there is no future installment date on NB
     * @scenario
     * 1. Create new customer
     * 2. Initiate SS HO3 policy and fill up to Purchase tab
	...
	/**
	 * @author Josh Carpenter
	 * @name Test balance is invoiced as off cycle bill for SS HO3 policy when there is no future installment date for endorsements
	 * @scenario
	 * 1. Create new customer
	 * 2. Create/bind SS HO3 policy (pay in full)
