...
public class TestEndorsementPremiumEntries extends TestEndorsementPremiumEntriesTemplate {
     ...
     * @name Test no duplicate endorsement premium entries exist for CA HO6 copied policies
     * @scenario
     * 1. Create policy
    ...
    @TestInfo(component = ComponentConstant.Sales.HOME_CA_HO6, testCaseId = {"PAS-19204"})
    ...
    /**
     * @author Josh Carpenter
     * @name Test no duplicate endorsement premium entries exist for CA HO6 copied quotes
     * @scenario
    ...
    /**
     * @author Josh Carpenter
     * @name Test no duplicate endorsement premium entries exist for CA HO6 renewals
     * @scenario
     * 1. Create policy
     * 2. Validate Included Endorsements matches what is on P & C tab under Endorsements section (name and amount)
     * 3. Validate DB entries match the included endorsements by name and amount and contain no duplicates
    ...
    /**
     * @author Josh Carpenter
     * @name Test no duplicate endorsement premium entries exist for CA HO6 rewrites
     * @scenario
     * 1. Create policy
     * 2. Validate Included Endorsements matches what is on P & C tab under Endorsements section (name and amount)
     * 3. Cancel policy
