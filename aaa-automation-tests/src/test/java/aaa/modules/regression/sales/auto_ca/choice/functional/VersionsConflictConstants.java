...
/*			.putAll("Vehicle Information (1998, DODGE, CARAVAN, SPORT VAN).Ownership Type", "Financed","Owned")
	...
	//TODO should be deleted when Policy Information.Renewal Term Premium - Old Rater is fixed, RenewalMerge test need to have POLICY_INFORMATION_VERSION_1, not policyInformationRenewal
	//all components/attributes that should be on Comparison page Renewal or Endorsement
