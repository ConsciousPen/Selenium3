...
public class TestInaccurateRatingFromOmittedPoints extends AutoCaSelectBaseTest {
	...
	String _productTypeExpectedThroughoutNewBusiness;
	String _productDetermined;
	String _capturedPremiumValue;
	...
	private TestData buildTestData(String firstName, String middleName, String lastName, String DOB, String address, String zip, String city, String licenseNumber) {
		...
		TestDataHelper.adjustTD(td, PrefillTab.class, AutoCaMetaData.PrefillTab.FIRST_NAME.getLabel(), firstName);
		TestDataHelper.adjustTD(td, PrefillTab.class, AutoCaMetaData.PrefillTab.MIDDLE_NAME.getLabel(), middleName);
		TestDataHelper.adjustTD(td, PrefillTab.class, AutoCaMetaData.PrefillTab.LAST_NAME.getLabel(), lastName);
		TestDataHelper.adjustTD(td, PrefillTab.class, AutoCaMetaData.PrefillTab.DATE_OF_BIRTH.getLabel(), DOB);
		TestDataHelper.adjustTD(td, PrefillTab.class, AutoCaMetaData.PrefillTab.ADDRESS_LINE_1.getLabel(), address);
		TestDataHelper.adjustTD(td, PrefillTab.class, AutoCaMetaData.PrefillTab.ZIP_CODE.getLabel(), zip);
		TestDataHelper.adjustTD(td, PrefillTab.class, AutoCaMetaData.PrefillTab.CITY.getLabel(), city);
		TestDataHelper.adjustTD(td, DriverTab.class, AutoCaMetaData.DriverTab.LICENSE_NUMBER.getLabel(), licenseNumber);
		TestDataHelper.adjustTD(td, PremiumAndCoveragesTab.class, AutoCaMetaData.PremiumAndCoveragesTab.BODILY_INJURY_LIABILITY.getLabel(), "$100,000/$300,000 (+$0.00)"); //This line is required to satisfy some of the policy creation requirements in PAS.
