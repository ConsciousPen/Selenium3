...
public class TestOverrideWildfireScore extends TestUpdateWildfireScoreTemplate {
	 ...
	 * @name Test Update Wildfire Score DP3 - No privilege, NB
	 * @scenario
	...
	/**
	 * @author Dominykas Razgunas
	 * @name Test Update Wildfire Score DP3 - No Privilege, Endorsement
	 * @scenario
	 * 1. Sign in with unprivileged User.
	 * 2. Create Customer.
	...
	/**
	 * @author Dominykas Razgunas
	 * @name Test Update Wildfire Score DP3 - NB
	 * @scenario
	...
	/**
	 * @author Dominykas Razgunas
	 * @name Test Update Wildfire Score DP3 - Endorsement
	 * @scenario
	 * 1. Sign in with privileged User.
	 * 2. Create Customer.
	...
	/**
	 * @author Dominykas Razgunas
	 * @name Test Update Wildfire Score DP3 - Renewal
	 * @scenario
	 * 1. Sign in with privileged User.
	 * 2. Create Customer.
	...
	/**
	 * @author Dominykas Razgunas
	 * @name Test Update Wildfire Score DP3 - Renewal Manual Entry
	 * @scenario
	 * 1. Sign in with privileged User.
	 * 2. Create Customer.
