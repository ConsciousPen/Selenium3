...
public class TestFireline extends TestFirelineTemplate {
    ...
    @TestInfo(component = ComponentConstant.Sales.HOME_SS_DP3, testCaseId = "PAS-21652")
    public void pas21652_firelineScore_GreaterThan_firelineLookupTable(@Optional("AZ") String state) {
        pas21652_SS_firelineRuleForFirelineTableLookup("85713", "4315 E Thunderbird Rd", 7,6, PrivilegeEnum.Privilege.L41,ADDRESS);
    }
    ...
    public void pas21652_firelineScore_GreaterThan_notIN_firelineLookupTable(@Optional("AZ") String state) {
        pas21652_SS_firelineRuleForFirelineTableLookup("85192", "14602 N 19th Ave", 5,4, PrivilegeEnum.Privilege.L41,ADDRESS);
    }
    ...
    public void pas21652_firelineScore_EqualORLess_firelineLookupTable(@Optional("AZ") String state) {
        pas21652_SS_firelineRuleForFirelineTableLookup("85019", "4315 E Thunderbird Rd", 6, 6, PrivilegeEnum.Privilege.L41,ADDRESS);
    }
    ...
    @Test(groups = {Groups.FUNCTIONAL, Groups.CRITICAL}, description = "Fireline rules for the Fireline Lookup table  - SS")
    @TestInfo(component = ComponentConstant.Sales.HOME_SS_DP3, testCaseId = "PAS-21652")
    public void pas21652_firelineScore_EqualORLess_notIN_firelineLookupTable(@Optional("AZ") String state) {
        pas21652_SS_firelineRuleForFirelineTableLookup("85065", "4315 E Thunderbird Rd", 4, 4, PrivilegeEnum.Privilege.L41,ADDRESS);
    }
     ...
     * 8. Check that Error tab appeared
     * 9. Verify the underwriting error AAA_HO_Fireline fires
     * 10. Verify that they have the ability to override the rule
     * @details
     */
    @Parameters({"state"})
    @Test(groups = {Groups.FUNCTIONAL, Groups.CRITICAL}, description = "Fireline rules for the Fireline Lookup table  - SS")
    @TestInfo(component = ComponentConstant.Sales.HOME_SS_DP3, testCaseId = "PAS-21652")
    public void pas21652_firelineRules_overridePrivileged(@Optional("AZ") String state) {
        pas21652_SS_firelineRuleForFirelineTableLookup("85713", "4315 E Thunderbird Rd", 7, 6,PrivilegeEnum.Privilege.L41,ADDRESS);
    }
    ...
    public void pas21652_firelineRules_notOverridePrivileged(@Optional("AZ") String state) {
        pas21652_SS_firelineRuleForFirelineTableLookup("85713", "4315 E Thunderbird Rd", 7,6, PrivilegeEnum.Privilege.F35,ADDRESS);
    }
    ...
    public void pas18302_firelineRuleForWoodShingleRoofs_noTrigger_privileged(@Optional("AZ") String state) {
        pas21652_SS_firelineRuleForFirelineTableLookup("85601", "4315 E Thunderbird Rd", 2,6, PrivilegeEnum.Privilege.L41,ADDRESS);
    }
    ...
    public void pas18302_firelineRuleForWoodShingleRoof_trigger_privileged(@Optional("AZ") String state) {
        pas21652_SS_firelineRuleForFirelineTableLookup("85741", "4315 E Thunderbird Rd", 4,6, PrivilegeEnum.Privilege.L41,ADDRESS);
    }
    ...
    public void pas21652_firelineRules_addressLevelNotMatched(@Optional("AZ") String state) {
        pas21652_SS_firelineRuleForFirelineTableLookup("85032", "4315 E Thunderbird Rd", 7,6, PrivilegeEnum.Privilege.L41,ZIP);
    }
