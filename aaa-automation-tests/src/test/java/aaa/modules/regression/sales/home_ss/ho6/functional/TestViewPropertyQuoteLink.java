...
public class TestViewPropertyQuoteLink extends TestViewPropertyQuoteLinkTemplate {
    ...
    @TestInfo(component = ComponentConstant.Sales.HOME_SS_HO6, testCaseId = "PAS-14842")
    public void pas14842_testViewPropertyQuoteLinkSSHO6NB(@Optional("") String state) {
