...
public class TestVersionsComparison extends TestComparisonConflictAbstract {
	...
	public void pas14145_endorsementsComparisonVehicleInformation(@Optional("CA") String state) {
		endorsementComparison(getTDVehicleInformationVersion1(), getTDVehicleInformationVersion2(), VersionsComparisonConstants.vehicleInformation, "VehicleTab", "VehicleInformation");
	}
