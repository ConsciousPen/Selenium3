...
public class TestZeroClaimsDiscount extends TestZeroClaimsDiscountTemplate {
	 ...
	 * @name Test Zero Claims Discount for SS HO3 Quotes, Updated with PAS-6730
	 * @scenario
	 * 1. Create customer
	 ...
	 **/
	@Parameters({"state"})
	@Test(groups = {Groups.FUNCTIONAL, Groups.HIGH}, description = "Test Zero Claims Discount for SS HO3 Quote")
	@TestInfo(component = ComponentConstant.Sales.HOME_SS_HO3, testCaseId = "PAS-9088, PAS-6730")
	...
	/**
	 * @author Josh Carpenter, Dominykas Razgunas
	 * @name Test Zero Claims Discount for SS HO3 Renewals, Updated with PAS-6730
	 * @scenario
	 * 1. Create customer
	 * 2. Create SS HO3 Policy
	 ...
	 **/
	@Parameters({"state"})
	@Test(groups = {Groups.FUNCTIONAL, Groups.HIGH}, description = "Test Zero Claims Discount for SS HO3 Renewals")
	@TestInfo(component = ComponentConstant.Sales.HOME_SS_HO3, testCaseId = "PAS-9088, PAS-6730")
	public void pas9088_testZeroClaimsDiscountHO3Renewal(@Optional("") String state) {
