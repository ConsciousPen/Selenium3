...
public class TestViewPropertyQuoteLink extends TestViewPropertyQuoteLinkTemplate {
    ...
    @TestInfo(component = ComponentConstant.Sales.HOME_CA_HO3, testCaseId = "PAS-14842")
    public void pas14842_testViewPropertyQuoteLinkCAHO3NB(@Optional("") String state) {
