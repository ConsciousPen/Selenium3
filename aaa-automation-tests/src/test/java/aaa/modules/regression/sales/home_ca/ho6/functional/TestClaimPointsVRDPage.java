...
public class TestClaimPointsVRDPage extends TestClaimPointsVRDPageAbstract {
	 ...
	 * @name Test Claims points refresh on VRD page for CA HO6 policies during NB. Updated with PAS-6730
	 * @scenario
	 * 1.  Create customer
	 * 2.  Initiate CA HO6 quote
	...
	@TestInfo(component = ComponentConstant.Service.HOME_CA_HO6, testCaseId = "PAS-19183, PAS-6730")
