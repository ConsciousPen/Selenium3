...
public class TestRestrictedPaymentPlan extends TestRestrictedPaymentPlanAbstract {
	...
	public void pas10870_restrictionPaymentPlansMembershipYes(@Optional("NJ") String state) throws NoSuchFieldException {
	...
	@Test(groups = {Groups.FUNCTIONAL, Groups.CRITICAL})
	@TestInfo(component = ComponentConstant.DocumentFulfillment.HOME_SS_HO4, testCaseId = {"PAS-2305"})
	public void pas10870_restrictionPaymentPlansMembershipPending(@Optional("DE") String state) throws NoSuchFieldException {
	...
	@Test(groups = {Groups.FUNCTIONAL, Groups.CRITICAL})
	@TestInfo(component = ComponentConstant.DocumentFulfillment.HOME_SS_HO4, testCaseId = {"PAS-2305"})
	public void pas10870_restrictionPaymentPlansMembershipNo(@Optional("DE") String state) throws NoSuchFieldException {
	...
	@Test(groups = {Groups.FUNCTIONAL, Groups.CRITICAL})
	@TestInfo(component = ComponentConstant.DocumentFulfillment.HOME_SS_HO4, testCaseId = {"PAS-2305"})
	public void pas10870_restrictionPaymentPlansMembershipPendingCalculation(@Optional("CO") String state) throws NoSuchFieldException {
	...
	@Test(groups = {Groups.FUNCTIONAL, Groups.CRITICAL})
	@TestInfo(component = ComponentConstant.DocumentFulfillment.HOME_SS_HO4, testCaseId = {"PAS-2305"})
	public void pas10870_restrictionPaymentPlansMembershipYesAutoNo(@Optional("VA") String state) throws NoSuchFieldException {
