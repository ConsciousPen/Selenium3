...
public class TestZeroClaimsDiscount extends TestZeroClaimsDiscountTemplate {
	 ...
	 * @name Test Zero Claims Discount for SS HO4 Quotes, Updated with PAS-6730
	 * @scenario
	 * 1. Create customer
	 ...
	 **/
	@Parameters({"state"})
	@Test(groups = {Groups.FUNCTIONAL, Groups.HIGH}, description = "Test Zero Claims Discount for SS HO4 Quote")
	@TestInfo(component = ComponentConstant.Sales.HOME_SS_HO4, testCaseId = "PAS-9088, PAS-6730")
	...
	/**
	 * @author Josh Carpenter, Dominykas Razgunas
	 * @name Test Zero Claims Discount for SS HO4 Renewals, Updated with PAS-6730
	 * @scenario
	 * 1. Create customer
	 ...
	 **/
	@Parameters({"state"})
	@Test(groups = {Groups.FUNCTIONAL, Groups.HIGH}, description = "Test Zero Claims Discount for SS HO4 Renewals")
	@TestInfo(component = ComponentConstant.Sales.HOME_SS_HO4, testCaseId = "PAS-9088, PAS-6730")
