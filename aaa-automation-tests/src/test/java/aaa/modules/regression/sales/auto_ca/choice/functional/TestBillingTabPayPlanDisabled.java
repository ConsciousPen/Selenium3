...
public class TestBillingTabPayPlanDisabled extends TestBillingTabPaymentPlanBehaviorTemplate {
     ...
     * @name Auto CA Choice - PayPlan is enabled on Billing tab once NB or endorsement is bound
    ...
    @TestInfo(component = ComponentConstant.Sales.AUTO_CA_CHOICE, testCaseId = "PAS-21539")
