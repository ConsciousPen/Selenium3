...
public class TestRenewalMessageOnBindPageOnPaymentPlanChange extends HomeCaHO6BaseTest {
	...
	private void checkMessageInBindTab(String message, String existingPaymentPlan, String changedPaymentPlan) {
		//Navigate to Bind tab
		NavigationPage.toViewTab(NavigationEnum.HomeCaTab.BIND.get());

		//Check New Message is shown in popup
		bindTab.btnPurchase.click();
		message = message.replace("EXISTINGPAYMENTPLAN", existingPaymentPlan).replace("CHANGEDPAYMENTPLAN", changedPaymentPlan);
