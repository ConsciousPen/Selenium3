...
public class TestMembershipSTG3Catchup extends HomeSSHO3BaseTest {
    ...
    @TestInfo(component = ComponentConstant.Sales.HOME_SS_HO3, testCaseId = "PAS-27116-1")
    ...
    @TestInfo(component = ComponentConstant.Sales.HOME_SS_HO3, testCaseId = "PAS-27116-2")
    ...
    @Parameters({"state"})
    @Test(groups = {Groups.FUNCTIONAL, Groups.CRITICAL, Groups.TIMEPOINT}, description = "PAS-6654 Update Renewal Logic so that policies without an active membership still go through the membership validation at renewal time")
    @TestInfo(component = ComponentConstant.Sales.HOME_SS_HO3, testCaseId = "PAS-27116-3")
    ...
    @Parameters({"state"})
    @Test(groups = {Groups.FUNCTIONAL, Groups.CRITICAL, Groups.TIMEPOINT}, description = "PAS-6654 Update Renewal Logic so that policies without an active membership still go through the membership validation at renewal time")
    @TestInfo(component = ComponentConstant.Sales.HOME_SS_HO3, testCaseId = "PAS-27116-4")
    ...
    @Parameters({"state"})
    @Test(groups = {Groups.FUNCTIONAL, Groups.CRITICAL, Groups.TIMEPOINT}, description = "PAS-6654 Update Renewal Logic so that policies without an active membership still go through the membership validation at renewal time")
    @TestInfo(component = ComponentConstant.Sales.HOME_SS_HO3, testCaseId = "PAS-27116-5")
    ...
    @Parameters({"state"})
    @Test(groups = {Groups.FUNCTIONAL, Groups.CRITICAL, Groups.TIMEPOINT}, description = "PAS-27116 Update Renewal Logic so that policies without an active membership still go through the membership validation at renewal time")
    @TestInfo(component = ComponentConstant.Sales.HOME_SS_HO3, testCaseId = "PAS-27116-6")
    ...
    @Parameters({"state"})
    @Test(groups = {Groups.FUNCTIONAL, Groups.CRITICAL, Groups.TIMEPOINT}, description = "PAS-6654 Update Renewal Logic so that policies without an active membership still go through the membership validation at renewal time")
    @TestInfo(component = ComponentConstant.Sales.HOME_SS_HO3, testCaseId = "PAS-27116-7")
    ...
    @Parameters({"state"})
    @Test(groups = {Groups.FUNCTIONAL, Groups.CRITICAL, Groups.TIMEPOINT}, description = "PAS-6654 Update Renewal Logic so that policies without an active membership still go through the membership validation at renewal time")
    @TestInfo(component = ComponentConstant.Sales.HOME_SS_HO3, testCaseId = "PAS-27116-8")
    ...
    @Parameters({"state"})
    @Test(groups = {Groups.FUNCTIONAL, Groups.CRITICAL, Groups.TIMEPOINT}, description = "PAS-6654 Update Renewal Logic so that policies without an active membership still go through the membership validation at renewal time")
    @TestInfo(component = ComponentConstant.Sales.HOME_SS_HO3, testCaseId = "PAS-27116-9")
    ...
    @Parameters({"state"})
    @Test(groups = {Groups.FUNCTIONAL, Groups.CRITICAL, Groups.TIMEPOINT}, description = "PAS-6654 Update Renewal Logic so that policies without an active membership still go through the membership validation at renewal time")
    @TestInfo(component = ComponentConstant.Sales.HOME_SS_HO3, testCaseId = "PAS-27116-10")
     ...
     * 1. Create Customer.
     * 2. Create Home SS Policy
     * 3. Run Membership Validation Batch Jobs at Time point 2
