...
public class TestRestrictedPaymentPlan extends TestRestrictedPaymentPlanAbstract {
	...
	public void pas10870_restrictionPaymentPlansMembershipYes(@Optional("CT") String state) throws NoSuchFieldException {
	...
	@Test(groups = {Groups.FUNCTIONAL, Groups.CRITICAL})
	@TestInfo(component = ComponentConstant.DocumentFulfillment.HOME_SS_HO6, testCaseId = {"PAS-2305"})
	public void pas10870_restrictionPaymentPlansMembershipPending(@Optional("VA") String state) throws NoSuchFieldException {
	...
	@Test(groups = {Groups.FUNCTIONAL, Groups.CRITICAL})
	@TestInfo(component = ComponentConstant.DocumentFulfillment.HOME_SS_HO6, testCaseId = {"PAS-2305"})
	public void pas10870_restrictionPaymentPlansMembershipNo(@Optional("VA") String state) throws NoSuchFieldException {
	...
	@Test(groups = {Groups.FUNCTIONAL, Groups.CRITICAL})
	@TestInfo(component = ComponentConstant.DocumentFulfillment.HOME_SS_HO6, testCaseId = {"PAS-2305"})
	public void pas10870_restrictionPaymentPlansMembershipPendingCalculation(@Optional("NJ") String state) throws NoSuchFieldException {
	...
	@Test(groups = {Groups.FUNCTIONAL, Groups.CRITICAL})
	@TestInfo(component = ComponentConstant.DocumentFulfillment.HOME_SS_HO6, testCaseId = {"PAS-2305"})
	public void pas10870_restrictionPaymentPlansMembershipPendingAutoNo(@Optional("CO") String state) throws NoSuchFieldException {
