...
public class TestQuoteDetermineEligibility extends HomeCaHO3BaseTest {
    ...
    public void testQuoteDetermineEligibilitySC3() {
        ...
        String coverageA =
                getTestSpecificTD("CovA_MoreThan20PercentsOfReplacementCosts").getTestData(HomeCaMetaData.PropertyInfoTab.class.getSimpleName(),
        ...
        // > than 25 years ago
        //        propertyInfoTab.getHomeRenovationAssetList().getAsset(HomeCaMetaData.PropertyInfoTab.HomeRenovation.ROOF_YEAR_OF_COMPLECTION.getLabel(), TextBox.class).setValue("1980");
        //        goToBindAndVerifyError(Errors.ERROR_AAA_HO_CA_15011_1);
        ...
        // > than 25 years ago
        //        propertyInfoTab.getHomeRenovationAssetList().getAsset(HomeCaMetaData.PropertyInfoTab.HomeRenovation.HEATING_COOLING_YEAR_OF_COMPLECTION.getLabel(), TextBox.class).setValue("1980");
        //        goToBindAndVerifyError(Errors.ERROR_AAA_HO_CA_15011_1);
        ...
        // > than 25 years ago
        //        propertyInfoTab.getHomeRenovationAssetList().getAsset(HomeCaMetaData.PropertyInfoTab.HomeRenovation.PLUMBING_YEAR_OF_COMPLECTION.getLabel(), TextBox.class).setValue("1980");
        //        goToBindAndVerifyError(Errors.ERROR_AAA_HO_CA_15011_1);
    ...
    private void setCorrectValueOfTextBox(String field) {
        propertyInfoTab.getHomeRenovationAssetList().getAsset(field, TextBox.class)
                .setValue(getTestSpecificTD("HomeRenovation_SetCorrectValues").getTestData(HomeCaMetaData.PropertyInfoTab.class.getSimpleName(),
                        HomeCaMetaData.PropertyInfoTab.HomeRenovation.class.getSimpleName()).getValue(field));
    }

    private void setCorrectValueOfComboBox(String field) {
        propertyInfoTab.getHomeRenovationAssetList().getAsset(field, ComboBox.class)
                .setValue(getTestSpecificTD("HomeRenovation_SetCorrectValues").getTestData(HomeCaMetaData.PropertyInfoTab.class.getSimpleName(),
                        HomeCaMetaData.PropertyInfoTab.HomeRenovation.class.getSimpleName()).getValue(field));
    }
}
