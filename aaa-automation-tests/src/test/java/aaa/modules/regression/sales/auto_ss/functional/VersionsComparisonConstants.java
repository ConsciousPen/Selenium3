...
public class VersionsComparisonConstants {
	...
	static final Multimap<String, String> uiFieldsToTDMapping = ImmutableListMultimap.<String, String>builder()
			...
			.put("Activity Information (Hit and Run, 05/10/2020, Not included in Rating).Type", "Type")
			.put("Activity Information (Hit and Run, 05/10/2020, Not included in Rating).Description", "Description")
			.put("Activity Information (Hit and Run, 05/10/2020, Not included in Rating).Occurrence Date", "Occurrence Date")
			.put("Activity Information (Hit and Run, 05/10/2020, Not included in Rating).Loss Payment Amount", "Loss Payment Amount")
			...
			.put("Activity Information (Hit and Run, 05/10/2020, Not included in Rating).Not Included in Points and/or Tier - Reason Codes", "Not Included in Points and/or Tier - Reason Codes")
			//Vehicle Information
