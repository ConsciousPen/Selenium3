...
public class TestFirelineTemplate extends PolicyBaseTest {
	...
	protected void pas21652_SS_firelineRuleForFirelineTableLookup(String zipCode, String address, int expectedFirelineScore, int firelineLookupTableValue, PrivilegeEnum.Privilege userPrivilege) {
	...
	protected void pas21652_SS_firelineRule_GENZIP_FirelineTableLookup(String zipCode, String address, int expectedFirelineScore, int firelineLookupTableValue, PrivilegeEnum.Privilege userPrivilege) {
		if (userPrivilege.equals(PrivilegeEnum.Privilege.L41)) {
			mainApp().open();
		} else {
			openAppNonPrivilegedUser(userPrivilege);
		...
		assertThat(new PropertyInfoTab().getFireReportAssetList()
				.getAsset(HomeSSMetaData.PropertyInfoTab.FireReport.PLACEMENT_OR_MATCH_TYPE)
				.getValue()).isEqualTo(String.valueOf("ZIP"));
	...
	protected void pas18311_CA_firelineRuleForFirelineTableLookup(String zipCode, String address, int expectedFirelineScore,int firelineLookupTableValue, PrivilegeEnum.Privilege userPrivilege, Boolean isFAIRplanAdded) {
		if (userPrivilege.equals(PrivilegeEnum.Privilege.L41)) {
			mainApp().open();
		} else {
			openAppNonPrivilegedUser(userPrivilege);
	...
	protected void pas18311_CA_firelineRules_addressLevelNotMatched(String zipCode, String address, int expectedFirelineScore,int firelineLookupTableValue, PrivilegeEnum.Privilege userPrivilege) {
		if (userPrivilege.equals(PrivilegeEnum.Privilege.L41)) {
			mainApp().open();
		} else {
			openAppNonPrivilegedUser(userPrivilege);
