...
public class TestFAIRPlanEndorsement extends HomeCaDP3BaseTest {
	 ...
	 *           -PAS-14368-
	 * 7. Validate that FPCECADP has correct Sequence in XML (<doc:Sequence> is 91 for NB and Endorsement, and 171 for renewal)
	 *@details
	 */
	@Parameters({"state"})
	@Test(groups = {Groups.FUNCTIONAL, Groups.HIGH})
	@TestInfo(component = ComponentConstant.Sales.AUTO_SS, testCaseId = "PAS-12466 AS-14368")
