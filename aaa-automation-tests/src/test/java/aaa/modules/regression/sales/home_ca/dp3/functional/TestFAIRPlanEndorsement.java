...
public class TestFAIRPlanEndorsement extends HomeCaDP3BaseTest {

	private String formIdInXml = DocGenEnum.Documents.FPCECADP.getIdInXml();
	 ...
	 * 1. Create Customer.
	 * 2. Create CA DP3 Policy with PPC 8B, 9, 10, 1X-8X, or 1Y-8Y,
	 *      construction type other than 'Log Home'
	 *      and without FAIR Plan Endorsement
	...
	/**
	 *@author Maris Strazds
	 *@name Test that form FPCECADP is included in New Business Package ---> not included in Endorsement package ---> Included in Renewal Package
	 *@scenario
	 * 1. Create Customer
	 * 2. Create CA HO3 Policy with FAIR Plan Endorsement
	 * 3. Validate that form FPCECADP is included in New Business Package
	 * 4. Validate that form FPCECADP is included in New Business Package only once
	 * 5. Validate that form FPCECADP is not included in Subsequent transactions, but it is listed in related documents (Make midterm endorsement
	 *    but do not remove FAIR Plan Endorsement and validate)
	 *          -PAS-14193-
	 * 6. Validate that form FPCECADP is generated at renewal, and is listed in other documents
	 * 7. Make Renewal image endorsement without removing FAIR plan endorsement
	 * 8. Validate that form FPCECADP is still included in renewal package and is also listed in other documents
	 *@details
	 */
	@Parameters({"state"})
	...
	/**
	 *@author Maris Strazds
	 *@name Test that form FPCECADP is included in Endorsement Package
	 *@scenario
	 * 1. Create Customer
	 * 2. Create CA DP3 Policy without FAIR Plan Endorsement
	 * 3. Do a Midterm endorsement and add FAIR Plan Endorsement
	 * 4. Re-calculate premium and bind endorsement
	 * 5. Validate that form FPCECADP is included in Endorsement Package
	 * 6. Validate that form FPCECADP is included in Endorsement Package only once
	 *@details
	 */
	@Parameters({"state"})
	...
	/**
	 *@author Maris Strazds
	 *@name Test that form FPCECADP is included in Renewal Package
	 *@scenario
	 * 1. Create Customer
	 * 2. Create CA DP3 Policy without FAIR Plan Endorsement
	 ...
	 * 7. Validate that form FPCECADP is included in Renewal Package
	...
	/**
	 *@author Maris Strazds
	 *@name Test that form FPCECADP is included in Renewal package, if endorsement is made for Renewal term when Renewal Document package is already generated (i.e Revised renewal)
	 *@scenario
	 * 1. Create Customer
	 * 2. Create CA DP3 Policy without FAIR Plan Endorsement
	 ...
	 * 6. Validate that form FPCECADP is included in Renewal package
	 * 7. Validate that form FPCECADP is included in Renewal package only once
	 *@details
	 */
	@Parameters({"state"})
	@Test(groups = {Groups.FUNCTIONAL, Groups.HIGH, Groups.TIMEPOINT})
	...
	/**
	 *@author Maris Strazds
	 *@name Test that form FPCECADP is included in Endorsement package, but not in Renewal Package,
	 ...
	 * 5. Re-calculate premium and bind endorsement
	 * 6. Validate that form FPCECADP is included in Endorsement package
	 * 7. Validate that form FPCECADP is not included in Renewal package
	 ...
	 * @scenario
	 * 1. Create Customer.
	 * 2. Initiate CA DP3 Quote. (don't add FAIR plan Endorsement)
	 * 3. Navigate to Property info tab
	 ...
	 * @scenario
	 * 1. Create Customer
	 * 2. Create CA DP3 Policy. (don't add FAIR plan Endorsement)
	 * 3. Initiate Midterm Endorsement
	 * 4. Navigate to Property info tab
	 ...
	 *8. Select FPCECA/FPCECAD form and generate document
	 *9. Validate that FPCECA/FPCECAD document is generated in XML
	 * @details
	 **/
	@Parameters({"state"})
	@Test(groups = {Groups.FUNCTIONAL, Groups.CRITICAL}, description = "PAS-12925 FAIR Plan Endorsement (formerly known as Difference in Conditions)")
	 ...
	 *5. Select FPCECA/FPCECAD form and generate document
	 *6. Validate that FPCECA/FPCECAD document is generated in XML
	 * @details
	 **/
	@Parameters({"state"})
	@Test(groups = {Groups.FUNCTIONAL, Groups.CRITICAL}, description = "PAS-12925 FAIR Plan Endorsement (formerly known as Difference in Conditions)")
