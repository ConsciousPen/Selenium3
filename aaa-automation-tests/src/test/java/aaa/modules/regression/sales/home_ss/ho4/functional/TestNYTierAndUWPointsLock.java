...
public class TestNYTierAndUWPointsLock extends TestNYPropertyTierAndUWPointsLock {
	...
	@TestInfo(component = ComponentConstant.Sales.HOME_SS_HO4, testCaseId = "PAS-14030, PAS-14045")
	public void pas14030_testNYViewRatingDetailsRenewal_HO4(@Optional("NY") String state) {
	...
	@TestInfo(component = ComponentConstant.Sales.HOME_SS_HO4, testCaseId = "PAS-14030, PAS-14045")
	public void pas14030_testNYViewRatingDetailsRenewalFlatEndorsement_HO4(@Optional("NY") String state) {
	...
	public void pas14030_testNYViewRatingDetailsMidTermEndorsement_HO4(@Optional("NY") String state) {
	...
	@TestInfo(component = ComponentConstant.Sales.HOME_SS_HO4, testCaseId = "PAS-14030")
	public void pas14030_testNYViewRatingDetailsEndorsement_HO4(@Optional("NY") String state) {
