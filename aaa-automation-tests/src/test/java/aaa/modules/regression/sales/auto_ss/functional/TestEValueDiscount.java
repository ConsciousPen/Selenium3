...
public class TestEValueDiscount extends AutoSSBaseTest implements TestEValueDiscountPreConditions {
    ...
    public static void paperlessPreferencesConfigCheck() {
        CustomAssert
                .assertTrue("paperless preference stub endpoint. Please run paperlessPreferencesConfigUpdate", DBService.get().getValue(String.format(PAPERLESS_PRFERENCE_STUB_POINT, APP_HOST, APP_STUB_URL)).get()
                        .contains(APP_HOST));
    }
