...
public abstract class TestHomeGranularityAbstract extends PolicyBaseTest {
    ...
    protected void validateCensusBlockGroupAndLatLong(String censusBlock, String latitude, String longitude, Boolean checkVRD) {
        ...
        String censusBlockGroupID = validateCensusBlockGroupAndLatLong(quoteNumber, censusBlock, latitude, longitude, HomeGranularityQueries.SELECT_CENSUS_BLOCK_GROUP);
        if(checkVRD){ checkVRD(censusBlockGroupID);}
    }
