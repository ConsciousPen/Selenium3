...
public class TestZeroClaimsDiscount extends TestZeroClaimsDiscountTemplate {
	 ...
	 * @name Test Zero Claims Discount for SS HO6 Quotes, Updated with PAS-6730
	 * @scenario
	 * 1. Create customer
	...
	@TestInfo(component = ComponentConstant.Sales.HOME_SS_HO6, testCaseId = "PAS-9088, PAS-6730")
	...
	/**
	 * @author Josh Carpenter, Dominykas Razgunas
	 * @name Test Zero Claims Discount for SS HO6 Renewals, Updated with PAS-6730
	 * @scenario
	 * 1. Create customer
	 * 2. Create SS HO6 Policy
