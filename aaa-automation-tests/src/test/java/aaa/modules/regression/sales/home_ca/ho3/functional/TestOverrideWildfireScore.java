...
public class TestOverrideWildfireScore extends HomeCaHO3BaseTest {

	private TestUpdateWildfireScore template = new TestUpdateWildfireScore();

	/**
	 * @author Dominykas Razgunas
	 * @name Test Update Wildfire Score HO3 CA - No privilege, NB
	 * @scenario
	...
	@Parameters({"state"})
	@Test(groups = {Groups.FUNCTIONAL, Groups.HIGH}, description = "Test Update CA Wildfire Score HO3 - No privilege, NB")
	@TestInfo(component = ComponentConstant.Sales.HOME_CA_HO3, testCaseId = "PAS-12922")
	...
	/**
	 * @author Dominykas Razgunas
	 * @name Test Update Wildfire Score HO3 CA - No Privilege, Endorsement
	 * @scenario
	 * 1. Sign in with unprivileged User.
	 * 2. Create Customer.
	...
	@Parameters({"state"})
	@Test(groups = {Groups.FUNCTIONAL, Groups.HIGH}, description = "Test Update CA Wildfire Score HO3 - No Privilege, Endorsement")
	@TestInfo(component = ComponentConstant.Sales.HOME_CA_HO3, testCaseId = "PAS-12922")
	...
	/**
	 * @author Dominykas Razgunas
	 * @name Test Update Wildfire Score HO3 CA - NB
	 * @scenario
	...
	@Parameters({"state"})
	@Test(groups = {Groups.FUNCTIONAL, Groups.HIGH}, description = "Test Update Wildfire Score HO3 CA - NB")
	@TestInfo(component = ComponentConstant.Sales.HOME_CA_HO3, testCaseId = "PAS-12922")
	...
	/**
	 * @author Dominykas Razgunas
	 * @name Test Update Wildfire Score HO3 CA - Endorsement
	 * @scenario
	 * 1. Sign in with privileged User.
	 * 2. Create Customer.
	...
	@Parameters({"state"})
	@Test(groups = {Groups.FUNCTIONAL, Groups.HIGH}, description = "Test Update Wildfire Score HO3 CA - Endorsement")
	@TestInfo(component = ComponentConstant.Sales.HOME_CA_HO3, testCaseId = "PAS-12922")
	...
	/**
	 * @author Dominykas Razgunas
	 * @name Test Update Wildfire Score HO3 CA - Renewal
	 * @scenario
	 * 1. Sign in with privileged User.
	 * 2. Create Customer.
	...
	@Parameters({"state"})
	@Test(groups = {Groups.FUNCTIONAL, Groups.HIGH}, description = "Test Update Wildfire Score HO3 CA - Renewal")
	@TestInfo(component = ComponentConstant.Sales.HOME_CA_HO3, testCaseId = "PAS-12922")
	...
	/**
	 * @author Dominykas Razgunas
	 * @name Test Update Wildfire Score HO3 CA - Renewal Manual Entry
	 * @scenario
	 * 1. Sign in with privileged User.
	 * 2. Create Customer.
	...
	@Parameters({"state"})
	@Test(groups = {Groups.FUNCTIONAL, Groups.HIGH}, description = "Test Update Wildfire Score HO3 CA - Renewal Manual Entry")
