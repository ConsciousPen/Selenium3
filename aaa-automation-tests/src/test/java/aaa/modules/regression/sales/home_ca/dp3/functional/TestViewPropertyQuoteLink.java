...
public class TestViewPropertyQuoteLink extends TestViewPropertyQuoteLinkTemplate {
    ...
    @TestInfo(component = ComponentConstant.Sales.HOME_CA_DP3, testCaseId = "PAS-14842")
    public void pas14842_testViewPropertyQuoteLinkCADP3NB(@Optional("") String state) {
