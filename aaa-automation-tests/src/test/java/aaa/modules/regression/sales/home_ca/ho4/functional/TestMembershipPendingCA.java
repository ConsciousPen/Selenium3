...
public class TestMembershipPendingCA extends HomeCaHO4BaseTest {
    ...
    private void premiumAndDiscountCheckAAANo() {
        ...
        CustomAssertions.assertThat(PremiumsAndCoveragesQuoteTab.tableDiscounts).isAbsent();
        //CustomAssertions.assertThat(PremiumsAndCoveragesQuoteTab.tableDiscounts.getRow(1).getCell("Discounts applied")).doesNotHaveValue("AAA Membership");
    }
    ...
    private void premiumAndDiscountCheckAAAPending() {
        ...
        CustomAssertions.assertThat(PremiumsAndCoveragesQuoteTab.tableDiscounts.getRow(1).getCell("Discounts applied")).hasValue("AAA Membership");
    }
}
