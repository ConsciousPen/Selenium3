...
public class TestViewPropertyQuoteLink extends TestViewPropertyQuoteLinkTemplate {
    ...
    @TestInfo(component = ComponentConstant.Sales.HOME_SS_DP3, testCaseId = "PAS-14842")
    public void pas14842_testViewPropertyQuoteLinkSSDP3NB(@Optional("") String state) {
