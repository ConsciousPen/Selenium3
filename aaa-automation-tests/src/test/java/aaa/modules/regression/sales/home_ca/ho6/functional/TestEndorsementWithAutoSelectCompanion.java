...
public class TestEndorsementWithAutoSelectCompanion extends HomeCaHO6BaseTest {
    ...
    @TestInfo(component = ComponentConstant.Sales.HOME_CA_HO6, testCaseId = "PAS-8786")
