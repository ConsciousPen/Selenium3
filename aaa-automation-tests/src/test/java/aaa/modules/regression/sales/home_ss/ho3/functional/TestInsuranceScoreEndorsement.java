...
public class TestInsuranceScoreEndorsement extends TestInsuranceScoreEndorsementTemplate {
	...
	@TestInfo(component = ComponentConstant.Sales.HOME_SS_HO3, testCaseId = {"PAS-24663"})
	...
	@Test(groups = {Groups.FUNCTIONAL, Groups.CRITICAL, Groups.TIMEPOINT})
	@TestInfo(component = ComponentConstant.Sales.HOME_SS_HO3, testCaseId = {"PAS-24664", "PAS-29054", "PAS-25628"})
