...
public class VersionsComparisonConstants {
	...
	static final Multimap<String, String> PREDEFINED_EXPECTED_VALUES = ImmutableListMultimap.<String, String>builder()
			...
			.putAll("Drivers.VIFirstName VI VILastName.Driving Activities.Activity Information (Hit and run, 07/20/2018, Not included in Rating).Conviction Points","1","")
			...
			.putAll("Vehicles.2003, MERCEDES-BENZ, SL500R.System Rated Driver", "New Driver Version2","NBFirstName NBLastName")
			.putAll("Vehicles.2003, MERCEDES-BENZ, SL500R.Manually assigned driver name", "New Driver Version2","NBFirstName NBLastName")
			.putAll("Vehicles.2008, ACURA, MDX.System Rated Driver", "New Driver Version2","VIFirstName VILastName")
			.putAll("Vehicles.2008, ACURA, MDX.Manually assigned driver name", "New Driver Version2","VIFirstName VILastName")
			.build();
	...
	static final Multimap<String, String> DATA_GATHER_DRIVER_INFORMATION = ImmutableListMultimap.<String, String>builder()
			...
			.put("Drivers.VIFirstName VI VILastName.Driving Activities.Activity Information (Hit and run, 07/20/2018, Not included in Rating)", "Conviction Points")
	...
	static final Multimap<String, String> RENEWAL_DRIVER_INFORMATION = ImmutableListMultimap.<String, String>builder()
			...
			.put("Drivers.NBFirstName NB NBLastName.Driving Activities.Activity Information (Hit and run, 07/20/2018, Not included in Rating)", "Description")
			.put("Drivers.NBFirstName NB NBLastName.Driving Activities.Activity Information (Hit and run, 07/20/2018, Not included in Rating)", "Conviction Date")
			.put("Drivers.NBFirstName NB NBLastName.Driving Activities.Activity Information (Hit and run, 07/20/2018, Not included in Rating)", "Conviction Points")
			.put("Drivers.NBFirstName NB NBLastName.Driving Activities.Activity Information (Hit and run, 07/20/2018, Not included in Rating)", "Include in Points and/or YAF?")
			.put("Drivers.NBFirstName NB NBLastName.Driving Activities.Activity Information (Hit and run, 07/20/2018, Not included in Rating)", "Not Included in Points and/or YAF - Reason Codes")
			.build();
	...
	static final Multimap<String, String> DATA_GATHER_ASSIGNMENT = ImmutableListMultimap.<String, String>builder()
			...
			.put("Vehicles.2008, ACURA, MDX", "Manually assigned driver name")
			.build();
	...
	static final Multimap<String, String> ASSIGNMENT = ImmutableListMultimap.<String, String>builder()
			...
			.put("Vehicles.2003, MERCEDES-BENZ, SL500R", "System Rated Driver")
