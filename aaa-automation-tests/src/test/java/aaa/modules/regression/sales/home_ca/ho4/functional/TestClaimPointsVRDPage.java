...
public class TestClaimPointsVRDPage extends TestClaimPointsVRDPageAbstract {
	 ...
	 * @name Test Claims points refresh on VRD page for CA HO4 policies during NB
	 * @scenario
	 * 1.  Create customer
	 * 2.  Initiate CA HO4 quote
	...
	@TestInfo(component = ComponentConstant.Service.HOME_CA_HO4, testCaseId = "PAS-17772")
