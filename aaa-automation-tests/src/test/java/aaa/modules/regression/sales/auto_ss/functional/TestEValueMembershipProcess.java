...
public class TestEValueMembershipProcess extends AutoSSBaseTest {
	...
	private void membershipEligibilityConfiguration(String membershipEligibilitySwitch, boolean membershipActive, boolean membershipDiscountPresent, boolean evalueDiscountPresent){
		...
		if(membershipActive){
			...
			inactiveMembershipNumberList.add("4333333333333457");//Expired
			inactiveMembershipNumberList.add("9920702826992041");//Inactive
			inactiveMembershipNumberList.add("4343433333333335");//Failed
			inactiveMembershipNumberList.add("3111111111111121");//Cancelled
			inactiveMembershipNumberList.add("4222222222222123");//No Hit
			inactiveMembershipNumberList.add("8800400000000002");//Lapsed
			inactiveMembershipNumberList.add("4290061311384005");//Pending
			inactiveMembershipNumberList.add("4333333333333338");//Expired
		...
		CustomAssert.assertTrue(DocGenHelper.getDocumentDataElemByName("AcctNum", DocGenEnum.Documents.AHDRXX, query).get(0).getDocumentDataElements().get(0).getDataElementChoice().getTextField().contains("Membership"));
		CustomAssert.assertTrue(DocGenHelper.getDocumentDataElemByName("AcctNum", DocGenEnum.Documents.AHDRXX, query).get(0).getDocumentDataElements().get(0).getDataElementChoice().getTextField().contains("eValue"));
