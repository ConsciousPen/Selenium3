...
public class TestSeniorDiscount extends HomeCaHO6BaseTest {

    private static final String SENIOR_DISCOUNT_NAME = "Mature Policy Holder";
    private HelperCommon helperCommon = new HelperCommon();


    /**
     * @author Oleg Stasyuk
	 * <b> Test HO6 Policy Senior Discounts </b>
	 * <p> Steps: 1.  Create a quote effective today
	 * <p> 2.  Set DOB to be 50 years in past from quote Effective date, check Senior Discount is applied
	 * <p> 3.  Check Boundary conditions +/-1 day
	 * <p> 4.  Set Quote effective date to be some days in the past
	 * <p> 5.  Set DOB to be 50 years in past from quote Effective date, check Senior Discount is applied
	 * <p> 6.  Check Boundary conditions +/-1 day
	 * <p> 7.  Set Quote effective date to be some days in the future
	 * <p> 8.  Set DOB to be 50 years in past from quote Effective date, check Senior Discount is applied
