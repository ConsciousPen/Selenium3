...
public class TestCAFairPlanSignature extends HomeCaDP3BaseTest {
     ...
     */
    @Parameters({"state"})
    @Test(groups = {Groups.FUNCTIONAL, Groups.HIGH}, description = "PAS-13239 18.5: CA FAIR Plan: Signature required to bind DP3")
    ...
    private void validateSignatureAndBind() {
        ...
        errorTab.getErrorCodesList().contains((ErrorEnum.Errors.ERROR_AAA_HO_CA20180518).getMessage().split("\\."));
