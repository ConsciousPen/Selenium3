...
public class TestClaimPointsVRDPage extends TestClaimPointsVRDPageAbstract {
	 ...
	 * @name Test Claims points refresh on VRD page for SS HO4 policies during NB. Updated with PAS-6730
	 * @scenario
	 * 1.  Create customer
	...
	@TestInfo(component = ComponentConstant.Sales.HOME_SS_HO4, testCaseId = "PAS-17772, PAS-6730")
