...
public class TestOffCycleBillNoInstallmentDate extends TestOffCycleBillNoInstallmentDateAbstract {
     ...
     * @name Test balance is invoiced as off cycle bill for CA HO6 policy when there is no future installment date on NB
     * @scenario
	...
	/**
	 * @author Josh Carpenter
	 * @name Test balance is invoiced as off cycle bill for CA HO6 policy when there is no future installment date for endorsements
	 * @scenario
	 * 1. Create new customer
	 * 2. Create/bind CA HO6 policy (pay in full)
