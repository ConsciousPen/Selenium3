...
public class TestMSRPRefreshRegularVehicle extends TestMSRPRefreshTemplate{
	 ...
	 * 5. Navigate to P&C page and validate that comp/coll symbols WERE Changed because Vehicle type = Regular
	 * @details
	 */
	@Parameters({"state"})
	 ...
	 * 4. Navigate to P&C page and that comp/coll symbols WERE Changed because Vehicle type = Regular
	 * @details
	 */
	@Parameters({"state"})
	@Test(groups = {Groups.FUNCTIONAL, Groups.MEDIUM})
