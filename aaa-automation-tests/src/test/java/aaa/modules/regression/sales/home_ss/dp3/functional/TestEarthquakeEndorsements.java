...
public class TestEarthquakeEndorsements extends HomeSSDP3BaseTest {
	...
	public void testEarthquakeEndorsement_NewBusiness(@Optional("") String state) {
		...
		template.testEndorsementForms(EndorsementForms.HomeSSEndorsementForms.DS_04_69.getName(),
