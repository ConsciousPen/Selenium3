...
public class TestPolicyRmeNyLegacyTierField extends TestPolicyRmeNyLegacyTierFieldTemplate {
    ...
    @TestInfo(component = ComponentConstant.Conversions.HOME_SS_DP3, testCaseId = {"PAS-23185", "PAS-23421"})
    ...
    @StateList(states = {Constants.States.NY})
    @Test(groups = {Groups.FUNCTIONAL, Groups.MEDIUM})
    @TestInfo(component = ComponentConstant.Conversions.HOME_SS_DP3, testCaseId = {"PAS-23185, PAS-23187"})
