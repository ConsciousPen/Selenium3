 ...
 *    4. Finish policy and attempt to bind
    ...
    public void pas7003_TestOverrideNumberOfRisksNB(@Optional("VA") String state) {
    ...
    @Test(groups = {Groups.FUNCTIONAL, Groups.MEDIUM})
    @TestInfo(component = ComponentConstant.Sales.PUP, testCaseId = "PAS-7003")
    public void pas7003_TestOverrideNumberOfRisksConversion(@Optional("VA") String state) {
