...
public class TestScenario2 extends Scenario2 {
	...
	@Parameters({"state"})
	@Test(dependsOnMethods = "TC01_createPolicy")
	public void TC22_Generate_Tenth_Bill(@Optional("CA") String state) {
		super.generateTenthBill();
	}

	@Parameters({"state"})
	@Test(dependsOnMethods = "TC01_createPolicy")
	public void TC23_Renewal_Image_Generation(@Optional("CA") String state) {
	...
	public void TC27_Verify_DocGen_Forms(@Optional("CA") String state) {
		super.verifyDocGenForms(DocGenEnum.Documents.AH35XX, DocGenEnum.Documents.AHRBXX);
	}
