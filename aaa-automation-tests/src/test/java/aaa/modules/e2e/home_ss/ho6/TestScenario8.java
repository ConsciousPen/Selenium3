...
public class TestScenario8 extends Scenario8 {
	...
	public void TC02_Generate_Second_Bill(String state) {
		generateAndCheckBill(installmentDueDates.get(1));
	}

	@Parameters({"state"})
	@Test(dependsOnMethods = "TC01_createPolicy")
	public void TC03_Change_Payment_To_Quarterly(String state) {
	...
	@Parameters({"state"})
	@Test(dependsOnMethods = "TC01_createPolicy")
	public void TC04_Generate_Second_Quterly_Bill(String state) {
		generateAndCheckBill(installmentDueDates.get(3), policyEffectiveDate);
	}

	@Parameters({"state"})
	@Test(dependsOnMethods = "TC01_createPolicy")
	public void TC05_Pay_Second_Quterly_Bill(String state) {
		payAndCheckBill(installmentDueDates.get(3));
	}

	@Parameters({"state"})
	@Test(dependsOnMethods = "TC01_createPolicy")
	public void TC06_Change_Payment_To_Monthly(String state) {
	...
	@Parameters({"state"})
	@Test(dependsOnMethods = "TC01_createPolicy")
	public void TC07_Generate_Forth_Monthly_Bill(String state) {
		generateAndCheckBill(installmentDueDates.get(4), policyEffectiveDate);
	}

	@Parameters({"state"})
	@Test(dependsOnMethods = "TC01_createPolicy")
	public void TC08_Pay_Forth_Monthly_Bill(String state) {
		payAndCheckBill(installmentDueDates.get(4));
	}

	@Parameters({"state"})
	@Test(dependsOnMethods = "TC01_createPolicy")
	public void TC09_Generate_Five_Monthly_Bill(String state) {
		generateAndCheckBill(installmentDueDates.get(5), policyEffectiveDate);
	}

	@Parameters({"state"})
	@Test(dependsOnMethods = "TC01_createPolicy")
	public void TC10_Change_Payment_To_Semi_Annaual(String state) {
	...
	@Parameters({"state"})
	@Test(dependsOnMethods = "TC01_createPolicy")
	public void TC11_Generate_Semi_Annual_Bill(String state) {
		generateAndCheckBill(installmentDueDates.get(6), policyEffectiveDate);
	}

	@Parameters({"state"})
	@Test(dependsOnMethods = "TC01_createPolicy")
	public void TC12_Pay_Semi_Annual_Bill(String state) {
	...
	@Parameters({"state"})
	@Test(dependsOnMethods = "TC01_createPolicy")
	public void TC15_Change_Payment_In_Renewal_To_Monthly(String state) {
	...
	@Parameters({"state"})
	@Test(dependsOnMethods = "TC01_createPolicy")
	public void TC16_Change_Payment_In_Policy_To_Quarterly(String state) {
		TestData td = getTestSpecificTD("TestData_Endorsement").adjust(getStateTestData(tdPolicy, "Endorsement", "TestData"));
		/** TODO Why 5??? */
	...
	@Parameters({"state"})
	@Test(dependsOnMethods = "TC01_createPolicy")
	public void TC17_Renewal_Offer_Generation(String state) {
		super.renewalOfferGeneration();
	}

	@Parameters({"state"})
	@Test(dependsOnMethods = "TC01_createPolicy")
	public void TC18_Change_Payment_Plan_To_Quarterly(String state) {
	...
	@Parameters({"state"})
	@Test(dependsOnMethods = "TC01_createPolicy")
	public void TC19_Renewal_Premium_Notice(String state) {
		super.renewalPremiumNotice();
	}

	@Parameters({"state"})
	@Test(dependsOnMethods = "TC01_createPolicy")
	public void TC20_Change_Payment_Plan_To_Monthly(String state) {
		TestData td = getTestSpecificTD("TestData_Endorsement4").adjust(getStateTestData(tdPolicy, "Endorsement", "TestData"));
