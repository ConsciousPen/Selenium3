...
//
//		BillingHelper.initiateDeclinePayment(installmentDueDates.get(1));
//		// DeclinePayment.confirmDeclinePayment();
//		DeclinePayment.declinePayment("Dataset1");
//		BillingHelper.verifyPaymentDeclined(installmentDueDates.get(1));
//
//		BillingHelper.initiateDeclinePayment(installmentDueDates.get(2));
//		// DeclinePayment.confirmDeclinePayment();
//		DeclinePayment.declinePayment("Dataset1");
//		BillingHelper.verifyPaymentDeclined(installmentDueDates.get(2));
//
...
//		LocalDateTime cDate = getTimePoints().getCancellationDate(installmentDueDates.get(2));
