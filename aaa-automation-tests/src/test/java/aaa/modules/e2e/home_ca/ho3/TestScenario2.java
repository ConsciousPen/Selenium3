...
public class TestScenario2 extends Scenario2 {
	...
	@Test(dependsOnMethods = "TC01_createPolicy")
	public void TC27_Verify_DocGen_Forms() {
		super.verifyDocGenForms();
	}

	@Test(dependsOnMethods = "TC01_createPolicy")
	public void TC28_Remove_AutoPay() {
		super.removeAutoPay();
	}

	@Test(dependsOnMethods = "TC01_createPolicy")
	public void TC29_Renewal_Payment_Not_Generated() {
		super.renewalPaymentNotGenerated();
	}

	@Test(dependsOnMethods = "TC01_createPolicy")
	public void TC30_Update_Policy_Status() {
		super.updatePolicyStatus();
	}

	@Test(dependsOnMethods = "TC01_createPolicy")
	public void TC31_Make_Manual_Payment_In_Full_Renewal_Offer_Amount() {
