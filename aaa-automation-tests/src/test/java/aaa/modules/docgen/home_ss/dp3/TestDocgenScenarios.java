...
public class TestDocgenScenarios extends HomeSSDP3BaseTest {
	...
	public void testPolicyDocuments(@Optional("") String state) {
		...
		DocGenHelper.verifyDocumentsGenerated(policyNum, DocGenEnum.Documents.DS02, DocGenEnum.Documents.AHNBXX, DocGenEnum.Documents.DS0469);
		...
		WebDriverHelper.switchToDefault();
		//WebDriverHelper.switchToDefault();
		DocGenHelper.verifyDocumentsGenerated(policyNum, DocGenEnum.Documents.DS11, DocGenEnum.Documents.AHPNXX);
	...
	public void testMortgagePolicyDocuments(@Optional("") String state) {
		...
		policy.purchase(getPolicyTD());
		String policyNum = PolicySummaryPage.labelPolicyNumber.getValue();
		DocGenHelper.verifyDocumentsGenerated(policyNum, DocGenEnum.Documents.DS02, DocGenEnum.Documents.AHNBXX, DocGenEnum.Documents._438BFUNS);
