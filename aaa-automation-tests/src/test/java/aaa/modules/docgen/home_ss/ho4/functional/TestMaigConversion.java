...
package aaa.modules.docgen.home_ss.ho4.functional;
...
import aaa.modules.conversion.manual.ConvHomeSsHO4BaseTest;
...
public class TestMaigConversion extends ConvHomeSsHO4BaseTest implements TestMaigConversionAbstract {
	...
	@TestInfo(component = ComponentConstant.Sales.HOME_SS_HO4, testCaseId = {"PAS-2305"})
