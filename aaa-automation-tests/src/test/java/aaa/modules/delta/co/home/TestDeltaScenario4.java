...
public class TestDeltaScenario4 extends HomeSSHO4BaseTest{ 
	...
	public void testSC4_TC01() {
        ...
        log.info("DELTA CO SC4: HO4 Quote created with #" + quoteNumber);
	...
	public void testSC4_TC05() {
		...
		propertyInfoTab.fillTab(td_construction2);
	...
	public void testSC4_TC06() {
        ...
        log.info("DELTA CO SC4: HO4 Policy created with #" + policyNumber);
		
	}
	
	@Test(groups = { Groups.DELTA, Groups.HIGH })
    @TestInfo(component = ComponentConstant.Sales.HOME_SS_HO3)
	public void testSC4_TC07() {
		mainApp().open(); 
