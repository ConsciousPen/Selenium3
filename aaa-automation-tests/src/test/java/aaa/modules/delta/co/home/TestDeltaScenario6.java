...
public class TestDeltaScenario6 extends HomeSSDP3BaseTest { 
	...
	public void testSC6_TC01() {
        ...
        log.info("DELTA CO SC1: DP3 Quote created with #" + quoteNumber);
	...
	public void testSC6_TC05() {
        ...
        log.info("DELTA CO SC6: DP3 Policy created with #" + policyNumber);
		
	}
	
	@Test(groups = { Groups.DELTA, Groups.HIGH })
    @TestInfo(component = ComponentConstant.Sales.HOME_SS_HO3)
	public void testSC6_TC06() {
		mainApp().open(); 
