...
public class TestDeltaScenario1 extends AutoSSBaseTest {
	...
	@Test
	@TestInfo(component = ComponentConstant.Service.AUTO_SS)
	public void testSC1_TC02(String state) {
	...
	@Test
	@TestInfo(component = ComponentConstant.Service.AUTO_SS)
	public void testSC1_TC03(String state) {
		preconditions(NavigationEnum.AutoSSTab.DRIVER);
		driverTab.fillTab(getTestSpecificTD("TestData"));
	...
	@Test
	@TestInfo(component = ComponentConstant.Service.AUTO_SS)
	public void testSC1_TC04(String state) {
	...
	@Test
	@TestInfo(component = ComponentConstant.Service.AUTO_SS)
	public void testSC1_TC05(String state) {
	...
	@Test
	@TestInfo(component = ComponentConstant.Service.AUTO_SS)
	public void testSC1_TC06(String state) {
		preconditions(NavigationEnum.AutoSSTab.PREMIUM_AND_COVERAGES);
	...
	@Test
	@TestInfo(component = ComponentConstant.Service.AUTO_SS)
	public void testSC1_TC07(String state) {
		preconditions(NavigationEnum.AutoSSTab.PREMIUM_AND_COVERAGES);
		pacTab.getAssetList().getAsset(AutoSSMetaData.PremiumAndCoveragesTab.FULL_SAFETY_GLASS).verify.value("No Coverage");
	...
	@Test
	@TestInfo(component = ComponentConstant.Service.AUTO_SS)
	public void testSC1_TC08(String state) {
	...
	@Test
	@TestInfo(component = ComponentConstant.Service.AUTO_SS)
	public void testSC1_TC09(String state) {
	...
	@Test
	@TestInfo(component = ComponentConstant.Service.AUTO_SS)
	public void testSC1_TC10(String state) {
