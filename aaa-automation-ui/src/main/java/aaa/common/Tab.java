...
public abstract class Tab {
	...
	public static StaticElement labelPolicyNumberSecondGen = new StaticElement(By.xpath("//span[@id = 'policyDataGatherForm:dataGatherHeaderSectionInfo']//td[3]//span"));
	...
	public String getPolicyNumberForPup() {
		return labelPolicyNumberSecondGen.getValue();
	}
