...
public final class SearchMetaData {
    ...
    public static final class Search extends MetaData {
	    public static final AssetDescriptor<RadioGroup> SEARCH_FOR = declare("Search For", RadioGroup.class, Waiters.AJAX, By.xpath("//table[@id='searchForm:entityTypeSelect']"));
