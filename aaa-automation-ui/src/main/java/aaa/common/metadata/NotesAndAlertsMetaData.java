...
public class NotesAndAlertsMetaData {
    ...
    public static final class NotesAndAlertsTab extends MetaData {
        public static final AttributeDescriptor NOTE_ALERT = declare("Note/Alert", RadioGroup.class,
        ...
        public static final AttributeDescriptor CONFID = declare("Confid.", RadioGroup.class);
        public static final AttributeDescriptor TITLE = declare("Title", TextBox.class);
        public static final AttributeDescriptor NOTE = declare("Note", RichTextBox.class,
                By.xpath("//div[@id='createNote_form:createNote_note']//iframe"));
        public static final AttributeDescriptor ALERT = declare("Alert", RichTextBox.class,
                By.xpath("//div[@id='createNote_form:createNote_note']//iframe"));
        public static final AttributeDescriptor NOTE_UPDATE = declare("NoteUpdate", RichTextBox.class,
                By.xpath("//div[@id='updateNote_form:updateNote_note']//iframe"));
        public static final AttributeDescriptor ALERT_UPDATE = declare("AlertUpdate", RichTextBox.class,
