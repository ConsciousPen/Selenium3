...
public class AdministrationMetaData {
    ...
    public static final class VinTableTab extends MetaData {
        ...
        public static final AssetDescriptor<RadioButton> UPLOAD_TO_VIN_TABLE_OPTION = declare("Upload to VIN table", RadioButton.class, Waiters.AJAX, By.xpath("//table[contains(@id,'uploadToVINTableForm')]//td[1]//div[contains(@class,'ui-radiobutton-box')]"));
        public static final AssetDescriptor<RadioButton> UPLOAD_TO_VIN_CONTROL_TABLE_OPTION = declare("Upload to VIN control table", RadioButton.class, Waiters.AJAX, By.xpath("//table[contains(@id,'uploadToVINTableForm')]//td[3]//div[contains(@class,'ui-radiobutton-box')]"));
