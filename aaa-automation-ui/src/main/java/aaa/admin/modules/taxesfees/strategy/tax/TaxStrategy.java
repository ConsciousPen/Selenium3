...
import aaa.admin.modules.taxesfees.strategy.tax.views.DefaultView;
...
public class TaxStrategy implements IStrategy {
    ...
    public void navigate() {
        ...
        NavigationPage.toViewLeftMenu(AdminAppLeftMenu.TAXES_FEES_FEE_AND_TAX_STRATEGY.get());
    }
    ...
    public void create(TestData td) {
        ...
        log.info("Created Tax Strategy " + entity);
    }
}
