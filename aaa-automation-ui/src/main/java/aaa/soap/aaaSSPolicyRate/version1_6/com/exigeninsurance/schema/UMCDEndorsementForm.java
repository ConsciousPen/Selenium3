...
/**
 * <p>Java class for UMCDEndorsementForm complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="UMCDEndorsementForm"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "UMCDEndorsementForm", propOrder = {
    "premiumEntry",
    "formText",
    "formCd"
})
public class UMCDEndorsementForm {

    @XmlElement(name = "PremiumEntry")
    protected List<PremiumEntry> premiumEntry;
    @XmlElement(defaultValue = "Operator Exclusion Endorsement and Uninsured Motorist Coverage Deletion ")
    protected String formText;
    @XmlElement(defaultValue = "Endorsement")
