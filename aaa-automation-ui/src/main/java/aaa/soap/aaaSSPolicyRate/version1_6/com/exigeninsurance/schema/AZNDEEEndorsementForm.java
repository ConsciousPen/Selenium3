...
/**
 * <p>Java class for AZ_NDEEEndorsementForm complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="AZ_NDEEEndorsementForm"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "AZ_NDEEEndorsementForm", propOrder = {
    "premiumEntry",
    "formText",
    "formCd"
})
public class AZNDEEEndorsementForm {

    @XmlElement(name = "PremiumEntry")
    protected List<PremiumEntry> premiumEntry;
    @XmlElement(defaultValue = "Named Driver Exclusion Election")
    protected List<String> formText;
    @XmlElement(defaultValue = "NDEE")
