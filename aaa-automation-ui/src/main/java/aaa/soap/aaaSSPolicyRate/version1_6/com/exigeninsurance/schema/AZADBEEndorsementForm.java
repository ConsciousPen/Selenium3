...
/**
 * <p>Java class for AZ_ADBEEndorsementForm complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="AZ_ADBEEndorsementForm"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "AZ_ADBEEndorsementForm", propOrder = {
    "premiumEntry",
    "formText",
    "formCd"
})
public class AZADBEEndorsementForm {

    @XmlElement(name = "PremiumEntry")
    protected List<PremiumEntry> premiumEntry;
    @XmlElement(defaultValue = "Automobile Death Benefits Endorsement")
    protected List<String> formText;
    @XmlElement(defaultValue = "ADBE")
