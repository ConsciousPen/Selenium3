...
/**
 * <p>Java class for GolfCartEndorsementForm complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="GolfCartEndorsementForm"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "GolfCartEndorsementForm", propOrder = {
    "premiumEntry",
    "formText",
    "formCd"
})
public class GolfCartEndorsementForm {

    @XmlElement(name = "PremiumEntry")
    protected List<PremiumEntry> premiumEntry;
    @XmlElement(defaultValue = "Golf Cart Endorsement")
    protected String formText;
    @XmlElement(defaultValue = "GCE")
