...
/**
 * <p>Java class for AAACOMPCoverage complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="AAACOMPCoverage"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="coverageCd" type="{http://www.exigeninsurance.com/data/EIS/1.0}CoverageCode"/&gt;
 *         &lt;element name="deductibleAmount" type="{http://www.exigeninsurance.com/data/AAA_SS_Lookup/1.0}COMP"/&gt;
...
@XmlType(name = "AAACOMPCoverage", propOrder = {
    "coverageCd",
    "deductibleAmount",
    "premiumEntry"
})
public class AAACOMPCoverage {

    @XmlElement(required = true)
    @XmlSchemaType(name = "string")
    protected CoverageCode coverageCd;
    @XmlElement(required = true, defaultValue = "500")
