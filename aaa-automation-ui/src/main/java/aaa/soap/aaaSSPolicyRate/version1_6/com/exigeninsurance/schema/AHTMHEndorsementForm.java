...
/**
 * <p>Java class for AHTMHEndorsementForm complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="AHTMHEndorsementForm"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "AHTMHEndorsementForm", propOrder = {
    "premiumEntry",
    "formText",
    "formCd"
})
public class AHTMHEndorsementForm {

    @XmlElement(name = "PremiumEntry")
    protected List<PremiumEntry> premiumEntry;
    @XmlElement(defaultValue = "Auto Home Trailer, Motor Home or Mobile Home Endorsement")
    protected String formText;
    @XmlElement(defaultValue = "AHTMHE")
