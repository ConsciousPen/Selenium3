...
public class ApplicationContext {
    ...
    protected List<ExtensionArea> applicationContextExtension;
     ...
     * 
     */
    public List<ExtensionArea> getApplicationContextExtension() {
        if (applicationContextExtension == null) {
            applicationContextExtension = new ArrayList<ExtensionArea>();
        }
