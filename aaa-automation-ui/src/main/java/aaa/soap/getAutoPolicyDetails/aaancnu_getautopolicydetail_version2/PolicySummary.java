    ...
    extends PolicyHeader
{
    ...
    protected aaa.soap.getAutoPolicyDetails.aaancnu_getautopolicydetail_version2.TaxFee cityTax;
    protected aaa.soap.getAutoPolicyDetails.aaancnu_getautopolicydetail_version2.TaxFee countyTax;
    protected aaa.soap.getAutoPolicyDetails.aaancnu_getautopolicydetail_version2.TaxFee stateTax;
    ...
    protected aaa.soap.getAutoPolicyDetails.aaancnu_getautopolicydetail_version2.ReferencedPolicies referencedPolicies;
    protected PolicyPayers payers;
    @XmlElement(nillable = true)
    protected List<aaa.soap.getAutoPolicyDetails.aaancnu_getautopolicydetail_version2.SurchargeAndFee> otherFee;
     ...
     *     
     */
    public aaa.soap.getAutoPolicyDetails.aaancnu_getautopolicydetail_version2.EValueHeader getEValueInfo() {
        return eValueInfo;
    }
     ...
     *     
     */
    public void setEValueInfo(aaa.soap.getAutoPolicyDetails.aaancnu_getautopolicydetail_version2.EValueHeader value) {
     ...
     * 
     */
    public List<aaa.soap.getAutoPolicyDetails.aaancnu_getautopolicydetail_version2.Extn> getExtn() {
        if (extn == null) {
            extn = new ArrayList<aaa.soap.getAutoPolicyDetails.aaancnu_getautopolicydetail_version2.Extn>();
        }
        return this.extn;
    }
     ...
     *     
     */
    public aaa.soap.getAutoPolicyDetails.aaancnu_getautopolicydetail_version2.TaxFee getCityTax() {
        return cityTax;
    }
     ...
     *     
     */
    public void setCityTax(aaa.soap.getAutoPolicyDetails.aaancnu_getautopolicydetail_version2.TaxFee value) {
        this.cityTax = value;
    }
     ...
     *     
     */
    public aaa.soap.getAutoPolicyDetails.aaancnu_getautopolicydetail_version2.TaxFee getCountyTax() {
        return countyTax;
    }
     ...
     *     
     */
    public void setCountyTax(aaa.soap.getAutoPolicyDetails.aaancnu_getautopolicydetail_version2.TaxFee value) {
     ...
     *     
     */
    public aaa.soap.getAutoPolicyDetails.aaancnu_getautopolicydetail_version2.TaxFee getStateTax() {
        return stateTax;
    }
     ...
     *     
     */
    public void setStateTax(aaa.soap.getAutoPolicyDetails.aaancnu_getautopolicydetail_version2.TaxFee value) {
        this.stateTax = value;
    }
     ...
     *     
     */
    public aaa.soap.getAutoPolicyDetails.aaancnu_getautopolicydetail_version2.ReferencedPolicies getReferencedPolicies() {
     ...
     *     
     */
    public void setReferencedPolicies(aaa.soap.getAutoPolicyDetails.aaancnu_getautopolicydetail_version2.ReferencedPolicies value) {
     ...
     * 
     */
    public List<aaa.soap.getAutoPolicyDetails.aaancnu_getautopolicydetail_version2.SurchargeAndFee> getOtherFee() {
        if (otherFee == null) {
            otherFee = new ArrayList<aaa.soap.getAutoPolicyDetails.aaancnu_getautopolicydetail_version2.SurchargeAndFee>();
        }
