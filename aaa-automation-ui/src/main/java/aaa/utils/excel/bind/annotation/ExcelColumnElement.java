...
public @interface ExcelColumnElement {
	 ...
	 * Only {@link Integer} type is supported for primary key field but in table it can be stored as String of numbers separated with {@link #primaryKeysSeparator} argument value
	 */
