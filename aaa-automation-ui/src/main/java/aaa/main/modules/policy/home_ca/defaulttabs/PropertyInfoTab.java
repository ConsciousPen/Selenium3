...
public class PropertyInfoTab extends Tab {
    ...
    public MultiInstanceAfterAssetList getDetachedStructuresAssetList() {
        return getAssetList().getAsset(HomeCaMetaData.PropertyInfoTab.DETACHED_STRUCTURES.getLabel(), MultiInstanceAfterAssetList.class);
    }
