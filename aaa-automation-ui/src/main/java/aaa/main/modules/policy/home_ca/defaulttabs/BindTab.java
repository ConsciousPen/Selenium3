...
public class BindTab extends Tab {
	...
	public Tab submitTab(boolean errorExpected) {
		...
		confirmPurchase();
		if (!errorExpected && errorTab.isVisible() && errorTab.getErrorCodesList().contains(ErrorEnum.Errors.ERROR_AAA_HO_CA_MEM_LASTNAME.getCode())) {
