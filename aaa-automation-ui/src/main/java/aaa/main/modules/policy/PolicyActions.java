				...
				for (int i = 0; i < rowsCount; i++) {
					...
					if (linkTriangle.isPresent() && linkTriangle.isVisible()) {
						...
						for (int j = 0; j < maxRowsCount; j++) {
							Link linkTriangle2 = new Link(By.xpath("//div[@id='comparisonTreeForm:comparisonTree']//tr[@id='comparisonTreeForm:comparisonTree_node_" + i
									+ "_" + j + "']/td[1]/span[contains(@class, 'ui-treetable-toggler')]"));
							if (linkTriangle2.isPresent() && linkTriangle2.isVisible()) {
								linkTriangle2.click();
								for (int z = 0; z < maxRowsCount; z++) {
									Link linkTriangle3 = new Link(By.xpath("//div[@id='comparisonTreeForm:comparisonTree']//tr[@id='comparisonTreeForm:comparisonTree_node_" + i
											+ "_" + j + "_" + z + "']/td[1]/span[contains(@class, 'ui-treetable-toggler')]"));
