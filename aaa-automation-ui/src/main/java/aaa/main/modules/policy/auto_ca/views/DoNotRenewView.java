...
import aaa.main.modules.policy.auto_ca.actiontabs.DoNotRenewActionTab;
 ...
 * @category Generated
 */
public class DoNotRenewView extends Workspace {
    public DoNotRenewView() {
        super();
        registerTab(DoNotRenewActionTab.class);
    }
}
