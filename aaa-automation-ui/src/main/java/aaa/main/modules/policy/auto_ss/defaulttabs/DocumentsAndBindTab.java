...
public class DocumentsAndBindTab extends Tab {
	...
	public static Button btnPurchase = new Button(By.xpath(".//input[contains(@id, 'policyDataGatherForm:moveToBilling') or contains(@id, 'policyDataGatherForm:moveToBilling_RenewalSave_footer')]"), Waiters.AJAX);
	public static Dialog confirmPurchase = new Dialog("//div[@id='policyDataGatherForm:confirmPurchaseDialog_container']");
