...
public class PolicySummaryPage extends SummaryPage {
    ...
    public static LocalDateTime getEffectiveDate() {
	    ...
	    if (!tableGeneralInformation.isPresent() || tableGeneralInformation.isPresent() && !tableGeneralInformation.getHeader().getValue().contains("Effective Date")) {
            ...
            dateEffective = TimeSetterUtil.getInstance().parse(tableGeneralInformation.getRow(1).getCell(PolicyConstants.PolicyGeneralInformationTable.EFFECTIVE_DATE).getValue(), DateTimeUtils.MM_DD_YYYY);
        }
    ...
    public static class TransactionHistory {
        ...
        public static LocalDateTime readEffectiveDate(String nameType) {
            return TimeSetterUtil.getInstance().parse(tableTransactionHistory.getRow(PolicyConstants.PolicyTransactionHistoryTable.TYPE, nameType).getCell(PolicyConstants.PolicyTransactionHistoryTable.EFFECTIVE_DATE)
                    .getValue(), DateTimeUtils.MM_DD_YYYY);
        }

        public static LocalDateTime readTransactionDate(String nameType) {
            return TimeSetterUtil.getInstance().parse(tableTransactionHistory.getRow(PolicyConstants.PolicyTransactionHistoryTable.TYPE, nameType).getCell(PolicyConstants.PolicyTransactionHistoryTable.TRANSACTION_DATE)
                    .getValue(), DateTimeUtils.MM_DD_YYYY);
        }
