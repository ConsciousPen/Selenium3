...
public final class CustomerMetaData {
    ...
    public static final class GeneralTab extends MetaData {
		...
		public static final AssetDescriptor<AssetList> ADDITIONAL_NAME_DETAILS_IND_SECTION = declare("AdditionalNameDetailsSection", AssetList.class, AdditionalNameDetailsSection.class, false, By.xpath("//div[@id='contentWrapper']"));
