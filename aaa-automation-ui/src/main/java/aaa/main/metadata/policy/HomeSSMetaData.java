...
public final class HomeSSMetaData {
	...
	public static final class ApplicantTab extends MetaData {
		...
		public static final AssetDescriptor<MultiInstanceAfterAssetList> NAMED_INSURED = declare("NamedInsured", MultiInstanceAfterAssetList.class, NamedInsured.class, By.xpath(".//div[@id='policyDataGatherForm:componentView_AAAHONamedInsured']"));
		public static final AssetDescriptor<AssetList> AAA_MEMBERSHIP = declare("AAAMembership", AssetList.class, AAAMembership.class, By.xpath(".//table[@id='policyDataGatherForm:formGrid_AAAHOMembership']"));
		public static final AssetDescriptor<AssetList> DWELLING_ADDRESS = declare("DwellingAddress", AssetList.class, DwellingAddress.class, By.xpath(".//div[@id='policyDataGatherForm:componentView_AAAHODwellAddress']"));
		public static final AssetDescriptor<AssetList> PREVIOUS_DWELLING_ADDRESS = declare("PreviousDwellingAddress", AssetList.class, PreviousDwellingAddress.class, By.xpath("//div[@id='policyDataGatherForm:componentView_AAAHOPreviousAddressComp']"));
		...
		public static final AssetDescriptor<AssetList> NAMED_INSURED_INFORMATION = declare("NamedInsuredInformation", AssetList.class, NamedInsuredInformation.class, By.xpath("//div[@id='policyDataGatherForm:componentView_AAAHOCommunicationInfo']"));
		public static final AssetDescriptor<MultiInstanceAfterAssetList> OTHER_ACTIVE_AAA_POLICIES = declare("OtherActiveAAAPolicies", MultiInstanceAfterAssetList.class, OtherActiveAAAPolicies.class, By.xpath("//div[@id='policyDataGatherForm:componentView_AAAHOOtherOrPriorPolicyComponent']"));
		public static final AssetDescriptor<AssetList> AGENT_INFORMATION = declare("AgentInfo", AssetList.class, AgentInfo.class, By.xpath("//div[@id='policyDataGatherForm:componentView_AAAProducerInfo']"));
		...
		public static final class NamedInsured extends MetaData {
			...
			public static final AssetDescriptor<SingleSelectSearchDialog> CUSTOMER_SEARCH = declare("CustomerSearchDialog", SingleSelectSearchDialog.class, CustomerSearch.class, By.xpath(".//form[@id='customerSearchFrom']"));
		...
		public static final class DwellingAddress extends MetaData {
			...
			public static final AssetDescriptor<Button> VALIDATE_ADDRESS_BTN = declare("Validate Address", Button.class, Waiters.AJAX, false, By.id("policyDataGatherForm:validateHODwellAddressButton"));
			public static final AssetDescriptor<AddressValidationDialog> VALIDATE_ADDRESS_DIALOG = declare("Validate Address Dialog", AddressValidationDialog.class, DialogsMetaData.AddressValidationMetaData.class, By.id(".//*[@id='addressValidationPopupAAAHODwellAddressValidationComp_content']"));
		}

		public static final class MailingAddress extends MetaData {
			public static final AssetDescriptor<RadioGroup> IS_DIFFERENT_MAILING_ADDRESS = declare("Is the mailing address different from the dwelling address?", RadioGroup.class, Waiters.AJAX, false,
			...
			public static final AssetDescriptor<TextBox> ADDRESS_VALIDATED = declare("Address validated", TextBox.class);
			public static final AssetDescriptor<Button> BTN_VALIDATE_ADDRESS = declare("Validate Address", Button.class, Waiters.AJAX, false, By.id("policyDataGatherForm:validateHOMailingAddressButtonUS"));
			public static final AssetDescriptor<AddressValidationDialog> VALIDATE_ADDRESS = declare("Validate Address Dialog", AddressValidationDialog.class, DialogsMetaData.AddressValidationMetaData.class, By.id("addressValidationPopupAAAHOMailingAddressValidation_container"));
		}

		public static final class PreviousDwellingAddress extends MetaData {
			public static final AssetDescriptor<RadioGroup> HAS_PREVIOUS_DWELLING_ADDRESS = declare("Has there been another dwelling address within the last 3 consecutive years?", RadioGroup.class, Waiters.AJAX, false,
			...
			public static final AssetDescriptor<AddressValidationDialog> VALIDATE_ADDRESS = declare("Validate Address Dialog", AddressValidationDialog.class, DialogsMetaData.AddressValidationMetaData.class, By.id("addressValidationPopupAAAHOPrevAddressValidationComp_container"));
		}
		...
		public static final class OtherActiveAAAPolicies extends MetaData {
			public static final AssetDescriptor<RadioGroup> OTHER_ACTIVE_AAA_POLICIES = declare("Other active AAA policies", RadioGroup.class, Waiters.AJAX, false, By.xpath("//table[@id='policyDataGatherForm:formGrid_AAAHOOtherPolicyViewOnly']"));
			...
			public static final AssetDescriptor<SingleSelectSearchDialog> ACTIVE_UNDERLYING_POLICIES_SEARCH = declare("ActiveUnderlyingPoliciesSearch", SingleSelectSearchDialog.class, OtherActiveAAAPoliciesSearch.class,
	...
	public static final class ReportsTab extends MetaData {
		public static final AssetDescriptor<RadioGroup> SALES_AGENT_AGREEMENT = declare("Sales Agent Agreement", RadioGroup.class, Waiters.AJAX, false, By.xpath("//table[@id='policyDataGatherForm:sedit_AAAHOCommonDisclosureMessageComponent_agentAgrees']"));
	...
	public static final class PropertyInfoTab extends MetaData {
		...
		public static final AssetDescriptor<AssetList> DWELLING_ADDRESS = declare("DwellingAddress", AssetList.class, DwellingAddress.class, By.xpath(".//table[@id='policyDataGatherForm:formGrid_AAAHOAddiDwellAddrMVO']"));
		public static final AssetDescriptor<MultiInstanceAfterAssetList> ADDITIONAL_ADDRESS = declare("AdditionalAddress", MultiInstanceAfterAssetList.class, AdditionalAddress.class, By.xpath(".//table[@id='policyDataGatherForm:formGrid_AAAHOAdditionalAddress']"));
		...
		public static final class AdditionalAddress extends MetaData {
			public static final AssetDescriptor<RadioGroup> ARE_THERE_ANY_ADDITIONAL_ADDRESSES = declare("Are there any additional address", RadioGroup.class, Waiters.AJAX, false, By.xpath("//table[@id='policyDataGatherForm:sedit_AAAHOAddiDwellAddrMVO_proxiedComponents_PreconfigDwell_addAddressInd']"));
			public static final AssetDescriptor<TextBox> ZIP_CODE = declare("Zip code", TextBox.class, Waiters.AJAX);
			public static final AssetDescriptor<TextBox> STREET_ADDRESS_1 = declare("Street address 1", TextBox.class, Waiters.AJAX);
			public static final AssetDescriptor<TextBox> STREET_ADDRESS_2 = declare("Street address 2", TextBox.class, Waiters.AJAX);
			public static final AssetDescriptor<TextBox> CITY = declare("City", TextBox.class, Waiters.AJAX);
			...
			public static final AssetDescriptor<AddressValidationDialog> VALIDATE_ADDRESS = declare("Validate Address Dialog", AddressValidationDialog.class, DialogsMetaData.AddressValidationMetaData.class, By.id("addressValidationFormAAAHOAdditionalDwelAddressValidation"));
		...
		public static final class PropertyValue extends MetaData {
			...
			public static final AssetDescriptor<ComboBox> REASON_REPLACEMENT_COST_DIFFERS_FROM_THE_TOOL_VALUE = declare("Reason replacement cost differs from the tool value", ComboBox.class, Waiters.AJAX);
		...
		public static final class AdditionalQuestions extends MetaData {
			...
			public static final AssetDescriptor<RadioGroup> IS_THERE_A_CREDITABLE_ALTERNATIVE_WATER_SOURCE_WITHIN_1_000_FEET_OF_THE_PROPERTY = declare("Is there a creditable alternative water source within 1,000 feet of the property?", RadioGroup.class, Waiters.NONE);
		}
		...
		public static final class TheftProtectiveTPDD extends MetaData {
			...
			public static final AssetDescriptor<CheckBox> GATED_COMMUNITY = declare("Gated community", CheckBox.class, By.xpath("//input[@id='policyDataGatherForm:sedit_AAAHOAntiTheftDevicesInfoProxy_gatedCommInd']"));
		}
		...
		public static final class HomeRenovation extends MetaData {
			...
			public static final AssetDescriptor<TextBox> PLUMBING_PERCENT_COMPLETE = declare("Plumbing % complete", TextBox.class, Waiters.AJAX, false, By.xpath("//input[@id='policyDataGatherForm:sedit_AAAHOBuildingImprovementsInfo_plumbingPercentComplete']"));
			...
			public static final AssetDescriptor<TextBox> PLUMBING_YEAR_OF_COMPLECTION = declare("Plumbing Year of completion", TextBox.class, Waiters.AJAX, false, By.xpath("//input[@id='policyDataGatherForm:sedit_AAAHOBuildingImprovementsInfo_plumbingRenovationYear']"));
			...
			public static final AssetDescriptor<TextBox> ELECTRICAL_PERCENT_COMPLETE = declare("Electrical % complete", TextBox.class, Waiters.AJAX, false, By.xpath("//input[@id='policyDataGatherForm:sedit_AAAHOBuildingImprovementsInfo_electricalPercentComplete']"));
		...
		public static final class PetsOrAnimals extends MetaData {
			public static final AssetDescriptor<RadioGroup> ARE_ANY_PETS_OR_ANIMALS_KEPT_ON_THE_PROPERTY = declare("Are any insured-owned pets or animals kept on the property?", RadioGroup.class, Waiters.AJAX);
		...
		public static final class Stoves extends MetaData {
			...
			public static final AssetDescriptor<RadioGroup> WAS_THE_STOVE_INSTALLED_BY_A_LICENSED_CONTRACTOR = declare("Was the stove installed by a licensed contractor?", RadioGroup.class, Waiters.AJAX);
			public static final AssetDescriptor<RadioGroup> DOES_THE_DWELLING_HAVE_AT_LEAST_ONE_SMOKE_DETECTOR_PER_STORY = declare("Does the dwelling have at least one smoke detector per story?", RadioGroup.class, Waiters.AJAX);
		}
		...
		public static final class RentalInformation extends MetaData {
			public static final AssetDescriptor<TextBox> NUMBER_OF_CONSECUTIVE_YEARS_INSURED_HAS_OWNED_ANY_RENTAL_PROPERTIES = declare("Number of consecutive years insured has owned any rental properties", TextBox.class, Waiters.AJAX);
	...
	public static final class EndorsementTab extends MetaData {
		...
		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> DS_03_12 = declare("DS 03 12", HomeSSEndorsementsMultiAssetList.class, EndorsementDS0312.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> DS_03_30 = declare("DS 03 30", HomeSSEndorsementsMultiAssetList.class, EndorsementDS0330.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> DS_03_30_08 = declare("DS 03 30 08", HomeSSEndorsementsMultiAssetList.class, EndorsementDS033008.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> DS_03_30_08 = declare("DS 03 30 08", HomeSSEndorsementsMultiAssetList.class, EndorsementDS033008.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> DS_03_30_08_12_VA = declare("DS 03 30 08 12 VA", HomeSSEndorsementsMultiAssetList.class, EndorsementDS03300812VA.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> DS_04_10 = declare("DS 04 10", HomeSSEndorsementsMultiAssetList.class, EndorsementDS0410.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		...
		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> DS_04_95 = declare("DS 04 95", HomeSSEndorsementsMultiAssetList.class, EndorsementDS0495.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> DS_04_99 = declare("DS 04 99", HomeSSEndorsementsMultiAssetList.class, EndorsementDS0499.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> DS_04_99_08_12 = declare("DS 04 99 08 12", HomeSSEndorsementsMultiAssetList.class, EndorsementDS04990812.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		...
		//		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> HS_03_30 = declare("HS 03 30", HomeSSEndorsementsMultiAssetList.class, EndorsementHS0330.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> HS_03_30_08_12_VA = declare("HS 03 30 08 12 VA", HomeSSEndorsementsMultiAssetList.class, EndorsementHS03300812VA.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> HS_04_10 = declare("HS 04 10", HomeSSEndorsementsMultiAssetList.class, EndorsementHS0410.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> HS_04_12 = declare("HS 04 12", HomeSSEndorsementsMultiAssetList.class, EndorsementHS0412.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> HS_04_20 = declare("HS 04 20", HomeSSEndorsementsMultiAssetList.class, EndorsementHS0420.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> HS_04_20_CO = declare("HS 04 20", HomeSSEndorsementsMultiAssetList.class, EndorsementHS0420CO.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> HS_04_20_WV = declare("HS 04 20", HomeSSEndorsementsMultiAssetList.class, EndorsementHS0420WV.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> HS_04_35 = declare("HS 04 35", HomeSSEndorsementsMultiAssetList.class, EndorsementHS0435.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> HS_04_36 = declare("HS 04 36", HomeSSEndorsementsMultiAssetList.class, EndorsementHS0436.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> HS_04_40 = declare("HS 04 40", HomeSSEndorsementsMultiAssetList.class, EndorsementHS0440.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> HS_04_41 = declare("HS 04 41", HomeSSEndorsementsMultiAssetList.class, EndorsementHS0441.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> HS_04_42 = declare("HS 04 42", HomeSSEndorsementsMultiAssetList.class, EndorsementHS0442.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> HS_04_43 = declare("HS 04 43", HomeSSEndorsementsMultiAssetList.class, EndorsementHS0443.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> HS_04_50 = declare("HS 04 50", HomeSSEndorsementsMultiAssetList.class, EndorsementHS0450.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> HS_04_52 = declare("HS 04 52", HomeSSEndorsementsMultiAssetList.class, EndorsementHS0452.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> HS_04_53 = declare("HS 04 53", HomeSSEndorsementsMultiAssetList.class, EndorsementHS0453.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> HS_04_54 = declare("HS 04 54", HomeSSEndorsementsMultiAssetList.class, EndorsementHS0454.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> HS_04_55 = declare("HS 04 55", HomeSSEndorsementsMultiAssetList.class, EndorsementHS0455.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> HS_04_59 = declare("HS 04 59", HomeSSEndorsementsMultiAssetList.class, EndorsementHS0459.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> HS_04_61 = declare("HS 04 61", HomeSSEndorsementsMultiAssetList.class, EndorsementHS0461.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> HS_04_65 = declare("HS 04 65", HomeSSEndorsementsMultiAssetList.class, EndorsementHS0465.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> HS_04_77 = declare("HS 04 77", HomeSSEndorsementsMultiAssetList.class, EndorsementHS0477.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> HS_04_90 = declare("HS 04 90", HomeSSEndorsementsMultiAssetList.class, EndorsementHS0490.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> HS_04_92 = declare("HS 04 92", HomeSSEndorsementsMultiAssetList.class, EndorsementHS0492.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> HS_04_93 = declare("HS 04 93", HomeSSEndorsementsMultiAssetList.class, EndorsementHS0493.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> HS_04_95 = declare("HS 04 95", HomeSSEndorsementsMultiAssetList.class, EndorsementHS0495.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> HS_04_99 = declare("HS 04 99", HomeSSEndorsementsMultiAssetList.class, EndorsementHS0499.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> HS_04_99_08_12 = declare("HS 04 99 08 12", HomeSSEndorsementsMultiAssetList.class, EndorsementHS04990812.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> HS_05_24 = declare("HS 05 24", HomeSSEndorsementsMultiAssetList.class, EndorsementHS0524.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> HS_05_46 = declare("HS 05 46", HomeSSEndorsementsMultiAssetList.class, EndorsementHS0546.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> HS_05_78 = declare("HS 05 78", HomeSSEndorsementsMultiAssetList.class, EndorsementHS0578.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> HS_06_14 = declare("HS 06 14", HomeSSEndorsementsMultiAssetList.class, EndorsementHS0614.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> HS_09_04 = declare("HS 09 04", HomeSSEndorsementsMultiAssetList.class, EndorsementHS0904.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> HS_09_06 = declare("HS 09 06", HomeSSEndorsementsMultiAssetList.class, EndorsementHS0906.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> HS_09_26 = declare("HS 09 26", HomeSSEndorsementsMultiAssetList.class, EndorsementHS0926.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> HS_09_27 = declare("HS 09 27", HomeSSEndorsementsMultiAssetList.class, EndorsementHS0927.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> HS_09_29 = declare("HS 09 29", HomeSSEndorsementsMultiAssetList.class, EndorsementHS0929.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> HS_09_30 = declare("HS 09 30", HomeSSEndorsementsMultiAssetList.class, EndorsementHS0930.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> HS_09_31 = declare("HS 09 31", HomeSSEndorsementsMultiAssetList.class, EndorsementHS0931.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> HS_09_32 = declare("HS 09 32", HomeSSEndorsementsMultiAssetList.class, EndorsementHS0932.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> HS_09_34 = declare("HS 09 34", HomeSSEndorsementsMultiAssetList.class, EndorsementHS0934.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> HS_09_37 = declare("HS 09 37", HomeSSEndorsementsMultiAssetList.class, EndorsementHS0937.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> HS_09_65 = declare("HS 09 65", HomeSSEndorsementsMultiAssetList.class, EndorsementHS0965.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> HS_09_88 = declare("HS 09 88", HomeSSEndorsementsMultiAssetList.class, EndorsementHS0988.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> HS_17_31 = declare("HS 17 31", HomeSSEndorsementsMultiAssetList.class, EndorsementHS1731.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> HS_17_33 = declare("HS 17 33", HomeSSEndorsementsMultiAssetList.class, EndorsementHS1733.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> HS_23_38 = declare("HS 23 38", HomeSSEndorsementsMultiAssetList.class, EndorsementHS2338.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> HS_23_83 = declare("HS 23 83", HomeSSEndorsementsMultiAssetList.class, EndorsementHS2383.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> HS_23_84 = declare("HS 23 84", HomeSSEndorsementsMultiAssetList.class, EndorsementHS2384.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> HS_24_43 = declare("HS 24 43", HomeSSEndorsementsMultiAssetList.class, EndorsementHS2443.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> HS_24_52 = declare("HS 24 52", HomeSSEndorsementsMultiAssetList.class, EndorsementHS2452.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> HS_24_64 = declare("HS 24 64", HomeSSEndorsementsMultiAssetList.class, EndorsementHS2464.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> HS_24_71 = declare("HS 24 71", HomeSSEndorsementsMultiAssetList.class, EndorsementHS2471.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> HS_24_72 = declare("HS 24 72", HomeSSEndorsementsMultiAssetList.class, EndorsementHS2472.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> HS_24_73 = declare("HS 24 73", HomeSSEndorsementsMultiAssetList.class, EndorsementHS2473.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> HS_24_94 = declare("HS 24 94", HomeSSEndorsementsMultiAssetList.class, EndorsementHS2494.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeSSEndorsementsMultiAssetList> HS_MS_I2 = declare("HS MS I2", HomeSSEndorsementsMultiAssetList.class, EndorsementHSMSI2.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));

		public static final class EndorsementDS0312 extends MetaData {
			public static final AssetDescriptor<ComboBox> WINDSTORM_OR_HAIL_DEDUCTIBLE = declare("Windstorm or Hail Deductible", ComboBox.class, Waiters.NONE);
		}
		...
		public static final class EndorsementDS0468 extends MetaData {
			...
			public static final AssetDescriptor<ComboBox> STATE = declare("State", ComboBox.class, Waiters.NONE);
			public static final AssetDescriptor<ComboBox> DESCRIPTION_OF_STRUCTURE = declare("Description of structure", ComboBox.class, Waiters.AJAX);
			public static final AssetDescriptor<ComboBox> CONSTRUCTION_TYPE = declare("Construction type", ComboBox.class, Waiters.NONE);
		...
		public static final class EndorsementDS0469 extends MetaData {
			...
			public static final AssetDescriptor<RadioGroup> INCLUDE_COVERAGE_FOR_EARTHQUAKE_LOSS_TO_EXTERIOR_MASONRY_VENEER = declare("Include coverage for earthquake loss to exterior masonry veneer?", RadioGroup.class, Waiters.AJAX);
		}
		...
		public static final class EndorsementHS0412 extends MetaData {
			public static final AssetDescriptor<ComboBox> COVERAGE_LIMIT = declare("Coverage limit", ComboBox.class, Waiters.NONE);
			public static final AssetDescriptor<RadioGroup> IS_THE_BUSINESS_CONDUCTED_ON_THE_RESIDENCE_PREMISES = declare("Is the business conducted on the residence premises?", RadioGroup.class, Waiters.AJAX);
			public static final AssetDescriptor<RadioGroup> IS_THE_BUSINESS_PROPERTY_FOR_SAMPLE_SALE_OR_DELIVERY_AFTER_SALE = declare("Is the business property for sample, sale or delivery after sale?", RadioGroup.class, Waiters.AJAX);
		}

		public static final class EndorsementHS0420 extends MetaData {
			public static final AssetDescriptor<ComboBox> AMOUNT_OF_INSURANCE = declare("Amount of insurance", ComboBox.class, Waiters.NONE);
		}
		...
		public static final class EndorsementHS0442 extends MetaData {
			...
			public static final AssetDescriptor<RadioGroup> BUSINESS_INVOLVING_HAZARDOUS_SITUATIONS_OR_MATERIALS = declare("Business involving hazardous situations or materials", RadioGroup.class, Waiters.AJAX);
			public static final AssetDescriptor<RadioGroup> BUSINESS_INVOLVING_THE_MANUFACTURING_OR_REPAIRING_OF_GOODS_OR_PRODUCTS = declare("Business involving the manufacturing or repairing of goods or products", RadioGroup.class, Waiters.AJAX);
			public static final AssetDescriptor<RadioGroup> PROFESSIONAL_LIABILITY_EXPOSURE_THAT_IS_UNINSURED = declare("Professional liability exposure that is uninsured", RadioGroup.class, Waiters.AJAX);
		...
		public static final class EndorsementHS0450 extends MetaData {
			...
			public static final AssetDescriptor<TextBox> DESCRIPTION_OF_RESIDENCE = declare("Description of residence", TextBox.class, Waiters.NONE);
		...
		public static final class EndorsementHS0454 extends MetaData {
			...
			public static final AssetDescriptor<RadioGroup> INCLUDE_COVERAGE_FOR_EARTHQUAKE_LOSS_TO_EXTERIOR_MASONRY_VENEER = declare("Include coverage for earthquake loss to exterior masonry veneer?", RadioGroup.class, Waiters.NONE);
			public static final AssetDescriptor<TextBox> REGION = declare("Region", TextBox.class, Waiters.NONE);
		}

		public static final class EndorsementHS0459 extends MetaData {
			public static final AssetDescriptor<TextBox> NAME_OF_RELATIVE = declare("Name of relative", TextBox.class, Waiters.NONE);
			...
			public static final AssetDescriptor<TextBox> NAME_OF_FACILITY = declare("Name of facility", TextBox.class, Waiters.NONE);
			public static final AssetDescriptor<TextBox> ZIP_CODE = declare("Zip code", TextBox.class, Waiters.AJAX);
			public static final AssetDescriptor<TextBox> STREET_ADDRESS_1 = declare("Street address 1", TextBox.class, Waiters.NONE);
			public static final AssetDescriptor<TextBox> STREET_ADDRESS_2 = declare("Street address 2", TextBox.class, Waiters.NONE);
			public static final AssetDescriptor<TextBox> CITY = declare("City", TextBox.class, Waiters.NONE);
			...
			public static final AssetDescriptor<ComboBox> COVERAGE_E_LIMIT = declare("Coverage E limit", ComboBox.class, Waiters.NONE);
		}
		...
		public static final class EndorsementHS0492 extends MetaData {
			public static final AssetDescriptor<TextBox> DESCRIPTION_OF_STRUCTURE = declare("Description of Structure", TextBox.class, Waiters.NONE);
			public static final AssetDescriptor<TextBox> ZIP_CODE = declare("Zip code", TextBox.class, Waiters.AJAX);
			public static final AssetDescriptor<TextBox> STREET_ADDRESS_1 = declare("Street address 1", TextBox.class, Waiters.NONE);
			public static final AssetDescriptor<TextBox> STREET_ADDRESS_2 = declare("Street address 2", TextBox.class, Waiters.NONE);
			public static final AssetDescriptor<TextBox> CITY = declare("City", TextBox.class, Waiters.NONE);
			public static final AssetDescriptor<ComboBox> STATE = declare("State", ComboBox.class, Waiters.NONE);
			public static final AssetDescriptor<TextBox> LIMIT_OF_LIABILITY = declare("Limit of liability", TextBox.class, Waiters.NONE);
			public static final AssetDescriptor<RadioGroup> IS_THE_STRUCTURE_USED_AS_A_DWELLING_OR_CAPABLE_OF_BEING_USED_AS_A_DWELLING = declare("Is the structure used as a dwelling or capable of being used as a dwelling?", RadioGroup.class, Waiters.AJAX);
			public static final AssetDescriptor<RadioGroup> IS_THE_STRUCTURE_USED_TO_CONDUCT_ANY_BUSINESS_OR_TO_STORE_ANY_BUSINESS_PROPERTY = declare("Is the structure used to conduct any business or to store any business property?", RadioGroup.class, Waiters.AJAX);
			public static final AssetDescriptor<RadioGroup> IS_THE_STRUCTURE_RENTED_OR_HELD_FOR_RENTAL_TO_ANY_PERSON_WHO_IS_NOT_A_RESIDENT_OF_THE_HOUSEHOLD = declare("Is the structure rented or held for rental to any person who is not a resident of the household?", RadioGroup.class, Waiters.AJAX);
			public static final AssetDescriptor<ComboBox> FIRE_DEPARTMENT_TYPE = declare("Fire department type", ComboBox.class, Waiters.AJAX);
			public static final AssetDescriptor<RadioGroup> SUBSCRIPTION_TO_FIRE_DEPARTMENT_STATION = declare("Subscription to fire department/station", RadioGroup.class, Waiters.AJAX);
			public static final AssetDescriptor<ComboBox> PUBLIC_PROTECTION_CLASS = declare("Public protection class", ComboBox.class, Waiters.AJAX);
			public static final AssetDescriptor<ComboBox> DISTANCE_TO_FIRE_HYDRANT = declare("Distance to fire hydrant", ComboBox.class, Waiters.AJAX);
			public static final AssetDescriptor<TextBox> FIRE_PROTECTION_AREA = declare("Fire protection area", TextBox.class, Waiters.NONE);
		}
		...
		public static final class EndorsementHS0546 extends MetaData {
			public static final AssetDescriptor<TextBox> DESCRIPTION_OF_RENTED_UNIT = declare("Description of rented unit", TextBox.class, Waiters.NONE);
			public static final AssetDescriptor<ComboBox> COVERAGE_AMOUNT = declare("Coverage amount", ComboBox.class, Waiters.NONE);
		}
		...
		public static final class EndorsementHS0904 extends MetaData {
			...
			public static final AssetDescriptor<RadioGroup> IS_THIS_AN_EXTENSION_OF_A_PRIOR_STRUCTURAL_ALTERATION_COVERAGE_ENDORSEMENT = declare("Is this an extension of a prior Structural Alteration Coverage endorsement?", RadioGroup.class, Waiters.AJAX);
			public static final AssetDescriptor<TextBox> REASON_FOR_EXTENSION = declare("Reason for extension", TextBox.class, Waiters.AJAX);
			public static final AssetDescriptor<RadioGroup> IS_THIS_FOR_AN_EXISTING_HOME_THAT_WILL_BE_UNDERGOING_RENOVATION_OR_REMODEL = declare("Is this for an existing home that will be undergoing renovation or remodel?", RadioGroup.class, Waiters.AJAX);
			public static final AssetDescriptor<RadioGroup> IS_THIS_FOR_A_NEW_HOME_THAT_IS_BEING_RENOVATED_FOR_SPECULATION = declare("Is this for a new home that is being renovated for speculation?", RadioGroup.class, Waiters.AJAX);
			public static final AssetDescriptor<RadioGroup> WILL_CONSTRUCTION_BE_COMPLETED_BY_A_LICENSED_CONTRACTOR = declare("Will construction be completed by a licensed contractor?", RadioGroup.class, Waiters.AJAX);
			public static final AssetDescriptor<RadioGroup> WILL_THE_HOME_REMAIN_OCCUPIED_DURING_CONSTRUCTION = declare("Will the home remain occupied during construction?", RadioGroup.class, Waiters.AJAX);
			...
			public static final AssetDescriptor<RadioGroup> WILL_THE_CONSTRUCTION_BE_COMPLETED_WITHIN_180_DAYS = declare("Will the construction be completed within 180 days?", RadioGroup.class, Waiters.AJAX);
		...
		public static final class EndorsementHS0937 extends MetaData {
			public static final AssetDescriptor<TextBox> DESCRIPTION_OF_STRUCTURE = declare("Description of structure", TextBox.class, Waiters.NONE);
			public static final AssetDescriptor<ComboBox> LOCATION_OF_STRUCTURE = declare("Location of structure", ComboBox.class, Waiters.NONE);
			public static final AssetDescriptor<TextBox> ZIP_CODE = declare("Zip code", TextBox.class, Waiters.AJAX);
			public static final AssetDescriptor<TextBox> STREET_ADDRESS_1 = declare("Street address 1", TextBox.class, Waiters.NONE);
			public static final AssetDescriptor<TextBox> STREET_ADDRESS_2 = declare("Street address 2", TextBox.class, Waiters.NONE);
			public static final AssetDescriptor<TextBox> CITY = declare("City", TextBox.class, Waiters.NONE);
		...
		public static final class EndorsementHS0988 extends MetaData {
			public static final AssetDescriptor<TextBox> NAME_OF_PERSON_OR_ORGANIZATION = declare("Name of person or organization", TextBox.class, Waiters.NONE);
			public static final AssetDescriptor<TextBox> ZIP_CODE = declare("Zip code", TextBox.class, Waiters.AJAX);
			public static final AssetDescriptor<TextBox> STREET_ADDRESS_1 = declare("Street address 1", TextBox.class, Waiters.NONE);
			public static final AssetDescriptor<TextBox> STREET_ADDRESS_2 = declare("Street address 2", TextBox.class, Waiters.NONE);
			public static final AssetDescriptor<TextBox> CITY = declare("City", TextBox.class, Waiters.NONE);
			public static final AssetDescriptor<ComboBox> STATE = declare("State", ComboBox.class, Waiters.NONE);
			public static final AssetDescriptor<TextBox> DESCRIPTION_OF_INSURABLE_INTEREST = declare("Description of insurable interest", TextBox.class, Waiters.NONE);
			...
			public static final AssetDescriptor<TextBox> EVENT_STREET_ADDRESS_1 = declare("Event street address 1", TextBox.class, Waiters.NONE);
			public static final AssetDescriptor<TextBox> EVENT_STREET_ADDRESS_2 = declare("Event street address 2", TextBox.class, Waiters.NONE);
			public static final AssetDescriptor<TextBox> EVENT_CITY = declare("Event city", TextBox.class, Waiters.NONE);
			public static final AssetDescriptor<ComboBox> EVENT_STATE = declare("Event state", ComboBox.class, Waiters.NONE);
			public static final AssetDescriptor<TextBox> EFFECTIVE_DATE = declare("Effective date", TextBox.class, Waiters.AJAX);
			public static final AssetDescriptor<TextBox> EXPIRATION_DATE = declare("Expiration date", TextBox.class, Waiters.AJAX);
			public static final AssetDescriptor<ComboBox> COVERAGE_E_LIMIT = declare("Coverage E limit", ComboBox.class, Waiters.NONE);
			public static final AssetDescriptor<TextBox> ADDITIONAL_COMMENTS_ABOUT_THE_EVENT = declare("Additional comments about the event", TextBox.class, Waiters.NONE);
			...
			public static final AssetDescriptor<RadioGroup> WILL_THERE_BE_A_SWIMMING_POOL_BOUNCE_HOUSE_OR_TRAMPOLINE_AT_THE_EVENT_LOCATION = declare("Will there be a swimming pool, bounce house, or trampoline at the event location?", RadioGroup.class, Waiters.AJAX);
			...
			public static final AssetDescriptor<RadioGroup> WILL_THERE_BE_DANGEROUS_OR_EXOTIC_ANIMALS_INCLUDING_VICIOUS_DOGS_AT_THE_EVENT = declare("Will there be dangerous or exotic animals, including vicious dogs at the event?", RadioGroup.class, Waiters.AJAX);
			public static final AssetDescriptor<RadioGroup> WILL_THERE_BE_HIRED_OR_VOLUNTEER_STAFF_AT_THE_EVENT = declare("Will there be hired or volunteer staff at the event?", RadioGroup.class, Waiters.AJAX);
			public static final AssetDescriptor<TextBox> ESTIMATED_TOTAL_NUMBER_OF_GUESTS_18_AND_OLDER = declare("Estimated total number of guests 18 and older", TextBox.class, Waiters.NONE);
			public static final AssetDescriptor<TextBox> ESTIMATED_TOTAL_NUMBER_OF_GUESTS_UNDER_AGE_18 = declare("Estimated total number of guests under age 18", TextBox.class, Waiters.NONE);
			...
			public static final AssetDescriptor<ComboBox> IF_A_CONTRACT_APPLIES_DOES_THE_CONTRACT_INCLUDE_A_HOLD_HARMLESS_CLAUSE = declare("If a contract applies, does the contract include a hold harmless clause?", ComboBox.class, Waiters.AJAX);
			...
			public static final AssetDescriptor<RadioGroup> IS_THE_EVENT_BEING_HELD_BY_THE_NAMED_INSURED_AND_IF_A_CONTRACT_APPLIES_IS_THE_CONTRACT_AGREEMENT_IN_THE_NAME_OF_AT_LEAST_ONE_OF_THE_NAMED_INSUREDS_ON_THIS_POLICY =
		...
		public static final class EndorsementHS2443 extends MetaData {
			public static final AssetDescriptor<TextBox> DESCRIPTION_OF_BUSINESS = declare("Description of business", TextBox.class, Waiters.NONE);
			public static final AssetDescriptor<TextBox> ZIP_CODE = declare("Zip code", TextBox.class, Waiters.AJAX);
			public static final AssetDescriptor<TextBox> STREET_ADDRESS_1 = declare("Street address 1", TextBox.class, Waiters.NONE);
			public static final AssetDescriptor<TextBox> STREET_ADDRESS_2 = declare("Street address 2", TextBox.class, Waiters.NONE);
			public static final AssetDescriptor<TextBox> CITY = declare("City", TextBox.class, Waiters.NONE);
		...
		public static final class EndorsementHS2464 extends MetaData {
			...
			public static final AssetDescriptor<TextBox> SERIAL_OR_MOTOR_NUMBER = declare("Serial or Motor number", TextBox.class, Waiters.NONE);
		}

		public static final class EndorsementHS2471 extends MetaData {
			public static final AssetDescriptor<TextBox> NAME_OF_BUSINESS = declare("Name of business", TextBox.class, Waiters.NONE);
			public static final AssetDescriptor<TextBox> DESCRIPTION_OF_BUSINESS = declare("Description of Business", TextBox.class, Waiters.NONE);
			public static final AssetDescriptor<ComboBox> CLASSIFICATION_OCCUPATION = declare("Classification/occupation", ComboBox.class, Waiters.NONE);
		...
		public static final class EndorsementHS2472 extends MetaData {
			public static final AssetDescriptor<TextBox> DESCRIPTION_OF_THE_NATURE_OF_THE_FARMING = declare("Description of the nature of the farming", TextBox.class, Waiters.NONE);
			public static final AssetDescriptor<RadioGroup> IS_THE_FARMING_LOCATED_AT_THE_RESIDENCE_PREMISES = declare("Is the farming located at the residence premises?", RadioGroup.class, Waiters.AJAX);
			public static final AssetDescriptor<TextBox> ZIP_CODE = declare("Zip code", TextBox.class, Waiters.AJAX);
			public static final AssetDescriptor<TextBox> STREET_ADDRESS_1 = declare("Street address 1", TextBox.class, Waiters.NONE);
			public static final AssetDescriptor<TextBox> STREET_ADDRESS_2 = declare("Street address 2", TextBox.class, Waiters.NONE);
			public static final AssetDescriptor<TextBox> CITY = declare("City", TextBox.class, Waiters.NONE);
			public static final AssetDescriptor<ComboBox> STATE = declare("State", ComboBox.class, Waiters.AJAX);
			public static final AssetDescriptor<RadioGroup> IS_THE_INCOME_DERIVED_FROM_THE_FARMING_A_PRIMARY_SOURCE_OF_INCOME = declare("Is the income derived from the farming a primary source of income?", RadioGroup.class, Waiters.AJAX);
			public static final AssetDescriptor<RadioGroup> IS_THE_FARMING_LOCATION_USED_FOR_RACING_PURPOSES = declare("Is the farming location used for racing purposes?", RadioGroup.class, Waiters.AJAX);
		}
		...
		public static final class EndorsementHS2473 extends MetaData {
			...
			public static final AssetDescriptor<RadioGroup> IS_THE_BUILDING_PRESENT_ON_THE_FARM_PREMISES = declare("Is the building present on the farm premises?", RadioGroup.class, Waiters.NONE);
			public static final AssetDescriptor<TextBox> TOTAL_NUMBER_OF_PERSON_DAYS_WORKED_FOR_ALL_PART_TIME_EMPLOYEES_WHO_WORK_40_DAYS_OR_LESS_PER_YEAR = declare("Total number of person days worked for all part-time employees who work 40 days or less per year", TextBox.class, Waiters.AJAX);
			public static final AssetDescriptor<TextBox> NUMBER_OF_PART_TIME_EMPLOYEES_41_179_DAYS_PER_YEAR = declare("Number of part-time employees (41-179 days per year)", TextBox.class, Waiters.AJAX);
			public static final AssetDescriptor<TextBox> NUMBER_OF_FULL_TIME_EMPLOYEES_180_OR_MORE_DAYS_PER_YEAR = declare("Number of full-time employees (180 or more days per year)", TextBox.class, Waiters.AJAX);
			public static final AssetDescriptor<TextBox> TOTAL_ANNUAL_PAYROLL = declare("Total annual payroll", TextBox.class, Waiters.NONE);
			public static final AssetDescriptor<ComboBox> OWNERSHIP_AND_OPERATION_OF_FARM = declare("Ownership and operation of farm", ComboBox.class, Waiters.NONE);
			public static final AssetDescriptor<RadioGroup> IS_PRINCIPAL_PURPOSE_OF_THE_FARM_IS_TO_SUPPLY_COMMODITIES_FOR_MANUFACTURING_OR_PROCESSING_BY_THE_INSURED_FOR_SALE_TO_OTHERS_SUCH_AS_CREAMERIES_AND_DAIRIES =
			...
			public static final AssetDescriptor<RadioGroup> IS_THE_FARMING_LOCATION_USED_FOR_RACING_PURPOSES = declare("Is the farming location used for racing purposes?", RadioGroup.class, Waiters.AJAX);
			public static final AssetDescriptor<RadioGroup> DOES_THE_FARM_OPERATE_FREEZING_OR_DEHYDRATING_PLANTS_OR_POULTRY_FACTORIES = declare("Does the farm operate freezing or dehydrating plants or poultry factories?", RadioGroup.class, Waiters.AJAX);
			...
			public static final AssetDescriptor<RadioGroup> IS_ANY_OTHER_BUSINESS_ACTIVITY_CONDUCTED_AT_THE_FARM_LOCATION = declare("Is any other business activity conducted at the farm location?", RadioGroup.class, Waiters.AJAX);
		}

		public static final class EndorsementHS2494 extends MetaData {
			public static final AssetDescriptor<RadioGroup> IS_THE_EMPLOYEE_A_PRIVATE_RESIDENCE_OR_ESTATE_FULL_TIME_INSERVANT = declare("Is the employee a Private Residence or Estate - Full Time Inservant?", RadioGroup.class, Waiters.AJAX);
			public static final AssetDescriptor<RadioGroup> IS_THE_EMPLOYEE_A_PRIVATE_RESIDENCE_FULL_TIME_OUTSERVANT_INCLUDING_DRIVERS = declare("Is the employee a Private Residence - Full Time Outservant including drivers?", RadioGroup.class, Waiters.AJAX);
			public static final AssetDescriptor<RadioGroup> IS_THE_EMPLOYEE_A_PRIVATE_ESTATE_FULL_TIME_OUTSERVANT_INCLUDING_DRIVERS = declare("Is the employee a Private Estate - Full Time Outservant including drivers?", RadioGroup.class, Waiters.AJAX);
			...
			public static final AssetDescriptor<ComboBox> NUMBER_OF_EMPLOYEES_VALUE1 = declare("Number of Employees Value1", ComboBox.class, Waiters.AJAX, false, By.xpath("//input[@id='policyDataGatherForm:sedit__HS2494EndorsementForm_value1]"));
			public static final AssetDescriptor<ComboBox> NUMBER_OF_EMPLOYEES_VALUE2 = declare("Number of Employees Value2", ComboBox.class, Waiters.AJAX, false, By.xpath("//input[@id='policyDataGatherForm:sedit__HS2494EndorsementForm_value2]"));
			public static final AssetDescriptor<ComboBox> NUMBER_OF_EMPLOYEES_VALUE3 = declare("Number of Employees Value3", ComboBox.class, Waiters.AJAX, false, By.xpath("//input[@id='policyDataGatherForm:sedit__HS2494EndorsementForm_value3]"));
		}
		...
		public static final class EndorsementHS0929 extends MetaData {
			public static final AssetDescriptor<ComboBox> PROPERTY_COVERAGE_LIMIT = declare("Property Coverage Limit", ComboBox.class, Waiters.NONE);
			public static final AssetDescriptor<ComboBox> LIABILITY_COVERAGE_LIMIT = declare("Liability Coverage Limit", ComboBox.class, Waiters.NONE);
		}
	...
	public static final class PersonalPropertyTab extends MetaData {
		public static final AssetDescriptor<PersonalPropertyMultiAssetList> BICYCLES = declare("Bicycles", PersonalPropertyMultiAssetList.class, Bicycles.class, By.xpath("//div[@id='policyDataGatherForm:componentView_ScheduledPropertyBicyclesItem']"));
		public static final AssetDescriptor<PersonalPropertyMultiAssetList> CAMERAS = declare("Cameras", PersonalPropertyMultiAssetList.class, Cameras.class, By.xpath("//div[@id='policyDataGatherForm:componentView_ScheduledPropertyCamerasItem']"));
		public static final AssetDescriptor<PersonalPropertyMultiAssetList> COINS = declare("Coins", PersonalPropertyMultiAssetList.class, Coins.class, By.xpath("//div[@id='policyDataGatherForm:componentView_ScheduledPropertyCoinsItem']"));
		public static final AssetDescriptor<PersonalPropertyMultiAssetList> FINE_ARTS = declare("Fine arts", PersonalPropertyMultiAssetList.class, FineArts.class, By.xpath("//div[@id='policyDataGatherForm:componentView_ScheduledPropertyFineArtsItem']"));
		public static final AssetDescriptor<PersonalPropertyMultiAssetList> FIREARMS = declare("Firearms", PersonalPropertyMultiAssetList.class, Firearms.class, By.xpath("//div[@id='policyDataGatherForm:componentView_ScheduledPropertyFirearmsItem']"));
		public static final AssetDescriptor<PersonalPropertyMultiAssetList> FURS = declare("Furs", PersonalPropertyMultiAssetList.class, Furs.class, By.xpath("//div[@id='policyDataGatherForm:componentView_ScheduledPropertyFursItem']"));
		public static final AssetDescriptor<PersonalPropertyMultiAssetList> GOLF_EQUIPMENT = declare("Golf equipment", PersonalPropertyMultiAssetList.class, GolfEquipment.class, By.xpath("//div[@id='policyDataGatherForm:componentView_ScheduledPropertyGolfItem']"));
		public static final AssetDescriptor<PersonalPropertyMultiAssetList> JEWELRY = declare("Jewelry", PersonalPropertyMultiAssetList.class, Jewelry.class, By.xpath("//div[@id='policyDataGatherForm:componentView_ScheduledPropertyJewelryItem']"));
		public static final AssetDescriptor<PersonalPropertyMultiAssetList> MEDICAL_DEVICES = declare("Medical devices", PersonalPropertyMultiAssetList.class, MedicalDevices.class, By.xpath("//div[@id='policyDataGatherForm:componentView_ScheduledPropertyMedicalItem']"));
		public static final AssetDescriptor<PersonalPropertyMultiAssetList> MUSICAL_INSTRUMENTS = declare("Musical instruments", PersonalPropertyMultiAssetList.class, MusicalInstruments.class, By.xpath("//div[@id='policyDataGatherForm:componentView_ScheduledPropertyMusicalItem']"));
		public static final AssetDescriptor<PersonalPropertyMultiAssetList> POSTAGE_STAMPS = declare("Postage stamps", PersonalPropertyMultiAssetList.class, PostageStamps.class, By.xpath("//div[@id='policyDataGatherForm:componentView_ScheduledPropertyPostageItem']"));
		public static final AssetDescriptor<PersonalPropertyMultiAssetList> SILVERWARE = declare("Silverware", PersonalPropertyMultiAssetList.class, Silverware.class, By.xpath("//div[@id='policyDataGatherForm:componentView_ScheduledPropertySilverwareItem']"));
		public static final AssetDescriptor<PersonalPropertyMultiAssetList> TRADING_CARDS_OR_COMICS = declare("Trading cards or comics", PersonalPropertyMultiAssetList.class, TradingCardsOrComics.class, By.xpath("//div[@id='policyDataGatherForm:componentView_ScheduledPropertyTradingCardsItem']"));
		...
		public static final class MedicalDevices extends MetaData {
			public static final AssetDescriptor<TextBox> LIMIT_OF_LIABILITY = declare("Limit of liability", TextBox.class, Waiters.AJAX);
			public static final AssetDescriptor<ComboBox> TYPE_OF_DEVICE = declare("Type of device", ComboBox.class, Waiters.NONE);
			public static final AssetDescriptor<TextBox> DESCRIPTION = declare("Description", TextBox.class, Waiters.NONE);
		}
		...
		public static final class TradingCardsOrComics extends MetaData {
			...
			public static final AssetDescriptor<RadioGroup> CERTIFICATE_OF_AUTHENTICITY_RECEIVED = declare("Certificate of authenticity received", RadioGroup.class, Waiters.NONE);
			public static final AssetDescriptor<TextBox> DESCRIPTION = declare("Description", TextBox.class, Waiters.NONE);
		}
	...
	public static final class MortgageesTab extends MetaData {
		...
		public static final AssetDescriptor<AssetListConfirmationDialog> MORTGAGEE_REMOVE_CONFIRMATION = declare("Mortgagee remove confirmation", AssetListConfirmationDialog.class, Waiters.AJAX, false,
		...
		public static final AssetDescriptor<AssetListConfirmationDialog> LEGAL_PROPERTY_ADDRESS_REMOVE_CONFIRMATION = declare("Legal property address remove confirmation", AssetListConfirmationDialog.class, Waiters.AJAX, false,
		...
		public static final AssetDescriptor<AssetListConfirmationDialog> ADDITIONAL_INSURED_REMOVE_CONFIRMATION = declare("Additional Insured remove confirmation", AssetListConfirmationDialog.class, Waiters.AJAX, false,
		...
		public static final AssetDescriptor<AssetListConfirmationDialog> ADDITIONAL_INTEREST_REMOVE_CONFIRMATION = declare("Additional Insured remove confirmation", AssetListConfirmationDialog.class, Waiters.AJAX, false,
		...
		public static final class MortgageeInformation extends MetaData {
			...
			public static final AssetDescriptor<AddressValidationDialog> VALIDATE_ADDRESS_DIALOG = declare("Validate Address Dialog", AddressValidationDialog.class, DialogsMetaData.AddressValidationMetaData.class, By.id(".//div[@id='addressValidationPopupAAAHOMortgageeAddressValidation_container']"));
		...
		public static final class LegalPropetyAddress extends MetaData {
			...
			public static final AssetDescriptor<AddressValidationDialog> VALIDATE_ADDRESS_DIALOG = declare("Validate Address Dialog", AddressValidationDialog.class, DialogsMetaData.AddressValidationMetaData.class, By.id(".//div[@id='addressValidationPopupAAAHOLegalPropAddressValidationComp_container']"));
		}
	...
	public static final class UnderwritingAndApprovalTab extends MetaData {
		...
		public static final AssetDescriptor<TextBox> REMARK_RENOVATION = declare("Remark Renovation", TextBox.class, Waiters.AJAX, false, By.id("policyDataGatherForm:sedit_AAAUnderwritingQuestionaireComponent_aaaDwellRenovationRemark"));
		public static final AssetDescriptor<TextBox> REMARK_RESIDENT_EMPLOYEES = declare("Remark Resident Employees", TextBox.class, Waiters.AJAX, false, By.id("policyDataGatherForm:sedit_AAAUnderwritingQuestionaireComponent_aaaEmployeesGradeRemark"));
	...
	public static final class DocumentsTab extends MetaData {
		...
		public static final AssetDescriptor<AssetList> DOCUMENTS_TO_BIND = declare("DocumentsToBind", AssetList.class, DocumentsToBind.class, By.xpath(".//div[@id='policyDataGatherForm:componentView_AAAHOBindDocuments']"));
		public static final AssetDescriptor<AssetList> DOCUMENTS_TO_ISSUE = declare("DocumentsToIssue", AssetList.class, DocumentsToIssue.class, By.xpath(".//div[@id='policyDataGatherForm:componentView_AAAHOIssueDocuments']"));
		...
		public static final class DocumentsToBind extends MetaData {
			...
			public static final AssetDescriptor<RadioGroup> PROOF_OF_UNDERLYING_INSURANCE_POLICY = declare("Proof of Underlying Insurance policy for the tenant(s) received?", RadioGroup.class, Waiters.NONE);
			...
			public static final AssetDescriptor<RadioGroup> PROOF_OF_HOME_RENOVATIONS_FOR_MODERNIZATION = declare("Proof of home renovations for the Home Modernization discount", RadioGroup.class, Waiters.NONE);
			...
			public static final AssetDescriptor<RadioGroup> CERTIFICATE_NO_CONTAMINATION_CAUSED_BY_OIL_STORAGE_TANK = declare("Certificate confirming no contamination caused by inactive underground oil storage tank", RadioGroup.class, Waiters.AJAX);
			public static final AssetDescriptor<RadioGroup> PROOF_OF_PLUMBING_AND_OTHER_RENOVATIONS = declare("Proof of plumbing, electrical, heating/cooling system and roof renovations", RadioGroup.class, Waiters.AJAX);
			public static final AssetDescriptor<RadioGroup> ACTUAL_CASH_VALUE_LOSS_SETTLEMENT_LOSSES_TO_ROOF_SURFACING = declare("Actual Cash Value Loss Settlement Windstorm Or Hail Losses To Roof Surfacing", RadioGroup.class, Waiters.NONE);
			public static final AssetDescriptor<RadioGroup> APPRAISALS_SALES_RECEIPTS_FOR_SCHEDULED_PROPERTY = declare("Appraisals/sales receipts for scheduled personal property items", RadioGroup.class, Waiters.NONE);
			public static final AssetDescriptor<RadioGroup> COVERAGE_ACCEPTANCE_STATEMENT = declare("Coverage Acceptance Statement", RadioGroup.class, Waiters.NONE);
			public static final AssetDescriptor<RadioGroup> THIRD_PARTY_DESIGNEE_FORM = declare("Third Party Designee Form", RadioGroup.class, Waiters.NONE);

			public static final AssetDescriptor<RadioGroup> CALIFORNIA_RESIDENTIAL_PROPERTY_INSURANCE = declare("California Residential Property Insurance Disclosure", RadioGroup.class, Waiters.NONE);
			public static final AssetDescriptor<RadioGroup> OHIO_MINE_SUBSIDENCE_INSURANCE_UNDERWRITING_ASSOSIATION_APPLICATION = declare("Ohio Mine Subsidence Insurance Underwriting Association Application", RadioGroup.class, Waiters.NONE);
			public static final AssetDescriptor<RadioGroup> PROOF_OF_LEAD_LIABILITY_AFFECTED_PROPERTY_REGISTERED_DOE = declare("Proof lead liability \"affected property\" is registered with the Department of Environment and meets their requirements", RadioGroup.class,
					Waiters.AJAX);
			public static final AssetDescriptor<RadioGroup> KENTUCKY_MINE_SUBSIDENCE_INSURANCE_FUND_WAIVER_FORM = declare("Kentucky Mine Subsidence Insurance Fund Waiver Form", RadioGroup.class, Waiters.NONE);
		}
	...
	public static final class GenerateOnDemandDocumentActionTab extends MetaData {
		public static final AssetDescriptor<FillableDocumentsTable> ON_DEMAND_DOCUMENTS = declare("OnDemandDocuments", FillableDocumentsTable.class, DocumentRow.class, By.xpath("(//div[@id='policyDataGatherForm:componentView_AAAHODocGen']//table)[1]"));
