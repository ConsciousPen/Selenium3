...
public final class PersonalUmbrellaMetaData {
	...
	public static final class PrefillTab extends MetaData {
		...
		public static final AssetDescriptor<MultiInstanceAfterAssetList> NAMED_INSURED =
				declare("NamedInsured", MultiInstanceAfterAssetList.class, NamedInsured.class, By.xpath(".//div[@id='policyDataGatherForm:componentView_AAAInsured']"));
		public static final AssetDescriptor<AdditionalPoliciesMultiAssetList> ACTIVE_UNDERLYING_PRIMARY_POLICY =
				declare("ActiveUnderlyingPrimaryPolicy", AdditionalPoliciesMultiAssetList.class, ActiveUnderlyingPolicies.class);
		public static final AssetDescriptor<AdditionalPoliciesMultiAssetList> ACTIVE_UNDERLYING_POLICIES =
				declare("ActiveUnderlyingPolicies", AdditionalPoliciesMultiAssetList.class, ActiveUnderlyingPolicies.class);
		...
		public static final class NamedInsured extends MetaData {
			public static final AssetDescriptor<ComboBox> PREFIX = declare("Prefix", ComboBox.class, Waiters.NONE);
			...
			public static final AssetDescriptor<ComboBox> SUFFIX = declare("Suffix", ComboBox.class, Waiters.NONE);
			...
			public static final AssetDescriptor<ComboBox> GENDER = declare("Gender", ComboBox.class, Waiters.NONE);
			...
			public static final AssetDescriptor<ComboBox> OCCUPATION = declare("Occupation", ComboBox.class, Waiters.NONE);
			public static final AssetDescriptor<RadioGroup> D_O_OFFICERS_PRESIDENT_VP_SECRETARY_TREASURER =
					declare("D&O Officers - President, VP, Secretary, Treasurer", RadioGroup.class, Waiters.NONE);
			public static final AssetDescriptor<RadioGroup> D_O_OTHER_THAN_OFFICERS_BOARD_MEMBERS = declare("D&O other than Officers - Board Members", RadioGroup.class, Waiters.NONE);
			public static final AssetDescriptor<TextBox> EMPLOYER = declare("Employer", TextBox.class, Waiters.NONE);
			public static final AssetDescriptor<RadioGroup> AAA_EMPLOYEE = declare("AAA employee", RadioGroup.class, Waiters.NONE);
		...
		public static final class ActiveUnderlyingPolicies extends MetaData {
			...
			public static final AssetDescriptor<SingleSelectSearchDialog> ACTIVE_UNDERLYING_POLICIES_SEARCH =
					declare("ActiveUnderlyingPoliciesSearch", SingleSelectSearchDialog.class, ActiveUnderlyingPoliciesSearch.class, By.xpath(".//div[@id='pupPolicySearchPopup_container']"));
			...
			public static final class ActiveUnderlyingPoliciesManual extends MetaData {
				...
				public static final AssetDescriptor<TextBox> POLICY_NUMBER = declare("Policy number", TextBox.class, Waiters.NONE);
				public static final AssetDescriptor<ComboBox> DWELLING_USAGE = declare("Dwelling usage", ComboBox.class, Waiters.NONE);
	...
	public static final class GeneralTab extends MetaData {
		...
		public static final AssetDescriptor<AssetList> MAILING_ADDRESS =
				declare("MailingAddress", AssetList.class, MailingAddress.class, By.xpath(".//table[@id='policyDataGatherForm:formGrid_AAAHOMailingAddressComponent']"));
		...
		public static final class AAAMembership extends MetaData {
			...
			public static final AssetDescriptor<TextBox> MEMBERSHIP_NUMBER = declare("Membership number", TextBox.class, Waiters.NONE);
			public static final AssetDescriptor<TextBox> LAST_NAME = declare("Last name", TextBox.class, Waiters.NONE);
			public static final AssetDescriptor<TextBox> MEMBER_SINCE_DATE = declare("Member Since Date", TextBox.class, Waiters.NONE);
			public static final AssetDescriptor<TextBox> MEMBERSHIP_EXPIRATION_DATE = declare("Membership Expiration date", TextBox.class, Waiters.NONE);
			public static final AssetDescriptor<TextBox> MEMBERSHIP_STATUS = declare("Membership Status", TextBox.class, Waiters.NONE);
		}
		...
		public static final class DwellingAddress extends MetaData {
			...
			public static final AssetDescriptor<ComboBox> STATE = declare("State", ComboBox.class, Waiters.NONE);
			public static final AssetDescriptor<Button> VALIDATE_ADDRESS_DWELLING_ADDRESS =
					declare("Validate Address", Button.class, Waiters.AJAX, false, By.id("policyDataGatherForm:validateAdditionalDwellingAddressButton"));
		...
		public static final class MailingAddress extends MetaData {
			public static final AssetDescriptor<RadioGroup> IS_DIFFERENT_MAILING_ADDRESS_RBTN =
					declare("Is the mailing address different from the dwelling address?", RadioGroup.class, Waiters.AJAX, false,
							By.xpath("//table[@id='policyDataGatherForm:addOptionalQuestion_AAAHOMailingAddressComponent']"));
			public static final AssetDescriptor<AssetListConfirmationDialog> REMOVE_CONFIRMATION =
					declare("Remove confirmation", AssetListConfirmationDialog.class, Waiters.AJAX, false, By.id("confirmOptionalNoSelected_AAAHOMailingAddressComponent_Dialog_container"));
			public static final AssetDescriptor<TextBox> ZIP_CODE = declare("Zip Code", TextBox.class, Waiters.AJAX);
			...
			public static final AssetDescriptor<Button> VALIDATE_ADDRESS_BTN =
					declare("Validate Address", Button.class, Waiters.AJAX, false, By.id("policyDataGatherForm:validateHOMailingAddressButtonUS"));
	...
	public static final class UnderlyingRisksPropertyTab extends MetaData {
		public static final AssetDescriptor<MultiInstanceAfterAssetList> ADDITIONAL_RESIDENCIES =
				declare("AdditionalResidencies", MultiInstanceAfterAssetList.class, AdditionalResidencies.class, By.xpath(".//table[@id='policyDataGatherForm:formGrid_PupAdditionalDwelling']"));
		public static final AssetDescriptor<MultiInstanceAfterAssetList> BUSINESS_OR_FARMING_COVERAGE =
				declare("BusinessOrFarmingCoverage", MultiInstanceAfterAssetList.class, BusinessOrFarmingCoverage.class, By
						.xpath(".//div[@id='policyDataGatherForm:componentView_PupUnderlyingFormsMVO']"));
		public static final AssetDescriptor<MultiInstanceAfterAssetList> PETS_OR_ANIMAL_INFORMATION =
				declare("PetsOrAnimalsInformation", MultiInstanceAfterAssetList.class, PetsOrAnimalsInformation.class, By
						.xpath(".//div[@id='policyDataGatherForm:componentView_AAADwellAnimalInfoComponent']"));
		public static final AssetDescriptor<MultiInstanceAfterAssetList> RECREATIONAL_EQUIPMENT_INFORMATION =
				declare("RecreationalEquipmentInformation", MultiInstanceAfterAssetList.class, RecreationalEquipmentInformation.class, By
						.xpath(".//div[@id='policyDataGatherForm:componentView_PupRecreationalEquipmentComponent']"));

		public static final class AdditionalResidencies extends MetaData {
			public static final AssetDescriptor<RadioGroup> ADD_RESIDENCE =
					declare("Add residence", RadioGroup.class, Waiters.AJAX, false, By.xpath("//table[@id='policyDataGatherForm:addOptionalQuestionFormGrid_PupAdditionalDwelling']"));
			public static final AssetDescriptor<AssetListConfirmationDialog> REMOVE_CONFIRMATION =
					declare("Remove confirmation", AssetListConfirmationDialog.class, Waiters.AJAX, false, By.id("confirmOptionalNoSelected_PupAdditionalDwelling_Dialog_container"));
			public static final AssetDescriptor<ComboBox> PREFILL_DATA_SOURCE = declare("Prefill/data source", ComboBox.class, Waiters.NONE);
			public static final AssetDescriptor<ComboBox> POLICY_TYPE = declare("Policy type", ComboBox.class, Waiters.AJAX);
			...
			public static final AssetDescriptor<ComboBox> CURRENT_CARRIER = declare("Current Carrier", ComboBox.class, Waiters.NONE);
			...
			public static final AssetDescriptor<TextBox> POLICY_TIER = declare("Policy tier", TextBox.class, Waiters.NONE);
			public static final AssetDescriptor<ComboBox> PUBLIC_PROTECTION_CLASS = declare("Public protection class", ComboBox.class, Waiters.NONE);
		...
		public static final class BusinessOrFarmingCoverage extends MetaData {
			public static final AssetDescriptor<RadioGroup> ADD_BUSINESS_OR_FARMING_COVERAGES =
					declare("Business or farming coverages on underlying home policies", RadioGroup.class, Waiters.AJAX, false, By
							.xpath("//table[@id='policyDataGatherForm:addOptionalQuestionFormGrid_AAAUnderlyingForm']"));
			public static final AssetDescriptor<AssetListConfirmationDialog> REMOVE_CONFIRMATION =
					declare("Remove confirmation", AssetListConfirmationDialog.class, Waiters.AJAX, false, By.id("confirmOptionalNoSelected_AAAUnderlyingForm_Dialog_container"));
			public static final AssetDescriptor<ComboBox> PREFILL_DATA_SOURCE = declare("Prefill/data source", ComboBox.class, Waiters.AJAX);
			public static final AssetDescriptor<ComboBox> ENDORSEMENT = declare("Endorsement", ComboBox.class, Waiters.NONE);
			public static final AssetDescriptor<ComboBox> PROPERTY_POLICY_NUMBER = declare("Property policy number", ComboBox.class, Waiters.NONE);
		...
		public static final class PetsOrAnimalsInformation extends MetaData {
			public static final AssetDescriptor<RadioGroup> ARE_ANY_INSURED_OWNED_PETS = declare("Are any insured-owned pets or animals kept on the property", RadioGroup.class, Waiters.AJAX, false, By
					.xpath("//table[@id='policyDataGatherForm:addOptionalQuestionFormGrid_AAADwellAnimalInfoComponent']"));
			public static final AssetDescriptor<AssetListConfirmationDialog> REMOVE_CONFIRMATION =
					declare("Remove confirmation", AssetListConfirmationDialog.class, Waiters.AJAX, false, By.id("confirmOptionalNoSelected_AAADwellAnimalInfoComponent_Dialog_container"));
			public static final AssetDescriptor<ComboBox> PREFILL_DATA_SOURCE = declare("Prefill/data source", ComboBox.class, Waiters.AJAX);
			public static final AssetDescriptor<TextBox> PROPERTY_POLICY_NUMBER = declare("Property policy number", TextBox.class, Waiters.NONE);
		...
		public static final class RecreationalEquipmentInformation extends MetaData {
			public static final AssetDescriptor<RadioGroup> ADD_RECREATIONAL_EQUIPMENT = declare("Add recreational equipment", RadioGroup.class, Waiters.AJAX, false, By
					.xpath("//table[@id='policyDataGatherForm:addOptionalQuestionFormGrid_PupRecreationalEquipmentComponent']"));
			public static final AssetDescriptor<AssetListConfirmationDialog> REMOVE_CONFIRMATION =
					declare("Remove confirmation", AssetListConfirmationDialog.class, Waiters.AJAX, false, By.id("confirmOptionalNoSelected_PupRecreationalEquipmentComponent_Dialog_container"));
			public static final AssetDescriptor<ComboBox> PROPERTY_POLICY_NUMBER = declare("Property policy number", ComboBox.class, Waiters.NONE);
	...
	public static final class UnderlyingRisksAutoTab extends MetaData {
		public static final AssetDescriptor<MultiInstanceAfterAssetList> DRIVERS =
				declare("Drivers", MultiInstanceAfterAssetList.class, Drivers.class, By.xpath(".//div[@id='policyDataGatherForm:componentView_PupDriverMVO']"));
		public static final AssetDescriptor<FillableTable> LIST_OF_AUTOMOBILES =
				declare("List of Automobiles", FillableTable.class, ListOfAutomobilesRow.class, By.xpath("//div[@id='policyDataGatherForm:dataGatherView_ListPupAutomobile']/div/table"));
		public static final AssetDescriptor<MultiInstanceAfterAssetList> AUTOMOBILES =
				declare("Automobiles", MultiInstanceAfterAssetList.class, Automobiles.class, By.xpath(".//div[@id='policyDataGatherForm:componentView_PupAutomobileMVO']"));
		public static final AssetDescriptor<MultiInstanceAfterAssetList> MOTORCYCLES =
				declare("Motorcycles", MultiInstanceAfterAssetList.class, Motorcycles.class, By.xpath(".//div[@id='policyDataGatherForm:componentView_PupMotorcycle']"));
		public static final AssetDescriptor<MultiInstanceAfterAssetList> MOTOR_HOMES =
				declare("MotorHomes", MultiInstanceAfterAssetList.class, MotorHomes.class, By.xpath(".//div[@id='policyDataGatherForm:componentView_PupMotorhome']"));

		public static final class Drivers extends MetaData {
			public static final AssetDescriptor<RadioGroup> ADD_DRIVERS =
					declare("Add drivers", RadioGroup.class, Waiters.AJAX, false, By.xpath("//table[@id='policyDataGatherForm:addOptionalQuestionFormGrid_Driver']"));
			public static final AssetDescriptor<AssetListConfirmationDialog> REMOVE_CONFIRMATION =
					declare("Remove confirmation", AssetListConfirmationDialog.class, Waiters.AJAX, false, By.id("confirmOptionalNoSelected_Driver_Dialog_container"));
			public static final AssetDescriptor<ComboBox> PREFILL_DATA_SOURCE = declare("Prefill/data source", ComboBox.class, Waiters.NONE);
			...
			public static final AssetDescriptor<ComboBox> GENDER = declare("Gender", ComboBox.class, Waiters.NONE);
			public static final AssetDescriptor<ComboBox> OCCUPATION = declare("Occupation", ComboBox.class, Waiters.NONE);
			public static final AssetDescriptor<TextBox> PHONE_NUMBER = declare("Phone Number", TextBox.class, Waiters.NONE);
			public static final AssetDescriptor<TextBox> EMAIL = declare("Email", TextBox.class, Waiters.NONE);
			public static final AssetDescriptor<TextBox> AGE_FIRST_LICENSED = declare("Age First Licensed", TextBox.class, Waiters.AJAX);
			public static final AssetDescriptor<TextBox> TOTAL_YEARS_OF_DRIVING_EXPERIENCE = declare("Total Years of Driving Experience", TextBox.class, Waiters.NONE);
			public static final AssetDescriptor<TextBox> LICENSE_NUMBER = declare("License Number", TextBox.class, Waiters.NONE);
		...
		public static final class Automobiles extends MetaData {
			public static final AssetDescriptor<RadioGroup> ADD_AUTOMOBILE =
					declare("Add automobile", RadioGroup.class, Waiters.AJAX, false, By.xpath("//table[@id='policyDataGatherForm:addOptionalQuestionFormGrid_PupAutomobile']"));
			public static final AssetDescriptor<Button> ADD = declare("Add", Button.class, Waiters.AJAX, true, By.xpath(".//input[@value='Add']"));
			public static final AssetDescriptor<AssetListConfirmationDialog> REMOVE_CONFIRMATION =
					declare("Remove confirmation", AssetListConfirmationDialog.class, Waiters.AJAX, false, By.id("confirmOptionalNoSelected_PupAutomobile_Dialog_container"));
			public static final AssetDescriptor<ComboBox> PREFILL_DATA_SOURCE = declare("Prefill/data source", ComboBox.class, Waiters.NONE);
		...
		public static final class Motorcycles extends MetaData {
			public static final AssetDescriptor<RadioGroup> ADD_MOTORCYCLE =
					declare("Add motorcycle", RadioGroup.class, Waiters.AJAX, false, By.xpath("//table[@id='policyDataGatherForm:addOptionalQuestionFormGrid_PupMotorcycle']"));
			public static final AssetDescriptor<AssetListConfirmationDialog> REMOVE_CONFIRMATION =
					declare("Remove confirmation", AssetListConfirmationDialog.class, Waiters.AJAX, false, By.id("confirmOptionalNoSelected_PupMotorcycle_Dialog_container"));
			public static final AssetDescriptor<ComboBox> PREFILL_DATA_SOURCE = declare("Prefill/data source", ComboBox.class, Waiters.NONE);
			public static final AssetDescriptor<RadioGroup> GUEST_PASSENGER_LIABILITY_COVERAGE = declare("Guest Passenger Liability Coverage", RadioGroup.class, Waiters.NONE);
			public static final AssetDescriptor<TextBox> VIN = declare("VIN", TextBox.class, Waiters.NONE);
		...
		public static final class MotorHomes extends MetaData {
			public static final AssetDescriptor<RadioGroup> ADD_MOTORE_HOME =
					declare("Add motor home", RadioGroup.class, Waiters.AJAX, false, By.xpath("//table[@id='policyDataGatherForm:addOptionalQuestionFormGrid_PupMotorhome']"));
			public static final AssetDescriptor<AssetListConfirmationDialog> REMOVE_CONFIRMATION =
					declare("Remove confirmation", AssetListConfirmationDialog.class, Waiters.AJAX, false, By.id("confirmOptionalNoSelected_PupMotorhome_Dialog_container"));
			public static final AssetDescriptor<ComboBox> PREFILL_DATA_SOURCE = declare("Prefill/data source", ComboBox.class, Waiters.AJAX);
			public static final AssetDescriptor<TextBox> VIN = declare("VIN", TextBox.class, Waiters.NONE);
			public static final AssetDescriptor<TextBox> YEAR = declare("Year", TextBox.class, Waiters.NONE);
			public static final AssetDescriptor<TextBox> MAKE = declare("Make", TextBox.class, Waiters.NONE);
	...
	public static final class UnderlyingRisksOtherVehiclesTab extends MetaData {
		public static final AssetDescriptor<MultiInstanceAfterAssetList> WATERCRAFT =
				declare("Watercraft", MultiInstanceAfterAssetList.class, Watercraft.class, By.xpath(".//div[@id='policyDataGatherForm:componentView_PupWatercraft']"));
		public static final AssetDescriptor<MultiInstanceAfterAssetList> RECREATIONAL_VEHICLE =
				declare("RecreationalVehicle", MultiInstanceAfterAssetList.class, RecreationalVehicle.class, By.xpath(".//div[@id='policyDataGatherForm:componentView_PupOffroad']"));

		public static final class Watercraft extends MetaData {
			public static final AssetDescriptor<RadioGroup> ADD_WATERCRAFT =
					declare("Add watercraft", RadioGroup.class, Waiters.AJAX, false, By.xpath("//table[@id='policyDataGatherForm:addOptionalQuestionFormGrid_PupWatercraft']"));
			public static final AssetDescriptor<AssetListConfirmationDialog> REMOVE_CONFIRMATION =
					declare("Remove confirmation", AssetListConfirmationDialog.class, Waiters.AJAX, false, By.id("confirmOptionalNoSelected_PupWatercraft_Dialog_container"));
			public static final AssetDescriptor<ComboBox> PREFILL_DATA_SOURCE = declare("Prefill/data source", ComboBox.class, Waiters.NONE);
			public static final AssetDescriptor<ComboBox> TYPE = declare("Type", ComboBox.class, Waiters.AJAX);
			public static final AssetDescriptor<TextBox> HIN = declare("HIN", TextBox.class, Waiters.NONE);
			public static final AssetDescriptor<TextBox> YEAR = declare("Year", TextBox.class, Waiters.NONE);
			public static final AssetDescriptor<TextBox> MAKE = declare("Make", TextBox.class, Waiters.NONE);
			public static final AssetDescriptor<TextBox> MODEL = declare("Model", TextBox.class, Waiters.NONE);
		...
		public static final class RecreationalVehicle extends MetaData {
			public static final AssetDescriptor<RadioGroup> ADD_RECREATIONAL_VEHICLE =
					declare("Add recreational vehicle (off-road)", RadioGroup.class, Waiters.AJAX, false, By.xpath("//table[@id='policyDataGatherForm:addOptionalQuestionFormGrid_PupOffroad']"));
			public static final AssetDescriptor<AssetListConfirmationDialog> REMOVE_CONFIRMATION =
					declare("Remove confirmation", AssetListConfirmationDialog.class, Waiters.AJAX, false, By.id("confirmOptionalNoSelected_PupOffroad_Dialog_container"));
			public static final AssetDescriptor<ComboBox> TYPE = declare("Type", ComboBox.class, Waiters.AJAX);
			public static final AssetDescriptor<RadioGroup> EXCLUDED = declare("Excluded", RadioGroup.class, Waiters.AJAX);
			public static final AssetDescriptor<TextBox> REASON_FOR_EXCLUSION = declare("Reason for exclusion", TextBox.class, Waiters.NONE);
			public static final AssetDescriptor<TextBox> VIN = declare("VIN", TextBox.class, Waiters.NONE);
	...
	public static final class UnderlyingRisksAllResidentsTab extends MetaData {
		...
		public static final AssetDescriptor<Button> CONFIRM_NO_RESIDENTS =
				declare("Confirm no residents", Button.class, Waiters.AJAX, false, By.id("confirmOptionalNoSelected_AAAResidents_Dialog_form:buttonYes"));
		public static final AssetDescriptor<TextBox> FIRST_NAME = declare("First name", TextBox.class, Waiters.NONE);
		public static final AssetDescriptor<TextBox> MIDDLE_NAME = declare("Middle name", TextBox.class, Waiters.NONE);
		public static final AssetDescriptor<TextBox> LAST_NAME = declare("Last name", TextBox.class, Waiters.NONE);
		public static final AssetDescriptor<TextBox> DATE_OF_BIRTH = declare("Date of birth", TextBox.class, Waiters.NONE);
		public static final AssetDescriptor<ComboBox> OCCUPATION = declare("Occupation", ComboBox.class, Waiters.NONE);
		public static final AssetDescriptor<TextBox> LICENSE_NUMBER = declare("License Number", TextBox.class, Waiters.NONE);
	}

	public static final class ClaimsTab extends MetaData {
		public static final AssetDescriptor<MultiInstanceAfterAssetList> AUTO_VIOLATIONS_CLAIMS = declare("AutoViolationsClaims", MultiInstanceAfterAssetList.class, AutoViolationsClaims.class, By
		...
		public static final AssetDescriptor<MultiInstanceAfterAssetList> PROPERTY_CLAIMS =
				declare("PropertyClaims", MultiInstanceAfterAssetList.class, PropertyClaims.class, By.xpath(".//div[@id='policyDataGatherForm:componentView_AAAHOLossInfo']"));

		public static final class AutoViolationsClaims extends MetaData {
			public static final AssetDescriptor<RadioGroup> ADD_AUTO_VIOLATION_CLAIM =
					declare("Add auto violations/claims", RadioGroup.class, Waiters.AJAX, false, By.xpath("//table[@id='policyDataGatherForm:addOptionalQuestionFormGrid_PupDrivingRecord']"));
			public static final AssetDescriptor<AssetListConfirmationDialog> REMOVE_CONFIRMATION =
					declare("Remove confirmation", AssetListConfirmationDialog.class, Waiters.AJAX, false, By.id("confirmOptionalNoSelected_PupDrivingRecord_Dialog_container"));
			...
			public static final AssetDescriptor<Button> ADD_AUTO_VIOLATION_CLAIM_INFORMATION =
					declare("Add Violation/Claim Information", Button.class, Waiters.AJAX, true, By.xpath(".//input[@value='Add Violation/Claim Information']"));
		}

		public static final class PropertyClaims extends MetaData {
			public static final AssetDescriptor<RadioGroup> ADD_LIABILITY_RELATED_PROPERTY_CLAIMS =
					declare("Add liability related property claims", RadioGroup.class, Waiters.AJAX, false, By.xpath("//table[@id='policyDataGatherForm:addOptionalQuestionFormGrid_AAAHOLossInfo']"));
			public static final AssetDescriptor<AssetListConfirmationDialog> REMOVE_CONFIRMATION =
					declare("Remove confirmation", AssetListConfirmationDialog.class, Waiters.AJAX, false, By.id("confirmOptionalNoSelected_AAAHOLossInfo_Dialog_container"));
			public static final AssetDescriptor<ComboBox> SOURCE = declare("Source", ComboBox.class, Waiters.NONE);
			public static final AssetDescriptor<ComboBox> PREFILL_DATA_SOURCE = declare("Prefill/data source", ComboBox.class, Waiters.NONE);
			public static final AssetDescriptor<TextBox> PROPERTY_POLICY_NUMBER = declare("Property Policy Number", TextBox.class, Waiters.NONE);
			public static final AssetDescriptor<TextBox> DATE_OF_LOSS = declare("Date of Loss", TextBox.class, Waiters.AJAX);
			public static final AssetDescriptor<ComboBox> CAUSE_OF_LOSS = declare("Cause of loss", ComboBox.class, Waiters.NONE);
			public static final AssetDescriptor<TextBox> AMOUNT_OF_LOSS = declare("Amount of loss", TextBox.class, Waiters.NONE);
			public static final AssetDescriptor<ComboBox> CLAIM_CARRIER = declare("Claim carrier", ComboBox.class, Waiters.NONE);
			public static final AssetDescriptor<ComboBox> CLAIM_STATUS = declare("Claim status", ComboBox.class, Waiters.NONE);
			public static final AssetDescriptor<RadioGroup> AAA_CLAIM = declare("AAA Claim", RadioGroup.class, Waiters.NONE);
	...
	public static final class EndorsementsTab extends MetaData {
		...
		public static final AssetDescriptor<PupEndorsementsMultiAssetList> F1752C =
				declare("F1752C", PupEndorsementsMultiAssetList.class, EndorsementF1752C.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<PupEndorsementsMultiAssetList> F1755C =
				declare("F1755C", PupEndorsementsMultiAssetList.class, EndorsementF1755C.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<PupEndorsementsMultiAssetList> F1757C =
				declare("F1757C", PupEndorsementsMultiAssetList.class, EndorsementF1757C.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<PupEndorsementsMultiAssetList> F1758C =
				declare("F1758C", PupEndorsementsMultiAssetList.class, EndorsementF1758C.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<PupEndorsementsMultiAssetList> F1759C =
				declare("F1759C", PupEndorsementsMultiAssetList.class, EndorsementF1759C.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<PupEndorsementsMultiAssetList> PS_09_22 =
				declare("PS 09 22", PupEndorsementsMultiAssetList.class, EndorsementPS0922.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		...
		public static final AssetDescriptor<PupEndorsementsMultiAssetList> PS_98_11 =
				declare("PS 98 11", PupEndorsementsMultiAssetList.class, EndorsementPS9811.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<PupEndorsementsMultiAssetList> PS_98_13 =
				declare("PS 98 13", PupEndorsementsMultiAssetList.class, EndorsementPS9813.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<PupEndorsementsMultiAssetList> PS_98_14 =
				declare("PS 98 14", PupEndorsementsMultiAssetList.class, EndorsementPS9814.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<PupEndorsementsMultiAssetList> PS_98_15 =
				declare("PS 98 15", PupEndorsementsMultiAssetList.class, EndorsementPS9815.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<PupEndorsementsMultiAssetList> _58_1027_CA =
				declare("58 1027 CA", PupEndorsementsMultiAssetList.class, Endorsement581027CA.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		...
		public static final class EndorsementF1759C extends MetaData {
			public static final AssetDescriptor<TextBox> ANIMAL_TYPE = declare("Animal Type", TextBox.class, Waiters.NONE);
			public static final AssetDescriptor<TextBox> NAME = declare("Name", TextBox.class, Waiters.NONE);
			public static final AssetDescriptor<TextBox> AGE = declare("Age", TextBox.class, Waiters.NONE);
		}
		...
		public static final class EndorsementF1752C extends MetaData {
			...
			public static final AssetDescriptor<TextBox> LAST_NAME = declare("Last Name", TextBox.class, Waiters.NONE);
			public static final AssetDescriptor<TextBox> DATE_OF_BIRTH = declare("Date of Birth", TextBox.class, Waiters.NONE);
			public static final AssetDescriptor<TextBox> LICENCE_NUMBER = declare("License Number", TextBox.class, Waiters.NONE);
		}
	...
	public static final class PremiumAndCoveragesQuoteTab extends MetaData {
		...
		public static final AssetDescriptor<ComboBox> PERSONAL_UMBRELLA =
				declare("Personal Umbrella", ComboBox.class, Waiters.AJAX, true, By.id("policyDataGatherForm:pupCoverageDetail:0:pupTableCoverageLimitSelect"));
		...
		public static final class OverridePremiumDialog extends MetaData {
			...
			public static final AssetDescriptor<TextBox> OVERRIDE_PREMIUM_BY_FLAT_AMOUNT =
					declare("Override Premium By Flat Amount", TextBox.class, Waiters.AJAX, By.id("premiumOverrideInfoFormAAAPUPPremiumOverride:deltaPremiumAmt"));
	...
	public static final class UnderwritingAndApprovalTab extends MetaData {
		...
		public static final AssetDescriptor<RadioGroup> HAVE_ANY_APPLICANTS_HAD_A_PRIOR_INSURANCE_POLICY_CANCELLED =
		...
		public static final AssetDescriptor<RadioGroup> DOES_APPLICANT_OWN_ANY_PROPERTY_OUTSIDE_OF_THE_US =
				declare("Does applicant own any property outside of the U.S. or reside outside of the U.S. for more than 180 days per year (excluding Canada)?", RadioGroup.class, Waiters.AJAX);
		...
		public static final AssetDescriptor<RadioGroup> IS_ANY_BUSINESS_HOME_DAY_CARE_OR_FARMING_ACTIVITY_CONDUCTED_ON_THE_PREMISES =
				declare("Is any business, home day care or farming activity conducted on the premises for which an endorsement is not already attached to the policy?", RadioGroup.class, Waiters.AJAX);
		public static final AssetDescriptor<RadioGroup> HAVE_ANY_OF_THE_APPLICANT_S_CURRENT_PETS_INJURED_ANOTHER_CREATURE_OR_PERSON =
		...
		public static final AssetDescriptor<RadioGroup> ARE_THERE_ANY_OWNED_LEASED_WATERCRAFT_USED_FOR_ANYTHING_OTHER_THAN_PERSONAL_PLEASURE_USE =
				declare("Are there any owned, leased or rented watercraft, personal watercraft, recreational vehicles, motorcycles or automobiles used for anything other than personal/pleasure use?", RadioGroup.class, Waiters.AJAX);
		public static final AssetDescriptor<RadioGroup> ARE_THERE_ANY_OWNED_LEASED_WATERCRAFT_WITHOUT_LIABILITY_COVERAGE =
				declare("Are there any owned, leased or rented watercraft, recreational vehicles, motorcycles or automobiles without liability coverage?", RadioGroup.class, Waiters.AJAX);
		public static final AssetDescriptor<RadioGroup> DO_ANY_APPLICANTS_USE_THEIR_PERSONAL_VEHICLES_FOR_WHOLESALE =
				declare("Do any applicants or drivers use their personal vehicles for wholesale or retail delivery of cargo or persons?", RadioGroup.class, Waiters.AJAX);
		public static final AssetDescriptor<RadioGroup> DO_ANY_APPLICANTS_OPERATE_A_COMMERCIAL_VEHICLE =
				declare("Do any applicants or drivers operate a commercial vehicle or a vehicle furnished by an employer?", RadioGroup.class, Waiters.AJAX);
		public static final AssetDescriptor<RadioGroup> DO_EMPLOYEES_OF_ANY_RESIDENT_RESIDE_IN_THE_DWELLING =
				declare("Do employees of any resident or applicant reside in the dwelling?", RadioGroup.class, Waiters.AJAX);
		public static final AssetDescriptor<RadioGroup> ANY_RESIDENT_SELF_EMPLOYED_OR_APPOINTED_PUBLIC_OFFICES =
				declare("Any resident self-employed, public lecturer, broadcaster, telecaster, newspaper reporter, editor, publisher, professional actor or entertainer, author, professional athlete or similar, or holder of any elected or appointed public offices?", RadioGroup.class, Waiters.AJAX);
		public static final AssetDescriptor<TextBox> TOTAL_NUMBER_OF_PART_TIME_AND_FULL_TIME_RESIDENT_EMPLOYEES =
				declare("Total number of part time and full time resident employees", TextBox.class, Waiters.AJAX);
		public static final AssetDescriptor<RadioGroup> ARE_ANY_APPLICANTS_OR_INSUREDS_A_CELEBRITY_OR_A_PUBLIC_FIGURE =
				declare("Are any applicants or insureds a celebrity or a public figure?", RadioGroup.class, Waiters.AJAX);
		public static final AssetDescriptor<RadioGroup> APPLICANTS_WHO_HAVE_BEEN_CANCELLED =
				declare("Applicant(s), who have been cancelled, refused insurance or non-renewed in the past 3 years are ineligible if based on any of the following reasons: Fraud or Material Misrepresentation, Substantial Increase in Hazard, or Claims.", RadioGroup.class, Waiters.AJAX);
		public static final AssetDescriptor<RadioGroup> IS_ANY_BUSINESS_OR_FARMING_ACTIVITY_CONDUCTED_ON_THE_PREMISES =
				declare("Is any business or farming activity conducted on the premises?", RadioGroup.class, Waiters.AJAX);
		public static final AssetDescriptor<RadioGroup> IS_ANY_BUSINESS__ADULT_DAY_CARE_OR_FARMING_ACTIVITY_CONDUCTED_ON_THE_PREMISES =
				declare("Is any business, adult day care, pet day care or farming activity conducted on the premises?", RadioGroup.class, Waiters.AJAX);
		public static final AssetDescriptor<TextBox> REMARKS = declare("Remarks", TextBox.class, Waiters.AJAX);

		public static final AssetDescriptor<TextBox> REMARK_CANCELLED_POLICY =
				declare("Remark Cancelled Policy", TextBox.class, Waiters.AJAX, false, By.xpath("//textarea[@id='policyDataGatherForm:underwritingQuestion_UWQuestionPolicyCancelled_remarks']"));
		public static final AssetDescriptor<TextBox> REMARK_CANCELLED_POLICY_EXTN = declare("Remark Cancelled Policy Extn", TextBox.class, Waiters.AJAX, false, By
				.xpath("//textarea[@id='policyDataGatherForm:underwritingQuestion_UWQuestionPolicyCancelledExtn_remarks']"));
		public static final AssetDescriptor<TextBox> REMARK_PROPERTY_OUTSUDE_US =
				declare("Remark Property Outside US", TextBox.class, Waiters.AJAX, false, By.xpath("//textarea[@id='policyDataGatherForm:underwritingQuestion_UWQuestionForeignProperty_remarks']"));
		public static final AssetDescriptor<TextBox> REMARK_NOT_PLEASURE_VEHICLE = declare("Remark Vehicles not for personal/pleasure use", TextBox.class, Waiters.AJAX, false, By
				.xpath("//textarea[@id='policyDataGatherForm:underwritingQuestion_UWQuestionVehicleForUnauthorizedUse_remarks']"));
		public static final AssetDescriptor<TextBox> REMARK_COMMERCIAL_VEHICLE =
				declare("Remark Commercial Vehicle", TextBox.class, Waiters.AJAX, false, By.xpath("//textarea[@id='policyDataGatherForm:underwritingQuestion_UWQuestionCommercialVehicle_remarks']"));
		public static final AssetDescriptor<TextBox> REMARK_RESIDENT_EMPLOYEES =
				declare("Remark Resident Employees", TextBox.class, Waiters.AJAX, false, By.xpath("//textarea[@id='policyDataGatherForm:underwritingQuestion_UWQuestionResidentEmployees_remarks']"));
		public static final AssetDescriptor<TextBox> REMARK_CELEBRITY =
				declare("Remark Celebrity", TextBox.class, Waiters.AJAX, false, By.xpath("//textarea[@id='policyDataGatherForm:underwritingQuestion_UWQuestionCelebrityPublic_remarks']"));
	}
	...
	public static final class DocumentsTab extends MetaData {
		...
		public static final AssetDescriptor<AssetList> DOCUMENTS_FOR_PRINTING =
				declare("DocumentsAvailableForPrinting", AssetList.class, DocumentsAvailableForPrinting.class, By.xpath(".//div[@id='policyDataGatherForm:componentView_AAAHODocGenPrint']"));
		public static final AssetDescriptor<AssetList> REQUIRED_TO_BIND =
				declare("RequiredToBind", AssetList.class, RequiredToBind.class, By.xpath(".//div[@id='policyDataGatherForm:componentView_PupOptionalSupportingDocuments']"));
		public static final AssetDescriptor<AssetList> REQUIRED_TO_ISSUE =
				declare("RequiredToIssue", AssetList.class, RequiredToIssue.class, By.xpath(".//div[@id='policyDataGatherForm:componentView_PupMandatorySupportingDocuments']"));
		...
		public static final class DocumentsAvailableForPrinting extends MetaData {
			...
			public static final AssetDescriptor<RadioGroup> APPLICATION_FOR_PERSONAL_UMBRELLA_LIABILITY =
					declare("Application for Personal Umbrella Liability Insurance", RadioGroup.class, Waiters.AJAX);
			...
			public static final AssetDescriptor<RadioGroup> DESIGNATED_MOTOR_VEHICLE_ENDORSEMENT =
					declare("Designated Recreational Motor Vehicle Exclusion Endorsement", RadioGroup.class, Waiters.AJAX);
			public static final AssetDescriptor<RadioGroup> PROOF_FOR_VEHICLE_NOT_INSURED_WITH_AAA_AMIG =
					declare("Proof of underlying insurance for each vehicle/watercraft not insured with AAA/AMIG", RadioGroup.class, Waiters.NONE);
			public static final AssetDescriptor<RadioGroup> PUP_UM_UIM_DISCLOUSURE_SIGNATURE = declare("PUP UM/UIM Disclosure", RadioGroup.class, Waiters.NONE);
			...
			public static final AssetDescriptor<RadioGroup> SIGNATURE_ON_FILE_FOR_DESIGNATED_RECREATIONAL_MOTOR_VEHICLE =
					declare("Signature on file for Designated Recreational Motor Vehicle", RadioGroup.class, Waiters.AJAX);
			...
			public static final AssetDescriptor<RadioGroup> SIGNATURE_OF_INSURED_FOR_EXCESS_UNINSURED_OFFER =
					declare("Signature of insured for Excess Uninsured Motorists Offer", RadioGroup.class, Waiters.NONE);
			public static final AssetDescriptor<RadioGroup> SIGNATURE_OF_INSURED_FOR_EXCESS_UNDERINSURED_OFFER =
					declare("Signature of insured for Excess Underinsured Motorists Offer", RadioGroup.class, Waiters.NONE);
		...
		public static final class RequiredToIssue extends MetaData {
			public static final AssetDescriptor<RadioGroup> APPLICANT_STATEMENT_SIGNATURE = declare("Applicant's statement signature", RadioGroup.class, Waiters.NONE);
			public static final AssetDescriptor<RadioGroup> SIGNATURE_FOR_INDIVIDUAL_EXCLUSION_ON_FILE =
					declare("Signature of named insured for Individual exclusion on file", RadioGroup.class, Waiters.NONE);
			public static final AssetDescriptor<RadioGroup> SIGNATURE_ON_FILE_IF_AUTO_LIABILITY_IS_EXCLUDED =
					declare("Signature on file if Auto Liability is excluded", RadioGroup.class, Waiters.NONE);
			public static final AssetDescriptor<RadioGroup> SIGNATURE_FOR_AUTOMOBILE_EXCLUSION_ON_FILE =
					declare("Signature of named insured for Automobile exclusion on file", RadioGroup.class, Waiters.NONE);
			...
			public static final AssetDescriptor<RadioGroup> SIGNATURE_FOR_ALL_HAZARDS_EXCLUSION_ON_FILE =
					declare("Signature of named insured for all hazards exclusion on file", RadioGroup.class, Waiters.NONE);
			public static final AssetDescriptor<RadioGroup> SIGNATURE_FOR_ANIMAL_EXCLUSION_ON_FILE = declare("Signature of named insured for animal exclusion on file", RadioGroup.class, Waiters.NONE);
			public static final AssetDescriptor<RadioGroup> SIGNATURE_FOR_WATERCRAFT_EXCLUSION_ON_FILE =
					declare("Signature of named insured for watercraft exclusion on file", RadioGroup.class, Waiters.NONE);
			public static final AssetDescriptor<RadioGroup> SIGNATURE_FOR_MOTOR_VEHICLE_EXCLUSION_ON_FILE =
					declare("Signature of named insured for recreational motor vehicle exclusion on file", RadioGroup.class, Waiters.NONE);
			public static final AssetDescriptor<RadioGroup> SIGNATURE_OF_EXCLUDED_NAMED_DRIVER_ON_FILE = declare("Signature of excluded named driver on file", RadioGroup.class, Waiters.NONE);
			public static final AssetDescriptor<RadioGroup> PUP_UM_UIM_DISCLOSURE = declare("PUP UM/UIM Disclosure", RadioGroup.class, Waiters.NONE);
	...
	public static final class NonPremiumBearingEndorsementActionTab extends MetaData {
		...
		public static final AssetDescriptor<RadioGroup> WILL_THIS_MORTGAGEE_COMPANY_BE_PAYING_THE_POLICY_PREMIUM =
				declare("Will this Mortgagee Company be Paying the Policy Premium?", RadioGroup.class);
	}
	...
	public static final class ChangeBrokerActionTab extends MetaData {
		...
		public static final class ChangeBrokerMetaData extends MetaData {
			...
			public static final AssetDescriptor<Button> BUTTON_OPEN_POPUP =
					declare(AbstractDialog.DEFAULT_POPUP_OPENER_NAME, Button.class, Waiters.DEFAULT, false, By.id("policyDataGatherForm:changeBrokerLink_BrokerChangeAction"));
		}
	}
	...
	public static final class GenerateOnDemandDocumentActionTab extends MetaData {
		public static final AssetDescriptor<FillableDocumentsTable> ON_DEMAND_DOCUMENTS =
				declare("OnDemandDocuments", FillableDocumentsTable.class, DocumentsRow.class, By.xpath("(//div[@id='policyDataGatherForm:componentView_AAAHODocGen']//table)[1]"));
		public static final AssetDescriptor<RadioGroup> DELIVERY_METHOD =
				declare("Delivery Method", RadioGroup.class, Waiters.AJAX, By.xpath("//span[@id='policyDataGatherForm:delveryMethodSectionPanel']/table"));
