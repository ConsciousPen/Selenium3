...
public class PurchaseMetaData {
	...
	public static final class PurchaseTab extends MetaData {
		...
		public static final AssetDescriptor<TextBox> PAYMENT_METHOD_CASH = declare("Cash", TextBox.class, Waiters.AJAX, false, By.xpath(".//input[contains(@id, 'purchaseForm:') and contains(@id, '0:paymentMethod_')]"));
		public static final AssetDescriptor<TextBox> PAYMENT_METHOD_CHECK = declare("Check", TextBox.class, Waiters.AJAX, false, By.xpath(".//input[contains(@id, 'purchaseForm:') and contains(@id, '1:paymentMethod_')]"));
