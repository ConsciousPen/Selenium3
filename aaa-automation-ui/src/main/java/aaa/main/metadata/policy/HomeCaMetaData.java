...
public final class HomeCaMetaData {
	...
	public static final class GeneralTab extends MetaData {
		...
		public static final AssetDescriptor<AssetList> CURRENT_CARRIER = declare("CurrentCarrier", AssetList.class, CurrentCarrier.class, By.xpath(".//div[@id='policyDataGatherForm:componentView_AAAHOPolicyPriorCarrier']"));
	...
	public static final class ApplicantTab extends MetaData {
		...
		public static final class DwellingAddress extends MetaData {
			...
			public static final AssetDescriptor<AddressValidationDialog> VALIDATE_ADDRESS_DIALOG = declare("Validate Address Dialog", AddressValidationDialog.class, DialogsMetaData.AddressValidationMetaData.class, By.id(".//*[@id='addressValidationPopupAAAHODwellAddressValidationComp_container']"));
		}
		...
		public static final class PreviousDwellingAddress extends MetaData {
			...
			public static final AssetDescriptor<AddressValidationDialog> VALIDATE_ADDRESS = declare("Validate Address", AddressValidationDialog.class, DialogsMetaData.AddressValidationMetaData.class, By.id("addressValidationPopupAAAHOPrevAddressValidationComp_container"));
		}
		...
		public static final class NamedInsuredInformation extends MetaData {
			...
			public static final AssetDescriptor<TextBox> PREFERRED_PHONE = declare("Preferred Phone", TextBox.class, Waiters.AJAX, By.id("policyDataGatherForm:sedit_AAAHOCommunicationInfo_preferredContact_label"));
	...
	public static final class ReportsTab extends MetaData {
		/*
		 * public static final AssetDescriptor<RadioGroup> CUSTOMER_AGREEMENT = declare(
	...
	public static final class PropertyInfoTab extends MetaData {
		...
		public static final class AdditionalAddress extends MetaData {
			public static final AssetDescriptor<RadioGroup> ARE_THERE_ANY_ADDITIONAL_ADDRESSES = declare("Are there any additional addresses?", RadioGroup.class, Waiters.AJAX, false, By.xpath("//table[@id='policyDataGatherForm:addOptionalQuestion_AAAHOAdditionalAddress']"));
			public static final AssetDescriptor<AssetListConfirmationDialog> REMOVE_CONFIRMATION = declare("Remove confirmation", AssetListConfirmationDialog.class, Waiters.AJAX, false, By.id("confirmOptionalNoSelected_AAAHOAdditionalAddress_Dialog_container"));
			public static final AssetDescriptor<TextBox> ZIP_CODE = declare("Zip code", TextBox.class, Waiters.AJAX);
			public static final AssetDescriptor<TextBox> STREET_ADDRESS_1 = declare("Street address 1", TextBox.class, Waiters.AJAX);
			public static final AssetDescriptor<TextBox> STREET_ADDRESS_2 = declare("Street address 2", TextBox.class, Waiters.AJAX);
			public static final AssetDescriptor<TextBox> CITY = declare("City", TextBox.class, Waiters.AJAX);
			...
			public static final AssetDescriptor<AddressValidationDialog> VALIDATE_ADDRESS = declare("Validate Address", AddressValidationDialog.class, DialogsMetaData.AddressValidationMetaData.class, By.id("addressValidationFormAAAHOAdditionalDwelAddressValidation"));
		...
		public static final class CeaInformation extends MetaData {
			...
			public static final AssetDescriptor<RadioGroup> IS_THE_DWELLING_ANCHORED = declare("Is the dwelling anchored to foundation using approved anchor bolts in accordance with California building code?", RadioGroup.class, Waiters.AJAX);
			public static final AssetDescriptor<RadioGroup> IS_THE_WATER_HEATER_SECURED_FOR_EARTHQUAKE = declare("Is the water heater secured to the building frame in accordance with guidelines for earthquake bracing of residential water heaters?", RadioGroup.class, Waiters.AJAX);
			...
			public static final AssetDescriptor<RadioGroup> ARE_CRIPPLE_WALLS_BRACED_WITH_PLYWODD = declare("Are cripple walls braced with plywood or its equivalent and installed in accordance with California building code?", RadioGroup.class, Waiters.AJAX);
			public static final AssetDescriptor<RadioGroup> DOES_DWELLING_HAVE_POST_AND_PIER_FOUNDATION = declare("Does dwelling have post-and-pier or post-and-beam foundation?", RadioGroup.class, Waiters.AJAX);
			public static final AssetDescriptor<RadioGroup> IS_DWELLING_HAD_BEEN_MODIFIED_ACCORDING_BUILDING_CODE = declare("Is dwelling with post-and-pier or post-and-beam foundation, has been modified in accordance with California building code?", RadioGroup.class, Waiters.AJAX);
		}
		...
		public static final class HomeRenovation extends MetaData {
			...
			public static final AssetDescriptor<ComboBox> PLUMBING_MONTH_OF_COMPLECTION = declare("Plumbing Month of completion", ComboBox.class, Waiters.AJAX, false, By.xpath("//select[@id='policyDataGatherForm:sedit_AAAHOBuildingImprovementsInfo_plumbingRenovationMonth']"));
			...
			public static final AssetDescriptor<ComboBox> ELECTRICAL_MONTH_OF_COMPLECTION = declare("Electrical Month of completion", ComboBox.class, Waiters.AJAX, false, By.xpath("//select[@id='policyDataGatherForm:sedit_AAAHOBuildingImprovementsInfo_electricalRenovationMonth']"));
			public static final AssetDescriptor<TextBox> ELECTRICAL_YEAR_OF_COMPLECTION = declare("Electrical Year of completion", TextBox.class, Waiters.AJAX, false, By.xpath("//input[@id='policyDataGatherForm:sedit_AAAHOBuildingImprovementsInfo_electricalRenovationYear']"));
			...
			public static final AssetDescriptor<TextBox> HEATING_COOLING_PERCENT_COMPLETE = declare("Heating/cooling % complete", TextBox.class, Waiters.AJAX, false, By.xpath("//input[@id='policyDataGatherForm:sedit_AAAHOBuildingImprovementsInfo_heatingOrCoolingPercentComplete']"));
			public static final AssetDescriptor<ComboBox> HEATING_COOLING_MONTH_OF_COMPLECTION = declare("Heating/cooling Month of completion", ComboBox.class, Waiters.AJAX, false, By.xpath("//select[@id='policyDataGatherForm:sedit_AAAHOBuildingImprovementsInfo_heatingOrCoolingRenovationMonth']"));
			public static final AssetDescriptor<TextBox> HEATING_COOLING_YEAR_OF_COMPLECTION = declare("Heating/cooling Year of completion", TextBox.class, Waiters.AJAX, false, By.xpath("//input[@id='policyDataGatherForm:sedit_AAAHOBuildingImprovementsInfo_heatingOrCoolingRenovationYear']"));
		...
		public static final class PetsOrAnimals extends MetaData {
			public static final AssetDescriptor<RadioGroup> ARE_ANY_PETS_OR_ANIMALS_KEPT_ON_THE_PROPERTY = declare("Are any pets or animals kept on the property?", RadioGroup.class, Waiters.AJAX);
		...
		public static final class ClaimHistory extends MetaData {
			public static final AssetDescriptor<RadioGroup> ADD_A_CLAIM = declare("Add a claim", RadioGroup.class, Waiters.AJAX, false, By.xpath("//table[@id='policyDataGatherForm:addOptionalQuestionFormGrid_AAAHOLossInfo']"));
	...
	public static final class EndorsementTab extends MetaData {
		public static final AssetDescriptor<TextBox> OPTIONAL_ENDORSEMENTS_FILTER = declare("Optional Endorsements Filter", TextBox.class, Waiters.NONE, false, By.id("policyDataGatherForm:filterCriteria_AAAHoPolicyEndorsementFormManager"));
		public static final AssetDescriptor<Button> BTN_FILTER = declare("Filter", Button.class, Waiters.AJAX, false, By.id("policyDataGatherForm:filterFormsButton_AAAHoPolicyEndorsementFormManager"));
		public static final AssetDescriptor<Button> BTN_VIEW_ALL = declare("View All", Button.class, Waiters.AJAX, false, By.id("policyDataGatherForm:viewAllButton_AAAHoPolicyEndorsementFormManager"));

		//		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> DL_01_04 = declare("DL 01 04", HomeCAEndorsementsMultiAssetList.class, EndorsementDL0104.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> DL_24_02 = declare("DL 24 02", HomeCAEndorsementsMultiAssetList.class, EndorsementDL2402.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> DL_24_11 = declare("DL 24 11", HomeCAEndorsementsMultiAssetList.class, EndorsementDL2411.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> DL_24_33 = declare("DL 24 33", HomeCAEndorsementsMultiAssetList.class, EndorsementDL2433.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> DL_24_82 = declare("DL 24 82", HomeCAEndorsementsMultiAssetList.class, EndorsementDL2482.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> DP_04_18 = declare("DP 04 18", HomeCAEndorsementsMultiAssetList.class, EndorsementDP0418.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> DP_04_22 = declare("DP 04 22", HomeCAEndorsementsMultiAssetList.class, EndorsementDP0422.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> DP_04_71 = declare("DP 04 71", HomeCAEndorsementsMultiAssetList.class, EndorsementDP0471.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> DP_04_73 = declare("DP 04 73", HomeCAEndorsementsMultiAssetList.class, EndorsementDP0473.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> DP_04_75 = declare("DP 04 75", HomeCAEndorsementsMultiAssetList.class, EndorsementDP0475.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> DP_04_95 = declare("DP 04 95", HomeCAEndorsementsMultiAssetList.class, EndorsementDP0495.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> DW_04_20 = declare("DW 04 20", HomeCAEndorsementsMultiAssetList.class, EndorsementDW0420.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> DW_04_21 = declare("DW 04 21", HomeCAEndorsementsMultiAssetList.class, EndorsementDW0421.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> DW_04_41 = declare("DW 04 41", HomeCAEndorsementsMultiAssetList.class, EndorsementDW0441.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> DW_04_63 = declare("DW 04 63", HomeCAEndorsementsMultiAssetList.class, EndorsementDW0463.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> DW_09_25 = declare("DW 09 25", HomeCAEndorsementsMultiAssetList.class, EndorsementDW0925.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> F1759C = declare("F1759C", HomeCAEndorsementsMultiAssetList.class, EndorsementF1759C.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> HARI = declare("HARI", HomeCAEndorsementsMultiAssetList.class, EndorsementHARI.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> HO_01_04 = declare("HO 01 04", HomeCAEndorsementsMultiAssetList.class, EndorsementHO0104.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> HO_04_10 = declare("HO 04 10", HomeCAEndorsementsMultiAssetList.class, EndorsementHO0410.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> HO_04_55 = declare("HO 04 55", HomeCAEndorsementsMultiAssetList.class, EndorsementHO0455.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> HO_04_96 = declare("HO 04 96", HomeCAEndorsementsMultiAssetList.class, EndorsementHO0496.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> HO_09_15 = declare("HO 09 15", HomeCAEndorsementsMultiAssetList.class, EndorsementHO0915.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> HO_1004 = declare("HO-1004", HomeCAEndorsementsMultiAssetList.class, EndorsementHO1004.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> HO_164 = declare("HO-164", HomeCAEndorsementsMultiAssetList.class, EndorsementHO164.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> HO_164C = declare("HO-164C", HomeCAEndorsementsMultiAssetList.class, EndorsementHO164C.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> HO_177 = declare("HO-177", HomeCAEndorsementsMultiAssetList.class, EndorsementHO177.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> HO_17_31 = declare("HO 17 31", HomeCAEndorsementsMultiAssetList.class, EndorsementHO1731.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> HO_17_32 = declare("HO 17 32", HomeCAEndorsementsMultiAssetList.class, EndorsementHO1732.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> HO_17_33 = declare("HO 17 33", HomeCAEndorsementsMultiAssetList.class, EndorsementHO1733.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> HO_210 = declare("HO-210", HomeCAEndorsementsMultiAssetList.class, EndorsementHO210.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> HO_210C = declare("HO-210C", HomeCAEndorsementsMultiAssetList.class, EndorsementHO210C.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> HO_28 = declare("HO-28", HomeCAEndorsementsMultiAssetList.class, EndorsementHO28.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> HO_29 = declare("HO-29", HomeCAEndorsementsMultiAssetList.class, EndorsementHO29.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> HO_300 = declare("HO-300", HomeCAEndorsementsMultiAssetList.class, EndorsementHO300.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> HO_40 = declare("HO-40", HomeCAEndorsementsMultiAssetList.class, EndorsementHO40.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> HO_41 = declare("HO-41", HomeCAEndorsementsMultiAssetList.class, EndorsementHO41.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> HO_42 = declare("HO-42", HomeCAEndorsementsMultiAssetList.class, EndorsementHO42.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> HO_42C = declare("HO-42C", HomeCAEndorsementsMultiAssetList.class, EndorsementHO42C.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> HO_43 = declare("HO-43", HomeCAEndorsementsMultiAssetList.class, EndorsementHO43.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> HO_43C = declare("HO-43C", HomeCAEndorsementsMultiAssetList.class, EndorsementHO43C.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> HO_44 = declare("HO-44", HomeCAEndorsementsMultiAssetList.class, EndorsementHO44.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> HO_48 = declare("HO-48", HomeCAEndorsementsMultiAssetList.class, EndorsementHO48.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> HO_51 = declare("HO-51", HomeCAEndorsementsMultiAssetList.class, EndorsementHO51.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> HO_57 = declare("HO-57", HomeCAEndorsementsMultiAssetList.class, EndorsementHO57.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> HO_58 = declare("HO-58", HomeCAEndorsementsMultiAssetList.class, EndorsementHO58.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> HO_58C = declare("HO-58C", HomeCAEndorsementsMultiAssetList.class, EndorsementHO58C.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> HO_59 = declare("HO-59", HomeCAEndorsementsMultiAssetList.class, EndorsementHO59.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> HO_59C = declare("HO-59C", HomeCAEndorsementsMultiAssetList.class, EndorsementHO59C.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> HO_60 = declare("HO-60", HomeCAEndorsementsMultiAssetList.class, EndorsementHO60.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> HO_60C = declare("HO-60C", HomeCAEndorsementsMultiAssetList.class, EndorsementHO60C.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> HO_61 = declare("HO-61", HomeCAEndorsementsMultiAssetList.class, EndorsementHO61.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> HO_61C = declare("HO-61C", HomeCAEndorsementsMultiAssetList.class, EndorsementHO61C.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> HO_61_1004 = declare("61 1004", HomeCAEndorsementsMultiAssetList.class, EndorsementHO611004.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> HO_62_6501 = declare("HO 62 6501", HomeCAEndorsementsMultiAssetList.class, EndorsementHO626501.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> HO_70 = declare("HO-70", HomeCAEndorsementsMultiAssetList.class, EndorsementHO70.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> HO_71 = declare("HO-71", HomeCAEndorsementsMultiAssetList.class, EndorsementHO71.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> HO_75 = declare("HO-75", HomeCAEndorsementsMultiAssetList.class, EndorsementHO75.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> HO_76 = declare("HO-76", HomeCAEndorsementsMultiAssetList.class, EndorsementHO76.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> HO_76C = declare("HO-76C", HomeCAEndorsementsMultiAssetList.class, EndorsementHO76C.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> HO_77 = declare("HO-77", HomeCAEndorsementsMultiAssetList.class, EndorsementHO77.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> HW_00_08 = declare("HW 00 08", HomeCAEndorsementsMultiAssetList.class, EndorsementHW0008.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> HW_04_35 = declare("HW 04 35", HomeCAEndorsementsMultiAssetList.class, EndorsementHW0435.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> HW_04_61 = declare("HW 04 61", HomeCAEndorsementsMultiAssetList.class, EndorsementHW0461.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> HW_04_95 = declare("HW 04 95", HomeCAEndorsementsMultiAssetList.class, EndorsementHW0495.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> HW_05_28 = declare("HW 05 28", HomeCAEndorsementsMultiAssetList.class, EndorsementHW0528.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> HW_09_06 = declare("HW 09 06", HomeCAEndorsementsMultiAssetList.class, EndorsementHW0906.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> HW_09_34 = declare("HW 09 34", HomeCAEndorsementsMultiAssetList.class, EndorsementHW0934.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> HW_24_82 = declare("HW 24 82", HomeCAEndorsementsMultiAssetList.class, EndorsementHW2482.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> HW_28 = declare("HW-28", HomeCAEndorsementsMultiAssetList.class, EndorsementHW28.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		//		public static final AssetDescriptor<HomeCAEndorsementsMultiAssetList> HW_A6_00 = declare("HW A6 00", HomeCAEndorsementsMultiAssetList.class, EndorsementHWA600.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
		...
		public static final class EndorsementHO42C extends MetaData {
			...
			public static final AssetDescriptor<TextBox> ADD_A_COMMENT_IF_YOU_ANSWERED_YES_TO_ANY_OF_THE_ABOVE_QUESTIONS = declare("Add a comment if you answered yes to any of the above questions", TextBox.class, Waiters.AJAX);
		}
		...
		public static final class EndorsementHO71 extends MetaData {
			...
			public static final AssetDescriptor<RadioGroup> IS_THE_INSURED_SELF_EMPLOYED_A_PARTNER_IN_THE_BUSINESS = declare("Is the insured self-employed, a partner in the business, or maintain any financial control in this business?", RadioGroup.class, Waiters.AJAX);
		}
		...
		public static final class EndorsementHO43 extends MetaData {
			...
			public static final AssetDescriptor<RadioGroup> BUSSINESS_INVOLVING_HAZZARDOUS_SITUATIONS = declare("Business involving hazardous situations or materials?", RadioGroup.class, Waiters.AJAX);
			public static final AssetDescriptor<RadioGroup> BUSSINESS_INVOLVING_THE_MANUFACTORING = declare("Business involving the manufacturing or repairing of goods or products?", RadioGroup.class, Waiters.AJAX);
			public static final AssetDescriptor<RadioGroup> IS_BUSINESS_CONDUCTED = declare("Is business conducted or is there equipment stored in a detached structure?", RadioGroup.class, Waiters.AJAX);
		...
		public static final class EndorsementHO42 extends MetaData {
			...
			public static final AssetDescriptor<RadioGroup> BUSINESS_INVOLVING_HAZARDOUS_SITUATIONS_OR_MATERIALS = declare("Business involving hazardous situations or materials?", RadioGroup.class, Waiters.AJAX);
			public static final AssetDescriptor<RadioGroup> BUSINESS_INVOLVING_THE_MANUFACTURING_OR_REPAIRING_OF_GOODS_OR_PRODUCTS = declare("Business involving the manufacturing or repairing of goods or products?", RadioGroup.class, Waiters.AJAX);
			public static final AssetDescriptor<RadioGroup> IS_BUSINESS_CONDUCTED_OR_IS_THERE_EQUIPMENT_STORED = declare("Is business conducted or is there equipment stored in a detached structure?", RadioGroup.class, Waiters.AJAX);
		}
	...
	public static final class PersonalPropertyTab extends MetaData {
		public static final AssetDescriptor<PersonalPropertyMultiAssetList> BOATS = declare("Boats", PersonalPropertyMultiAssetList.class, Boats.class, By.xpath("//div[@id='policyDataGatherForm:componentView_ScheduledPropertyBoatsItem']"));
		...
		public static final AssetDescriptor<RadioGroup> SCHEDULED_PROPERTY_COVERAGE = declare("Scheduled Property Coverage", RadioGroup.class);
		public static final AssetDescriptor<TextBox> LIMIT_AMOUNT = declare("Limit Amount", TextBox.class);
		public static final AssetDescriptor<TextBox> PAYMENT_BASIS = declare("Payment Basis", TextBox.class);
		public static final AssetDescriptor<TextBox> DEDUCTIBLE_AMOUNT = declare("Deductible Amount", TextBox.class);
		public static final AssetDescriptor<TextBox> TAXES = declare("Taxes", TextBox.class);
		public static final AssetDescriptor<TextBox> FEES = declare("Fees", TextBox.class);
		public static final AssetDescriptor<TextBox> TERM_PREMIUM = declare("Term Premium", TextBox.class);
		public static final AssetDescriptor<TextBox> BILLABLE_PREMIUM = declare("Billable Premium", TextBox.class);

		public static final class JewelryTab extends MetaData {
			public static final AssetDescriptor<TextBox> JEWELRY = declare("Jewelry", TextBox.class);
			public static final AssetDescriptor<TextBox> ITEM_NUMBER = declare("Item Number", TextBox.class);
			public static final AssetDescriptor<TextBox> AMOUNT = declare("Amount", TextBox.class);
			public static final AssetDescriptor<TextBox> DESCRIPTION = declare("Description", TextBox.class);
			public static final AssetDescriptor<TextBox> OF_PICTURE = declare("# of Picture", TextBox.class);
		}

		public static final class FineArtsTab extends MetaData {
			public static final AssetDescriptor<TextBox> FINE_ARTS = declare("Fine Arts", TextBox.class);
			public static final AssetDescriptor<TextBox> ITEM_NUMBER = declare("Item Number", TextBox.class);
			public static final AssetDescriptor<TextBox> AMOUNT = declare("Amount", TextBox.class);
			public static final AssetDescriptor<TextBox> DESCRIPTION = declare("Description", TextBox.class);
			public static final AssetDescriptor<TextBox> CREATOR_AUTHOR = declare("Creator(Author)", TextBox.class);
			public static final AssetDescriptor<TextBox> TITLE = declare("Title", TextBox.class);
			public static final AssetDescriptor<TextBox> DIMENSION = declare("Dimension", TextBox.class);
			public static final AssetDescriptor<TextBox> YEAR = declare("Year", TextBox.class);
			public static final AssetDescriptor<TextBox> TECHNIQUE = declare("Technique", TextBox.class);
		}

		public static final class PortableElectronicEquipmentTab extends MetaData {
			public static final AssetDescriptor<TextBox> PORTABLEELECTRONICEQUIPMENT = declare("PortableElectronicEquipment", TextBox.class);
			public static final AssetDescriptor<TextBox> ITEM_NUMBER = declare("Item Number", TextBox.class);
			public static final AssetDescriptor<TextBox> AMOUNT = declare("Amount", TextBox.class);
			public static final AssetDescriptor<TextBox> DESCRIPTION = declare("Description", TextBox.class);
		}
		...
		public static final class SportsEquipmentTab extends MetaData {
			public static final AssetDescriptor<TextBox> SPORTSEQUIPMENT = declare("SportsEquipment", TextBox.class);
			public static final AssetDescriptor<TextBox> ITEM_NUMBER = declare("Item Number", TextBox.class);
			public static final AssetDescriptor<TextBox> AMOUNT = declare("Amount", TextBox.class);
			public static final AssetDescriptor<TextBox> DESCRIPTION = declare("Description", TextBox.class);
		}
		...
		public static final class MoneyTab extends MetaData {
			public static final AssetDescriptor<TextBox> CLASS_LIMIT = declare("Class Limit", TextBox.class);
			public static final AssetDescriptor<TextBox> ITEM_NUMBER = declare("Item Number", TextBox.class);
			public static final AssetDescriptor<TextBox> AMOUNT = declare("Amount", TextBox.class);
			public static final AssetDescriptor<TextBox> DESCRIPTION = declare("Description", TextBox.class);
		}
		...
		public static final class SecuritiesTab extends MetaData {
			public static final AssetDescriptor<TextBox> SECURITIES = declare("Securities", TextBox.class);
			public static final AssetDescriptor<TextBox> ITEM_NUMBER = declare("Item Number", TextBox.class);
			public static final AssetDescriptor<TextBox> AMOUNT = declare("Amount", TextBox.class);
			public static final AssetDescriptor<TextBox> DESCRIPTION = declare("Description", TextBox.class);
		}
		...
		public static final class FursTab extends MetaData {
			public static final AssetDescriptor<TextBox> FURS = declare("Furs", TextBox.class);
			public static final AssetDescriptor<TextBox> ITEM_NUMBER = declare("Item Number", TextBox.class);
			public static final AssetDescriptor<TextBox> AMOUNT = declare("Amount", TextBox.class);
			public static final AssetDescriptor<TextBox> DESCRIPTION = declare("Description", TextBox.class);
			public static final AssetDescriptor<TextBox> NUMBER_OF_PICTURE = declare("# of Picture", TextBox.class);
		}
		...
		public static final class SilverwareTab extends MetaData {
			public static final AssetDescriptor<TextBox> SILVERWARE = declare("Silverware", TextBox.class);
			public static final AssetDescriptor<TextBox> ITEM_NUMBER = declare("Item Number", TextBox.class);
			public static final AssetDescriptor<TextBox> AMOUNT = declare("Amount", TextBox.class);
			public static final AssetDescriptor<TextBox> DESCRIPTION = declare("Description", TextBox.class);
		}*/
	...
	public static final class PremiumsAndCoveragesQuoteTab extends MetaData {
		...
		public static final AssetDescriptor<StaticElement> COVERAGE_A = declare(HomeCaCoverages.COVERAGE_A.get(), StaticElement.class, Waiters.AJAX, false,
				By.xpath(String.format("//table[@id='policyDataGatherForm:coverageSummaryTable']//tr[td[.='%s']]//td[3]", HomeCaCoverages.COVERAGE_A.get())));
		public static final AssetDescriptor<ComboBox> COVERAGE_B = declare(HomeCaCoverages.COVERAGE_B.get(), ComboBox.class, Waiters.AJAX, false,
				By.xpath(String.format("//table[@id='policyDataGatherForm:coverageSummaryTable']//tr[td[.='%s']]//td[3]", HomeCaCoverages.COVERAGE_B.get())));
		public static final AssetDescriptor<TextBox> COVERAGE_C = declare(HomeCaCoverages.COVERAGE_C.get(), TextBox.class, Waiters.AJAX, false,
				By.xpath(String.format("//table[@id='policyDataGatherForm:coverageSummaryTable']//tr[td[.='%s']]//input", HomeCaCoverages.COVERAGE_C.get())));
		public static final AssetDescriptor<TextBox> COVERAGE_D = declare(HomeCaCoverages.COVERAGE_D.get(), TextBox.class, Waiters.AJAX, false,
				By.xpath(String.format("//table[@id='policyDataGatherForm:coverageSummaryTable']//tr[td[.='%s']]//input", HomeCaCoverages.COVERAGE_D.get())));
		public static final AssetDescriptor<ComboBox> COVERAGE_E = declare(HomeCaCoverages.COVERAGE_E.get(), ComboBox.class, Waiters.AJAX, false,
				By.xpath(String.format("//table[@id='policyDataGatherForm:coverageSummaryTable']//tr[td[.='%s']]//select", HomeCaCoverages.COVERAGE_E.get())));
		public static final AssetDescriptor<StaticElement> COVERAGE_F = declare(HomeCaCoverages.COVERAGE_F.get(), StaticElement.class, Waiters.AJAX, false,
				By.xpath(String.format("//table[@id='policyDataGatherForm:coverageSummaryTable']//tr[td[.='%s']]//td[3]", HomeCaCoverages.COVERAGE_F.get())));
		public static final AssetDescriptor<ComboBox> DEDUCTIBLE = declare(HomeCaCoverages.DEDUCTIBLE.get(), ComboBox.class, Waiters.AJAX, false,
				By.xpath(String.format("//table[@id='policyDataGatherForm:coverageSummaryTable']//tr[td[.='%s']]//select", HomeCaCoverages.DEDUCTIBLE.get())));

		/*
		 * public static final AssetDescriptor<TextBox> NAME = declare("Name",
		 ...
		 * static final AssetDescriptor<TextBox> STREET_ADDRESS_1 = declare(
		 * "Street address 1", TextBox.class, Waiters.AJAX); public static final
		 * AssetDescriptor<TextBox> STREET_ADDRESS_2 = declare("Street address 2",
		 * TextBox.class, Waiters.AJAX); public static final AttributeDescriptor
		 * CITY = declare("City", TextBox.class, Waiters.AJAX); public static
		 * final AssetDescriptor<ComboBox> STATE = declare("State", ComboBox.class,
		 * Waiters.AJAX);
		 */
		...
		public static final class CeaCoverages extends MetaData {
			public static final AssetDescriptor<StaticElement> COVERAGE_A_DWELLING_LIMIT = declare(HomeCaCeaCoverages.COVERAGE_A_DWELLING_LIMIT.get(), StaticElement.class, Waiters.AJAX, true,
	...
	public static final class UnderwritingAndApprovalTab extends MetaData {
		...
		public static final AssetDescriptor<RadioGroup> HAVE_ANY_OF_THE_APPLICANT_S_CURRENT_PETS_INJURED_CREATURE = declare("Have any of the applicant(s)’ current pets injured, intentionally or unintentionally, another creature or person?", RadioGroup.class, Waiters.AJAX);
		...
		public static final AssetDescriptor<RadioGroup> ARE_ALL_WATER_HEATERS_STRAPPED_TO_THE_WALL = declare("Are all water heaters strapped to the wall, or, if located in the garage, raised at least 18 inches from the floor?", RadioGroup.class, Waiters.AJAX);
		public static final AssetDescriptor<RadioGroup> DO_EMPLOYEES_OF_ANY_RESIDENT_OR_APPLICANT_RESIDE_IN_THE_DWELLING = declare("Do employees of any resident or applicant reside in the dwelling?", RadioGroup.class, Waiters.AJAX);
		...
		public static final AssetDescriptor<RadioGroup> IS_ANY_BUSINESS_OR_FARMING_ACTIVITY_CONDUCTED_ON_THE_PREMISES = declare("Is any business, home day care or farming activity conducted on the premises?", RadioGroup.class, Waiters.AJAX);
		...
		public static final AssetDescriptor<RadioGroup> IS_THE_DWELLING_LOCATED_WITHIN_500_FEET_OF_BAY_OR_COASTAL_WATERS = declare("Is the dwelling located within 500 feet of bay or coastal waters?", RadioGroup.class, Waiters.AJAX);
		...
		public static final AssetDescriptor<TextBox> HOW_MANY_CUSTOMERS_VISIT_THE_RESIDENCE_PREMISES_PER_WEEK = declare("How many customers visit the residence premises per week? ", TextBox.class, Waiters.AJAX);
		public static final AssetDescriptor<RadioGroup> OTHERS = declare("Others?", RadioGroup.class, Waiters.AJAX);
		public static final AssetDescriptor<RadioGroup> HAVE_ANY_APPLICANTS_HAD_A_FLAT_ROOF_RELATED_CLAIM_IN_THE_PAST_3_YEARS = declare("Have any applicants had a flat roof related claim in the past 3 years?", RadioGroup.class, Waiters.AJAX);
		public static final AssetDescriptor<TextBox> REMARKS = declare("Remarks", TextBox.class, Waiters.AJAX);

		public static final AssetDescriptor<TextBox> REMARK_PRIOR_INSURANCE = declare("Remark Prior Insurance", TextBox.class, Waiters.AJAX, false, By.xpath("//textarea[@id='policyDataGatherForm:sedit_AAAUnderwritingQuestionaireComponent_aaaPriorPolicyStatusRemark']"));
		public static final AssetDescriptor<TextBox> REMARK_FIRE_HAZARD = declare("Remark Fire Hazard", TextBox.class, Waiters.AJAX, false, By.xpath("//textarea[@id='policyDataGatherForm:sedit_AAAUnderwritingQuestionaireComponent_aaaFireSafeDistRemark']"));
		public static final AssetDescriptor<TextBox> REMARK_DWELL_SLOPE = declare("Remark Dwell Slope", TextBox.class, Waiters.AJAX, false, By.xpath("//textarea[@id='policyDataGatherForm:sedit_AAAUnderwritingQuestionaireComponent_aaaDwellSlopeRemark']"));
		public static final AssetDescriptor<TextBox> REMARK_FORECLOSURE = declare("Remark Foreclosure", TextBox.class, Waiters.AJAX, false, By.xpath("//textarea[@id='policyDataGatherForm:sedit_AAAUnderwritingQuestionaireComponent_aaaForeClosureProceedingRemark']"));
		public static final AssetDescriptor<TextBox> REMARK_RENOVATION = declare("Remark Renovation", TextBox.class, Waiters.AJAX, false, By.xpath("//textarea[@id='policyDataGatherForm:sedit_AAAUnderwritingQuestionaireComponent_aaaDwellRenovationRemark']"));
		public static final AssetDescriptor<TextBox> REMARK_RESIDENT_EMPLOYEES = declare("Remark Resident Employees", TextBox.class, Waiters.AJAX, false, By.xpath("//textarea[@id='policyDataGatherForm:sedit_AAAUnderwritingQuestionaireComponent_aaaEmployeesGradeRemark']"));
	}
	...
	public static final class DocumentsTab extends MetaData {
		...
		public static final class DocumentsForPrinting extends MetaData {
			...
			public static final AssetDescriptor<RadioGroup> APPRAISALS_RECEIPTS_FOR_SCHEDULED_PERSONAL_PROPERTY = declare("Appraisals/sales receipts for scheduled personal property items", RadioGroup.class, Waiters.NONE);
		}
		...
		public static final class DocumentsToBind extends MetaData {
			...
			public static final AssetDescriptor<RadioGroup> CERTIFICATE_CONFIRMING_NO_CONTAMINATION_CAUSED_BY_STORAGE_TANK = declare("Certificate confirming no contamination caused by inactive underground oil storage tank", RadioGroup.class, Waiters.AJAX);
			public static final AssetDescriptor<RadioGroup> PROOF_OF_PLUMBING_AND_OTHERS_RENOVATIONS = declare("Proof of plumbing, electrical, heating/cooling system and roof renovations", RadioGroup.class, Waiters.AJAX);
			public static final AssetDescriptor<RadioGroup> PROOF_OF_AN_UNDERLYING_RENTERS_INSURANCE = declare("Proof of an underlying renters insurance policy for your tenant(s)", RadioGroup.class, Waiters.AJAX);
			public static final AssetDescriptor<RadioGroup> ACTUAL_CASH_VALUE_LOSS_TO_ROOF_SURFACING = declare("Actual Cash Value Loss Settlement Windstorm Or Hail Losses To Roof Surfacing", RadioGroup.class, Waiters.NONE);
		}
		...
		public static final class DocumentsToIssue extends MetaData {
			...
			public static final AssetDescriptor<RadioGroup> CALIFORNIA_RESIDENTIAL_PROPERTY_INSURANCE_DISCLOSURE = declare("California Residential Property Insurance Disclosure", RadioGroup.class, Waiters.AJAX);
