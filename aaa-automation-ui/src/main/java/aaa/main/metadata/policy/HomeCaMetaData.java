...
public final class HomeCaMetaData {
    ...
    public static final class GeneralTab extends MetaData {
        ...
        public static final AssetDescriptor<AssetList> CURRENT_CARRIER = declare("CurrentCarrier", AssetList.class, CurrentCarrier.class,
    ...
    public static final class ApplicantTab extends MetaData {
        ...
        public static final AssetDescriptor<MultiInstanceAfterAssetList> NAMED_INSURED = declare("NamedInsured", MultiInstanceAfterAssetList.class, NamedInsured.class,
        ...
        public static final AssetDescriptor<AssetList> PREVIOUS_DWELLING_ADDRESS = declare("PreviousDwellingAddress", AssetList.class, PreviousDwellingAddress.class,
                By.xpath("//div[@id='policyDataGatherForm:componentView_AAAHOPreviousAddressComp']"));
        public static final AssetDescriptor<AssetList> MAILING_ADDRESS = declare("MailingAddress", AssetList.class, MailingAddress.class,
                By.xpath("//div[@id='policyDataGatherForm:componentView_AAAHOMailingAddressComponent']"));
        public static final AssetDescriptor<AssetList> NAMED_INSURED_INFORMATION = declare("NamedInsuredInformation", AssetList.class, NamedInsuredInformation.class,
        ...
        public static final class NamedInsured extends MetaData {
            ...
            public static final AssetDescriptor<SingleSelectSearchDialog> CUSTOMER_SEARCH = declare("CustomerSearchDialog", SingleSelectSearchDialog.class, CustomerSearch.class,
        ...
        public static final class PreviousDwellingAddress extends MetaData {
            ...
            public static final AssetDescriptor<AddressValidationDialog> VALIDATE_ADDRESS = declare("Validate Address Dialog", AddressValidationDialog.class, DialogsMetaData.AddressValidationMetaData.class,
        ...
        public static final class MailingAddress extends MetaData {
            ...
            public static final AssetDescriptor<ComboBox> COUNTRY = declare("Country", ComboBox.class, Waiters.AJAX);
            public static final AssetDescriptor<TextBox> ADDRESS_VALIDATED = declare("Address validated", TextBox.class);
            public static final AssetDescriptor<Button> VALIDATE_ADDRESS_BTN = declare("Validate Address", Button.class, Waiters.AJAX, false,
        ...
        public static final class NamedInsuredInformation extends MetaData {
            ...
            //          public static final AssetDescriptor<TextBox> PREFERRED_PHONE = declare("Preferred Phone", TextBox.class, Waiters.AJAX,
        ...
        public static final class OtherActiveAAAPolicies extends MetaData {
            public static final AssetDescriptor<RadioGroup> OTHER_ACTIVE_AAA_POLICIES = declare("Other active AAA policies", RadioGroup.class, Waiters.AJAX, false,
    ...
    public static final class ReportsTab extends MetaData {
         ...
         */
        public static final AssetDescriptor<RadioGroup> SALES_AGENT_AGREEMENT = declare("Sales Agent Agreement", RadioGroup.class, Waiters.AJAX, false,
                By.xpath("//table[@id='policyDataGatherForm:sedit_AAAHOCommonDisclosureMessageComponent_agentAgrees']"));

        public static final AssetDescriptor<FillableTable> AAA_MEMBERSHIP_REPORT = declare("AAAMembershipReport", FillableTable.class, AaaMembershipReportRow.class,
                By.xpath("//table[@id='policyDataGatherForm:membershipReports']"));
        public static final AssetDescriptor<FillableTable> FIRELINE_REPORT = declare("FirelineReport", FillableTable.class, FirelineReportRow.class,
                By.xpath("//table[@id='policyDataGatherForm:firelineReportTable']"));
        public static final AssetDescriptor<FillableTable> PUBLIC_PROTECTION_CLASS = declare("PublicProtectionClass", FillableTable.class, PublicProtectionClassRow.class,
    ...
    public static final class PropertyInfoTab extends MetaData {
        ...
        public static final AssetDescriptor<MultiInstanceAfterAssetList> ADDITIONAL_ADDRESS = declare("AdditionalAddress", MultiInstanceAfterAssetList.class, AdditionalAddress.class,
        ...
        public static final class AdditionalAddress extends MetaData {
            public static final AssetDescriptor<RadioGroup> ARE_THERE_ANY_ADDITIONAL_ADDRESSES = declare("Are there any additional addresses?", RadioGroup.class, Waiters.AJAX, false,
                    By.xpath("//table[@id='policyDataGatherForm:addOptionalQuestion_AAAHOAdditionalAddress']"));
            public static final AssetDescriptor<AssetListConfirmationDialog> REMOVE_CONFIRMATION = declare("Remove confirmation", AssetListConfirmationDialog.class, Waiters.AJAX, false,
        ...
        public static final class HomeRenovation extends MetaData {
            ...
            public static final AssetDescriptor<TextBox> PLUMBING_PERCENT_COMPLETE = declare("Plumbing % complete", TextBox.class, Waiters.AJAX, false,
            ...
            public static final AssetDescriptor<TextBox> PLUMBING_YEAR_OF_COMPLECTION = declare("Plumbing Year of completion", TextBox.class, Waiters.AJAX, false,
            ...
            public static final AssetDescriptor<TextBox> ELECTRICAL_PERCENT_COMPLETE = declare("Electrical % complete", TextBox.class, Waiters.AJAX, false,
            ...
            public static final AssetDescriptor<TextBox> ROOF_PERCENT_COMPLETE = declare("Roof % complete", TextBox.class, Waiters.AJAX, false,
                    By.xpath("//input[@id='policyDataGatherForm:sedit_AAAHOBuildingImprovementsInfo_roofPercentComplete']"));
            public static final AssetDescriptor<ComboBox> ROOFG_MONTH_OF_COMPLECTION = declare("Roof Month of completion", ComboBox.class, Waiters.AJAX, false,
                    By.xpath("//select[@id='policyDataGatherForm:sedit_AAAHOBuildingImprovementsInfo_roofRenovationMonth']"));
            public static final AssetDescriptor<TextBox> ROOF_YEAR_OF_COMPLECTION = declare("Roof Year of completion", TextBox.class, Waiters.AJAX, false,
        ...
        public static final class ClaimHistory extends MetaData {
            public static final AssetDescriptor<RadioGroup> ADD_A_CLAIM = declare("Add a claim", RadioGroup.class, Waiters.AJAX, false,
    ...
    public static final class EndorsementTab extends MetaData {
        public static final AssetDescriptor<TextBox> OPTIONAL_ENDORSEMENTS_FILTER = declare("Optional Endorsements Filter", TextBox.class, Waiters.NONE, false,
        ...
        public static final class EndorsementHO43 extends MetaData {
            ...
            public static final AssetDescriptor<RadioGroup> BUSSINESS_INVOLVING_THE_MANUFACTORING = declare("Business involving the manufacturing or repairing of goods or products?", RadioGroup.class,
                    Waiters.AJAX);
    ...
    public static final class PersonalPropertyTab extends MetaData {
        public static final AssetDescriptor<PersonalPropertyMultiAssetList> BOATS = declare("Boats", PersonalPropertyMultiAssetList.class, Boats.class,
                By.xpath("//div[@id='policyDataGatherForm:componentView_ScheduledPropertyBoatsItem']"));
        public static final AssetDescriptor<PersonalPropertyMultiAssetList> CAMERAS = declare("Cameras", PersonalPropertyMultiAssetList.class, Cameras.class,
                By.xpath("//div[@id='policyDataGatherForm:componentView_ScheduledPropertyCamerasItem']"));
        public static final AssetDescriptor<PersonalPropertyMultiAssetList> COINS = declare("Coins", PersonalPropertyMultiAssetList.class, Coins.class,
                By.xpath("//div[@id='policyDataGatherForm:componentView_ScheduledPropertyCoinsItem']"));
        public static final AssetDescriptor<PersonalPropertyMultiAssetList> FINE_ARTS = declare("Fine arts", PersonalPropertyMultiAssetList.class, FineArts.class,
                By.xpath("//div[@id='policyDataGatherForm:componentView_ScheduledPropertyFineArtsItem']"));
        public static final AssetDescriptor<PersonalPropertyMultiAssetList> FURS = declare("Furs", PersonalPropertyMultiAssetList.class, Furs.class,
                By.xpath("//div[@id='policyDataGatherForm:componentView_ScheduledPropertyFursItem']"));
        public static final AssetDescriptor<PersonalPropertyMultiAssetList> GOLF_EQUIPMENT = declare("Golf equipment", PersonalPropertyMultiAssetList.class, GolfEquipment.class,
                By.xpath("//div[@id='policyDataGatherForm:componentView_ScheduledPropertyGolfItem']"));
        public static final AssetDescriptor<PersonalPropertyMultiAssetList> JEWELRY = declare("Jewelry", PersonalPropertyMultiAssetList.class, Jewelry.class,
                By.xpath("//div[@id='policyDataGatherForm:componentView_ScheduledPropertyJewelryItem']"));
        public static final AssetDescriptor<PersonalPropertyMultiAssetList> MUSICAL_INSTRUMENTS = declare("Musical instruments", PersonalPropertyMultiAssetList.class, MusicalInstruments.class,
                By.xpath("//div[@id='policyDataGatherForm:componentView_ScheduledPropertyMusicalItem']"));
        public static final AssetDescriptor<PersonalPropertyMultiAssetList> POSTAGE_STAMPS = declare("Postage stamps", PersonalPropertyMultiAssetList.class, PostageStamps.class,
                By.xpath("//div[@id='policyDataGatherForm:componentView_ScheduledPropertyPostageItem']"));
        public static final AssetDescriptor<PersonalPropertyMultiAssetList> SILVERWARE = declare("Silverware", PersonalPropertyMultiAssetList.class, Silverware.class,
    ...
    public static final class MortgageesTab extends MetaData {
        ...
        public static final AssetDescriptor<MultiInstanceAfterAssetList> MORTGAGEE_INFORMATION = declare("MortgageeInformation", MultiInstanceAfterAssetList.class, MortgageeInformation.class,
        ...
        public static final AssetDescriptor<TextBox> LEGAL_NAMED_INSURED = declare("Legal named insured", TextBox.class, Waiters.AJAX, false,
        ...
        public static final AssetDescriptor<AssetList> LEGAL_PROPERTY_ADDRESS = declare("LegalPropetyAddress", AssetList.class, LegalPropetyAddress.class,
        ...
        public static final AssetDescriptor<MultiInstanceAfterAssetList> ADDITIONAL_INSURED = declare("AdditionalInsured", MultiInstanceAfterAssetList.class, AdditionalInsured.class,
        ...
        public static final AssetDescriptor<MultiInstanceAfterAssetList> ADDITIONAL_INTEREST = declare("AdditionalInterest", MultiInstanceAfterAssetList.class, AdditionalInterest.class,
    ...
    public static final class UnderwritingAndApprovalTab extends MetaData {
        ...
        public static final AssetDescriptor<TextBox> REMARK_PRIOR_INSURANCE = declare("Remark Prior Insurance", TextBox.class, Waiters.AJAX, false,
                By.xpath("//textarea[@id='policyDataGatherForm:sedit_AAAUnderwritingQuestionaireComponent_aaaPriorPolicyStatusRemark']"));
        public static final AssetDescriptor<TextBox> REMARK_FIRE_HAZARD = declare("Remark Fire Hazard", TextBox.class, Waiters.AJAX, false,
                By.xpath("//textarea[@id='policyDataGatherForm:sedit_AAAUnderwritingQuestionaireComponent_aaaFireSafeDistRemark']"));
        public static final AssetDescriptor<TextBox> REMARK_DWELL_SLOPE = declare("Remark Dwell Slope", TextBox.class, Waiters.AJAX, false,
                By.xpath("//textarea[@id='policyDataGatherForm:sedit_AAAUnderwritingQuestionaireComponent_aaaDwellSlopeRemark']"));
        public static final AssetDescriptor<TextBox> REMARK_FORECLOSURE = declare("Remark Foreclosure", TextBox.class, Waiters.AJAX, false,
                By.xpath("//textarea[@id='policyDataGatherForm:sedit_AAAUnderwritingQuestionaireComponent_aaaForeClosureProceedingRemark']"));
        public static final AssetDescriptor<TextBox> REMARK_RENOVATION = declare("Remark Renovation", TextBox.class, Waiters.AJAX, false,
                By.xpath("//textarea[@id='policyDataGatherForm:sedit_AAAUnderwritingQuestionaireComponent_aaaDwellRenovationRemark']"));
        public static final AssetDescriptor<TextBox> REMARK_RESIDENT_EMPLOYEES = declare("Remark Resident Employees", TextBox.class, Waiters.AJAX, false,
    ...
    public static final class DocumentsTab extends MetaData {
        public static final AssetDescriptor<AssetList> DOCUMENTS_FOR_PRINTING = declare("DocumentsForPrinting", AssetList.class, DocumentsForPrinting.class,
                By.xpath(".//div[@id='policyDataGatherForm:componentView_AAAHODocGenPrint']"));
        public static final AssetDescriptor<AssetList> DOCUMENTS_TO_BIND = declare("DocumentsToBind", AssetList.class, DocumentsToBind.class,
                By.xpath(".//div[@id='policyDataGatherForm:componentView_AAAHOBindDocuments']"));
        public static final AssetDescriptor<AssetList> DOCUMENTS_TO_ISSUE = declare("DocumentsToIssue", AssetList.class, DocumentsToIssue.class,
        ...
        public static final class DocumentsForPrinting extends MetaData {
            ...
            public static final AssetDescriptor<RadioGroup> APPRAISALS_RECEIPTS_FOR_SCHEDULED_PERSONAL_PROPERTY = declare("Appraisals/sales receipts for scheduled personal property items", RadioGroup.class,
                    Waiters.NONE);
        }
        ...
        public static final class DocumentsToBind extends MetaData {
            ...
            public static final AssetDescriptor<RadioGroup> PROOF_OF_PLUMBING_AND_OTHERS_RENOVATIONS = declare("Proof of plumbing, electrical, heating/cooling system and roof renovations", RadioGroup.class,
                    Waiters.AJAX);
