...
public final class AutoSSMetaData {
	...
	public static final class PremiumAndCoveragesTab extends MetaData {
		...
		public static final AssetDescriptor<ComboBox> UNDERINSURED_MOTORIST_CONVERSION_COVERAGE =
				declare("Underinsured Motorist Conversion Coverage", ComboBox.class, By.xpath(".//table[@id='policyDataGatherForm:policy_vehicle_detail_coverage']//span[normalize-space(.)='Underinsured Motorist Conversion Coverage']/ancestor::tr[1]//select"));
