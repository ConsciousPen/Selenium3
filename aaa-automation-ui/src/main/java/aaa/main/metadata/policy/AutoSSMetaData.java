...
public final class AutoSSMetaData {
	...
	public static final class GeneralTab extends MetaData {
		...
		public static final AssetDescriptor<MultiAssetList> OTHER_AAA_PRODUCT_OWNED =
				declare("OtherAAAProductsOwned", MultiAssetList.class, OtherAAAProductsOwned.class, By.xpath(".//div[@id='policyDataGatherForm:componentView_AAAAutoOtherPoliciesMPD']"));
		...
		public static final class OtherAAAProductsOwned extends MetaData {
			...
			public static final AssetDescriptor<AssetList> SEARCH_OTHER_AAA_PRODUCTS = declare("SearchOtherAAAProducts", AssetList.class, SearchOtherAAAProducts.class, By.xpath("//form[@id='autoOtherPolicySearchForm']"));
			...
			public static final class SearchOtherAAAProducts extends MetaData {
				...
				public static final AssetDescriptor<Button> CLOSE_BTN = declare("X", Button.class, By.xpath("//div[@id = 'autoOtherPolicySearchPopup_header_controls']/child::img"));
