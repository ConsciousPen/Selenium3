...
public final class BillingAccountMetaData {
    ...
    public static final class BillingAccountTab extends MetaData {
        ...
        public static final AttributeDescriptor BILLING_ACCOUNT_POLICIES_STATUS = declare("Biling Account Policies status", StaticElement.class,
        ...
        public static final AttributeDescriptor SELECT_INVOICING_CALENDAR = declare("Select Invoicing Calendar", AssetList.class, InvoicingCalendarComboBox.class,
    ...
    public static final class TransferPaymentActionTab extends MetaData {
        ...
        public static final class AllocationMultiSelector extends MetaData {
            ...
            public static final AttributeDescriptor BUTTON_OPEN_POPUP = declare(AbstractDialog.DEFAULT_POPUP_OPENER_NAME, Button.class, Waiters.SLEEP(30000), false,
    ...
    public static final class TransferPaymentBenefitsActionTab extends MetaData {
        public static final AttributeDescriptor BILLING_ACCOUNT = declare("Billing Account", DialogSingleSelector.class, BillingAccountSingleSelector.class, false,
    ...
    public static final class AdvancedAllocationsActionTab extends MetaData {
        public static final AttributeDescriptor TOTAL_AMOUNT = declare("Total Amount", TextBox.class);
        public static final AttributeDescriptor PRODUCT_SUB_TOTAL = declare("Total Amount", TextBox.class);
