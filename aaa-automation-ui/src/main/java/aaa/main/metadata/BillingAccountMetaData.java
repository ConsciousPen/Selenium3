...
public final class BillingAccountMetaData {
	...
	public static final class BillingAccountTab extends MetaData {
		...
		public static final AssetDescriptor<StaticElement> BILLING_ACCOUNT_POLICIES_STATUS = declare("Biling Account Policies status", StaticElement.class, By.id("billingDetailedForm:billing_policies_info_table:0:column_status")); //billingDetailedForm:billing_policies_info_table:0:statusLink
		...
		public static final AssetDescriptor<AssetList> SELECT_INVOICING_CALENDAR = declare("Select Invoicing Calendar", AssetList.class, InvoicingCalendarComboBox.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
	...
	public static final class TransferPaymentActionTab extends MetaData {
		...
		public static final class AllocationMultiSelector extends MetaData {
			...
			public static final AssetDescriptor<Button> BUTTON_OPEN_POPUP = declare(AbstractDialog.DEFAULT_POPUP_OPENER_NAME, Button.class, Waiters.SLEEP(30000), false, By.id("transferPaymentForm:searchAllocationLnkText"));
		}
	}

	public static final class TransferPaymentBenefitsActionTab extends MetaData {
		public static final AssetDescriptor<DialogSingleSelector> BILLING_ACCOUNT = declare("Billing Account", DialogSingleSelector.class, BillingAccountSingleSelector.class, false, By.id("searchBillingAccountsForm:billingAccountSearchPopup"));
		...
		public static final class BillingAccountSingleSelector extends MetaData {
			...
			public static final AssetDescriptor<Button> BUTTON_OPEN_POPUP = declare(AbstractDialog.DEFAULT_POPUP_OPENER_NAME, Button.class, Waiters.SLEEP(30000), false, By.id("paymentForm:showBillingAccountSearchPopupLnk"));
		}
	}
