...
public final class BillingAccountMetaData {
	...
	public static final class AcceptPaymentActionTab extends MetaData {
		...
		public static final AssetDescriptor<TextBox> AMOUNT_PREVIOS_TERM = declare("Previous term amount", TextBox.class, By.id("paymentForm::0:amount_"));
		public static final AssetDescriptor<TextBox> AMOUNT_RENEWAL_TERM = declare("Renewal term amount", TextBox.class, By.id("paymentForm::1:amount_"));
