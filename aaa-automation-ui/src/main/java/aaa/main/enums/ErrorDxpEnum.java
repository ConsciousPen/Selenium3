...
public final class ErrorDxpEnum {
	...
	public enum Errors {
		...
		//UNINSURED_MOTORIST_COVERAGE_BIND_RULE_ERROR("200037_VA", "A signed IMPORTANT NOTICE - UNINSURED MOTORIST COVERAGE form must be received prior to issuing this transaction")
	;
