...
public final class DocGenEnum {
	...
	public enum Documents {
		...
		AA16CO_NOT_CAPITAL_LETTERS("RMPC", "AA16CO", "Medical Payments Rejection of Coverage"),
		...
		AA47CA(""),
		AA49CA(""),
		AA52AZ("AA52AZ", "AA52AZ", "Uninsured and Underinsured Motorist Coverage Selection"),
		...
		AA52ID("AA52ID", "UM and UIM Disclosure Statement and Rejection Of Coverage"),
