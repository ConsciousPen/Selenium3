...
public final class DocGenEnum {
	...
	public enum Documents {
		...
		HS02_4("HS02_4", "Renters Policy Declarations"),
		HS02_6("HS02_6", "Condominium Owners Policy Declarations"),
		...
		HSRNHBXX("Renewal Reminder (Home Banking)"),
		HSRNHBPUPXX("Renewal Reminder (Home Banking PUP)"),
