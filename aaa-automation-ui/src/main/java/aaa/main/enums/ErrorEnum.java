...
public final class ErrorEnum {
	...
	public enum Errors {
		...
		ERROR_AAA_PUP_SS4242760("AAA_PUP_SS4242760", "BI Limits should not be less than $250,000/500,000. (AAA_PUP_SS4242760) [for ..."),
		ERROR_AAA_PUP_SS4242761("AAA_PUP_SS4242761", "BI Limits should not be less than $250,000/500,000. (AAA_PUP_SS4242761) [for ..."),
		ERROR_AAA_PUP_SS4242880("AAA_PUP_SS4242880", "PD Limits should not be less than $100,000. (AAA_PUP_SS4242880) [for PupAutom..."),
		ERROR_AAA_PUP_SS4245880("AAA_PUP_SS4245880", "Combined Single Limit should not be less than $500,000. (AAA_PUP_SS4245880) [..."),
        ...
        AAA_PUP_UWApp_Auto_Antique("AAA_PUP_UWApp_Auto_Antique", "Applicants with 5 or more antique vehicles are ineligible. (AAA_PUP_UWApp_Aut..."),
        AAA_PUP_UWApp_Auto_PPA("AAA_PUP_UWApp_Auto_PPA", "Applicants with 9 or more automobiles are ineligible. (AAA_PUP_UWApp_Auto_PPA..."),
		...
		ERROR_AAA_AAA_MVR_order_validation_SS("AAA_MVR_order_validation_SS", "Current MVR for Juan-JSHNW Smith must be ordered (AAA_MVR_order_validation_SS..."),
