...
public final class ErrorEnum {
	...
	public enum Errors {
		...
		ERROR_200200_NJ("200200_NJ", "A signed \"Acknowledgement of Carco Inspection Requirements\" must be received prior to completing this transaction."),
		ERROR_200204_NJ("200204_NJ", "Inspection Waiver - Sales Agreement Required must be received prior to issuing this transaction."),
		ERROR_200304("200304", "If Limited Tort Liability coverage is selected, a signed form must be receive"),
		ERROR_200305("200305", "First Party Benefits signed form must be received"),
		ERROR_200306("200306", "A signed Uninsured motorist coverage selection form must be received prior to issuing this transaction"),
		...
		// Auto Errors
		ERROR_AAA_200307("200307", "A signed Underinsured motorist coverage selection form must be received prior to issuing this transaction"),
		...
		ERROR_AAA_200200_NY("200200_NY", "Vehicles with Physical Damage Coverage require a CARCO Inspection or Proof of New Vehicle"),
		ERROR_AAA_200203("200203", "If Uninsured/Underinsured Motorist (UM/UIM) Coverage is rejected. A signed Uninsured/Underinsured Motorist coverage selection form must be received prior to issuing this transaction"),
