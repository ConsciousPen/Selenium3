...
public enum CoverageInfo {
	...
	FPB_BASIC_PA("FBP", "Basic First Party Benefits", CoverageLimits.COV_FPB_5K_BASIC,  AvailableCoverageLimits.FPB_PA, null),
	FPB_50K_PACKAGED_PA("FBP", "Packaged First Party Benefits", CoverageLimits.COV_FPB_50K_TOTAL,  AvailableCoverageLimits.FPB_PA, null),
	FPB_100K_PACKAGED_PA("FBP", "Packaged First Party Benefits", CoverageLimits.COV_FPB_100K_TOTAL,  AvailableCoverageLimits.FPB_PA, null),
	FPB_177_5K_PACKAGED_PA("FBP", "Packaged First Party Benefits", CoverageLimits.COV_FPB_177_5K_TOTAL,  AvailableCoverageLimits.FPB_PA, null),
	FPB_ADDED_PA("FBP", "ADDED First Party Benefits", CoverageLimits.COV_FPB_ADDED,  AvailableCoverageLimits.FPB_PA, null),
	MEDPM_PA("MEDPM", "Medical Benefit", CoverageLimits.COV_5000,  AvailableCoverageLimits.MEDPM_PA, null),
	IL_PA("IL", "Work Loss Benefit", CoverageLimits.COV_FALSE_NO_COVERAGE,  AvailableCoverageLimits.IL_PA, null),
