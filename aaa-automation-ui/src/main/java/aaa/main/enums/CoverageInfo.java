...
public enum CoverageInfo {
	...
	UM_SUM_NY("UM/SUM", "Supplementary Uninsured/Underinsured Motorists Bodily Injury", CoverageLimits.COV_100300, AvailableCoverageLimits.BI_WV_VA_KS_DC_DE, "Per Person/Per Accident"),
	UM_SUM_2550_NY("UM/SUM", "Uninsured Motorists Bodily Injury", CoverageLimits.COV_2550, AvailableCoverageLimits.BI_WV_VA_KS_DC_DE, "Per Person/Per Accident");
