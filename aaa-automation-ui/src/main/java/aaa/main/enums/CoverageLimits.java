...
public enum CoverageLimits {
	...
	COV_FPB_5K_BASIC("$5K Basic Coverage Package", "$5K Basic Coverage Package"),
	COV_FPB_50K_TOTAL("$50K Total Coverage Package", "$50K Total Coverage Package"),
	COV_FPB_100K_TOTAL("$100K Total Coverage Package", "$100K Total Coverage Package"),
	COV_FPB_177_5K_TOTAL("$177.5K Total Coverage Package", "$177.5K Total Coverage Package"),
