...
import aaa.main.modules.policy.home_ca.actiontabs.SuspendQuoteActionTab;
 ...
 * @category Generated
 */
public class SuspendQuoteView extends Workspace {
    public SuspendQuoteView() {
        super();
        registerTab(SuspendQuoteActionTab.class);
    }
}
